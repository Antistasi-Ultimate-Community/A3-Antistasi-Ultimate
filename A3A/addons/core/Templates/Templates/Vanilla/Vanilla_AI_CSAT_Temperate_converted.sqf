...
_vehiclesData set ["vehiclesBasic", ["O_T_Quadbike_01_ghex_F"]];

private _lightUnarmed = ["O_T_MRAP_02_ghex_F"];
private _lightArmed = ["O_T_MRAP_02_gmg_ghex_F", "O_T_MRAP_02_hmg_ghex_F"];
_vehiclesData set ["vehiclesTrucks", ["O_T_Truck_03_covered_ghex_F", "O_T_Truck_03_transport_ghex_F"]];
...
_vehiclesData set ["vehiclesAmmoTrucks", ["O_T_Truck_03_ammo_ghex_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["O_T_Truck_03_repair_ghex_F", "O_T_Truck_02_Box_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["O_T_Truck_02_fuel_F", "O_T_Truck_03_fuel_ghex_F"]];
_vehiclesData set ["vehiclesMedical", ["O_T_Truck_02_Medical_F", "O_T_Truck_03_medical_ghex_F"]];
private _lightAPCs = ["O_T_APC_Wheeled_02_rcws_v2_ghex_F"];
_vehiclesData set ["vehiclesAPCs", ["O_T_APC_Wheeled_02_rcws_v2_ghex_F"]];
...
_vehiclesData set ["vehiclesAA", ["O_T_APC_Tracked_02_AA_ghex_F"]];
...
_vehiclesData set ["vehiclesArtillery", ["O_T_MBT_02_arty_ghex_F"]];
...
_vehiclesData set ["vehiclesHelisLight", _helisLight];
_vehiclesData set ["vehiclesHelisAttack", _helisLightAttack]call _fnc_saveToTemplate;
...
_militiaVehiclesData set ["vehiclesTrucks", ["O_T_Truck_02_transport_F", "O_T_Truck_02_F"]];
