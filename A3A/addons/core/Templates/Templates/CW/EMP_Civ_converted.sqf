...
_vehiclesData set ["vehiclesCivRepair", [
    "442_argon_repair", 0.3]];

_vehiclesData set ["vehiclesCivMedical", ["442_argon_medical", 0.1]];

_vehiclesData set ["vehiclesCivFuel", [
    "442_argon_fuel", 0.2]];


_vehiclesData set ["vehiclesCivHeli", ["3AS_Civilian_Transport_02", "3AS_Civilian_Transport_03"]];
