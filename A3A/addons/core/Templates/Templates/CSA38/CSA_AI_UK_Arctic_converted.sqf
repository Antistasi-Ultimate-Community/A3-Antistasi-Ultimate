...
_vehiclesData set ["vehiclesBasic", ["LIB_UK_Willys_MB_w"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_UK_Willys_MB_w","LIB_UK_Willys_MB_Hood_w"]];
private _vehiclesLightArmed = ["LIB_UK_Willys_MB_M1919_w","LIB_UniversalCarrier_w"]; 
_vehiclesData set ["vehiclesTrucks", ["LIB_US_GMC_Tent_w","LIB_US_GMC_Open_w"]];
_vehiclesData set ["vehiclesCargoTrucks", ["LIB_US_GMC_Tent_w","LIB_US_GMC_Open_w"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["LIB_US_GMC_Ammo_w"]];
_vehiclesData set ["vehiclesRepairTrucks", ["LIB_US_GMC_Parm_w"]];
_vehiclesData set ["vehiclesFuelTrucks", ["LIB_US_GMC_Fuel_w"]];
_vehiclesData set ["vehiclesMedical", ["LIB_US_GMC_Ambulance_w", "LIB_UK_Willys_MB_Ambulance_w"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_UniversalCarrier_w"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_US_M3_Halftrack_w","LIB_UniversalCarrier_w"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_Cromwell_Mk4_w", "csa38_valentineMkIIW", "LIB_Churchill_Mk7_w", "LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Crocodile_w", "LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Howitzer_w", "LIB_Churchill_Mk7_AVRE_w"]];
_vehiclesData set ["vehiclesTanks", ["LIB_Churchill_Mk7_w", "LIB_Churchill_Mk7_Crocodile_w", "LIB_M4A4_FIREFLY", "csa38_matildaiiCS_3", "csa38_matildaii_3"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_UniversalCarrier_w"]];
_vehiclesData set ["vehiclesLightTanks",  ["csa38_valentineMkIIW"]];
...
_vehiclesData set ["vehiclesGunBoats", ["LIB_LCM3_Armed", "LIB_LCI"]];
_vehiclesData set ["vehiclesAmphibious", []];

private _vehiclesPlanesCAS = ["LIB_P47"];
private _vehiclesPlanesAA = ["LIB_RAF_P39"];
_vehiclesData set ["vehiclesPlanesTransport", ["LIB_C47_RAF"]];
...
_vehiclesData set ["staticAT", ["LIB_Zis3_w"]];
_vehiclesData set ["staticAA", ["LIB_61k"]];
...
_vehiclesData set ["mortarMagazineHE", "LIB_8Rnd_60mmHE_M2"];
_vehiclesData set ["mortarMagazineSmoke", "LIB_60mm_M2_SmokeShell"];

//Minefield definition
_vehiclesData set ["minefieldAT", ["LIB_US_M1A1_ATMINE"]];
_vehiclesData set ["minefieldAPERS", ["LIB_M3_MINE"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_UK_Willys_MB_M1919_w"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_US_GMC_Open_w"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_UK_Willys_MB_w"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_UniversalCarrier_w"]];
