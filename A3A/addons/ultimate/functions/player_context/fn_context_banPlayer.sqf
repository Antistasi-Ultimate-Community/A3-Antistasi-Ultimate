...
FIX_LINE_NUMBERS()
/* ----------------------------------------------------------------------------
Function: A3U_fnc_context_banPlayer

Description:
    Generates a context menu popup that prompts the admin to input a reason 
    before executing a server command to permanently remove the selected player.

Parameters:
    0: _display - The parent display to attach the controls group to <DISPLAY>
    1: _target - The player object to be removed <OBJECT>
