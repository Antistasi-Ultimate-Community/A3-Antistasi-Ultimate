...
_vehiclesData set ["vehiclesBasic", ["cwr3_i_m151"]];
_vehiclesData set ["vehiclesLightUnarmed", ["cwr3_i_landrover", "cwr3_i_uaz452", "cwr3_i_uaz_open", "cwr3_i_btr40"]];
_vehiclesData set ["vehiclesLightArmed", ["cwr3_i_uaz_dshkm", "cwr3_i_btr40_dshkm"]];
_vehiclesData set ["vehiclesTruck", ["cwr3_i_v3s_open", "cwr3_i_ural_open"]];
_vehiclesData set ["vehiclesAT", ["cwr3_i_uaz_spg9"]];
_vehiclesData set ["vehiclesAA", ["cwr3_i_uaz_aa"]];
_vehiclesData set ["vehiclesBoat", ["cwr3_i_zodiac"]];

_vehiclesData set ["vehiclesPlane", ["cwr3_i_an2"]];       // replace from civ varient s
_vehiclesData set ["vehiclesCivPlane", ["CUP_C_AN2_CIV"]];
_vehiclesData set ["vehiclesMedical", ["cwr3_i_landrover_mev", "cwr3_i_uaz452_mev"]];


_vehiclesData set ["vehiclesCivCar", ["CUP_O_Hilux_unarmed_CR_CIV"]];
_vehiclesData set ["vehiclesCivTruck", ["cwr3_c_v3s_blue"]];
_vehiclesData set ["vehiclesCivHeli", ["CUP_C_Mi17_Civilian_RU"]];
_vehiclesData set ["vehiclesCivBoat", ["C_Rubberboat"]];

_vehiclesData set ["staticMGs", ["CUP_I_DSHKM_NAPA", "CUP_B_DSHkM_MiniTriPod_NAPA"]];
