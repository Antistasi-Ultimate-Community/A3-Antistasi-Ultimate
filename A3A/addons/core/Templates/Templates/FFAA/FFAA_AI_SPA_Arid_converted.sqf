...
_vehiclesData set ["vehiclesBasic", ["ffaa_et_neton_mk2"]];
_vehiclesData set ["vehiclesLightUnarmed", ["ffaa_et_vamtac_ume","ffaa_et_vamtac_trans", "ffaa_et_vamtac_trans_blind"]];
_vehiclesData set ["vehiclesLightArmed", ["ffaa_et_vamtac_st5_m2", "ffaa_et_vamtac_m2", "ffaa_et_lince_m2", "ffaa_et_vamtac_st5_lag40", "ffaa_vamtac_lag40", "ffaa_et_lince_lag40", "ffaa_et_vamtac_st5_spike", "ffaa_et_vamtac_tow", "ffaa_et_vamtac_crows", "ffaa_et_rg31_samson", "ffaa_et_vamtac_cardom"]];
_vehiclesData set ["vehiclesTrucks", ["ffaa_et_pegaso_carga", "ffaa_et_m250_carga_blin", "ffaa_et_pegaso_carga_lona", "ffaa_et_m250_carga_lona_blin"]];
_vehiclesData set ["vehiclesCargoTrucks", ["ffaa_et_m250_recuperacion_blin"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["ffaa_et_pegaso_municion", "ffaa_et_m250_municion_blin"]];
_vehiclesData set ["vehiclesRepairTrucks", ["ffaa_et_pegaso_repara_municion", "ffaa_et_m250_repara_municion_blin"]];
_vehiclesData set ["vehiclesFuelTrucks", ["ffaa_et_pegaso_combustible", "ffaa_et_m250_combustible_blin"]];
_vehiclesData set ["vehiclesMedical", ["ffaa_et_toa_ambulancia"]];
_vehiclesData set ["vehiclesLightAPCs", ["ffaa_et_toa_m2", "ffaa_et_toa_zapador", "ffaa_et_toa_spike"]];
_vehiclesData set ["vehiclesAPCs", ["ffaa_ar_piranhaIIIC"]];
_vehiclesData set ["vehiclesIFVs", ["ffaa_et_pizarro_mauser", "ffaa_ar_piranhaIIIC_lance"]];
_vehiclesData set ["vehiclesTanks", ["ffaa_et_leopardo"]];
_vehiclesData set ["vehiclesAA", ["ffaa_et_vamtac_mistral"]];
_vehiclesData set ["vehiclesAirborne", ["ffaa_et_toa_m2"]];
_vehiclesData set ["vehiclesLightTanks",  ["ffaa_et_pizarro_mauser", "ffaa_ar_piranhaIIIC_lance"]];

_vehiclesData set ["vehiclesTransportBoats", ["ffaa_ar_supercat", "ffaa_ar_zodiac_hurricane", "ffaa_ar_zodiac_hurricane_long"]];
_vehiclesData set ["vehiclesGunBoats", ["CUP_B_RHIB2Turret_USMC"]];
_vehiclesData set ["vehiclesAmphibious", []];

_vehiclesData set ["vehiclesPlanesCAS", ["ffaa_ar_harrier"]];
_vehiclesData set ["vehiclesPlanesAA", ["ffaa_ea_ef18m"]];
_vehiclesData set ["vehiclesPlanesTransport", ["ffaa_ea_hercules"]];

_vehiclesData set ["vehiclesHelisLight", ["ffaa_famet_ec135", "ffaa_famet_cougar", "ffaa_nh90_tth_transport"]];
_vehiclesData set ["vehiclesHelisTransport", ["ffaa_nh90_nfh_transport", "ffaa_famet_ch47_mg"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["ffaa_nh90_tth_armed", "ffaa_famet_cougar_armed"]];
_vehiclesData set ["vehiclesHelisAttack", ["ffaa_famet_tigre"]];

_vehiclesData set ["vehiclesArtillery", ["ffaa_ar_m109"]];
...
_vehiclesData set ["uavsPortable", ["ffaa_raven"]];



_vehiclesData set ["vehiclesPolice", ["CUP_LADA_LM_CIV", "CUP_C_S1203_Militia_CIV"]];

_vehiclesData set ["staticMGs", ["CUP_B_M2StaticMG_USMC"]];
_vehiclesData set ["staticAT", ["CUP_B_TOW2_TriPod_US"]];
_vehiclesData set ["staticAA", ["ffaa_mistral_tripode"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["ffaa_et_lince_mg3", "ffaa_et_vamtac_st5_mg3"]];
_militiaVehiclesData set ["vehiclesTrucks", ["ffaa_et_pegaso_carga"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["ffaa_et_anibal", "ffaa_et_neton_mk2"]];
_militiaVehiclesData set ["vehiclesAPCs", ["ffaa_et_toa_m2"]];
