...
_vehiclesData set ["vehiclesIFVs", ["LIB_PzKpfwIV_H", "LIB_StuG_III_G", "CSA38_pzIIID_LATE4", "CSA38_pzIVC_LATE2"]];
_vehiclesData set ["vehiclesTanks", ["LIB_PzKpfwV", "LIB_PzKpfwVI_E"]];
_vehiclesData set ["vehiclesAA", ["LIB_FlakPanzerIV_Wirbelwind"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_SdKfz251"]];
_vehiclesData set ["vehiclesLightTanks",  ["CSA38_pzII_LATE2"]];
...
_vehiclesData set ["staticAT", ["LIB_Pak40","csa38_pak35_late"]];
