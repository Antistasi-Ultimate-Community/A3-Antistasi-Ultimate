...
_vehiclesData set ["vehiclesDropPod", ["3AS_Rho_Crate_IMP_Transport"]]; 

["ammobox", "B_supplyCrate_F"] call _fnc_saveToTemplate;     //Don't touch or you die a sad and lonely death!
["surrenderCrate", "Box_IND_Wps_F"] call _fnc_saveToTemplate; //Changeing this from default will require you to define logistics attachement offset for the box type
["equipmentBox", "Box_NATO_Equip_F"] call _fnc_saveToTemplate; //Changeing this from default will require you to define logistics attachement offset for the box type

_vehiclesData set ["vehiclesBasic", ["WM_74Z_Imperial_Brown"]]; 			//this line determines basic vehicles, the lightest kind available. -- Example: _vehiclesData set ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["3AS_ISP_Transport"]]; 		
["vehiclesLightArmed",["WM_74Z_Imperial_Brown", "3AS_ISP", "3AS_ISP"]] call _fnc_saveToTemplate; 		
_vehiclesData set ["vehiclesTrucks", ["442_argon_transport", "442_argon_covered"]]; 		
_vehiclesData set ["vehiclesCargoTrucks", ["442_argon_transport", "442_argon_covered"]]; 		
_vehiclesData set ["vehiclesAmmoTrucks", ["442_argon_ammo"]]; 	
_vehiclesData set ["vehiclesRepairTrucks", ["442_argon_repair"]]; 	
_vehiclesData set ["vehiclesFuelTrucks", ["442_argon_fuel"]];	
_vehiclesData set ["vehiclesMedical", ["WM_ITT_Medical","3AS_ITT_Medical"]];
_vehiclesData set ["vehiclesLightAPCs", ["WM_ITT_Imperial", "3AS_ITT", "3AS_PX10_IMP_F"]];
_vehiclesData set ["vehiclesAPCs", ["WM_ITT_Imperial", "3AS_ITT", "3AS_Saber_M1_Imperial", "3AS_Saber_M1Recon_Imperial", "3AS_PX10_IMP_UP"]];
_vehiclesData set ["vehiclesAirborne", ["3AS_PX10_IMP_F", "3AS_ISP", "3AS_Saber_M1_Imperial", "WM_ITT_Imperial", "3AS_ITT"]];
_vehiclesData set ["vehiclesIFVs", ["3AS_Saber_Super_Imperial", "3AS_Saber_M1G_Imperial"]];
_vehiclesData set ["vehiclesLightTanks",  ["3AS_Saber_Super_Imperial", "3AS_Saber_M1G_Imperial"]];
_vehiclesData set ["vehiclesTanks", ["3AS_ATTE_Imperial","WM_ATST"]];
_vehiclesData set ["vehiclesAA", ["3AS_RX200_Base"]];

_vehiclesData set ["vehiclesTransportBoats", ["I_Boat_Transport_01_F"]]; 
_vehiclesData set ["vehiclesGunBoats", ["442_boat_armed"]]; 
_vehiclesData set ["vehiclesAmphibious", []];

_vehiclesData set ["vehiclesPlanesCAS", ["WM_TieBomber_Cluster"]];
_vehiclesData set ["vehiclesPlanesLargeCAS", ["WM_TieDefender"]];
_vehiclesData set ["vehiclesPlanesAA", ["WM_TieInterceptor","WM_TieInterceptor","3AS_VWing_Imperial","3AS_VWing_Imperial","WM_TieAdvanced"]];
_vehiclesData set ["vehiclesPlanesLargeAA", ["WM_Tiefighter","WM_Tiefighter","WM_Tiefighter","WM_Tiefighter","WM_Tiefighter"]];
_vehiclesData set ["vehiclesPlanesTransport", ["3AS_Imperial_Transport_01","3AS_Gozanti_F"]];

_vehiclesData set ["vehiclesPlanesGunship", ["3AS_LAAT_Mk1_Imperial"]];

_vehiclesData set ["vehiclesHelisLight", ["3AS_Patrol_LAAT_Imperial"]];
_vehiclesData set ["vehiclesHelisTransport", ["3AS_LAAT_Mk2_Imperial", "3AS_LAAT_Mk2_Imperial", "3AS_LAAT_Mk2_Imperial", "WM_Lambda", "3AS_Nu_IMP_F", "3AS_Rho_IMP_F"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["3AS_LAAT_Mk1_Imperial"]];
_vehiclesData set ["vehiclesHelisAttack", ["3AS_LAAT_Mk1_Imperial"]];


_vehiclesData set ["vehiclesArtillery", ["442_rx200_arty"]];
["magazines", createHashMapFromArray [
["442_rx200_arty", ["32Rnd_155mm_Mo_shells"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["B_UAV_02_dynamicLoadout_F", "B_T_UAV_03_dynamicLoadout_F"]];
_vehiclesData set ["uavsPortable", ["3as_uas2"]];
...
_vehiclesData set ["staticMortars", ["3AS_Republic_Mortar"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "lsd_cis_radarDish"];
_vehiclesData set ["vehicleSam", "3AS_Keeradak_Imperial"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["3AS_ISP","WM_74Z_Imperial_Brown"]];
_militiaVehiclesData set ["vehiclesTrucks", ["442_argon_transport", "442_argon_covered"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["3AS_ISP_Transport"]];
_militiaVehiclesData set ["vehiclesAPCs", ["WM_ITT_Imperial"]];
