...
_vehiclesData set ["vehiclesBasic", ["CSLA_JARA250","CSLA_AZU_R2_des"]];			 
_vehiclesData set ["vehiclesLightUnarmed", ["CSLA_AZU_para_des","CSLA_AZU_des","CSLA_AZU_R2_des"]];		 
_vehiclesData set ["vehiclesLightArmed", []];             
_vehiclesData set ["vehiclesTrucks", ["CSLA_F813_des","CSLA_V3S_des"]];		 
_vehiclesData set ["vehiclesCargoTrucks", ["CSLA_F813_des","CSLA_V3S_des"]];		 
_vehiclesData set ["vehiclesAmmoTrucks", ["CSLA_V3Sa_des"]];		 
_vehiclesData set ["vehiclesRepairTrucks", ["CSLA_DTP90_Des"]];		 
_vehiclesData set ["vehiclesFuelTrucks", ["CSLA_V3Sf_des"]];		 
_vehiclesData set ["vehiclesMedical", ["CSLA_OZV90_Des"]];		 
_vehiclesData set ["vehiclesLightAPCs", ["CSLA_OT65A_des"]];             
_vehiclesData set ["vehiclesAPCs", ["CSLA_OT64C_des"]];                  
_vehiclesData set ["vehiclesAirborne", ["CSLA_BVP1_Des","CSLA_OT64C_des","CSLA_OT65A_des"]];              
_vehiclesData set ["vehiclesIFVs", ["CSLA_BVP1_Des","CSLA_OT62_Des","CSLA_OT62D_Des"]];                  
_vehiclesData set ["vehiclesTanks", ["CSLA_T72_Des","CSLA_T72M_Des","CSLA_T72M1_Des"]];                 
_vehiclesData set ["vehiclesLightTanks", ["CSLA_BPzV_Des"]];            
_vehiclesData set ["vehiclesAA", ["CSLA_PLdvK59V3S_des"]];                    

_vehiclesData set ["vehiclesTransportBoats", ["CSLA_lodka"]];	
_vehiclesData set ["vehiclesGunBoats", ["O_Boat_Armed_01_hmg_F"]];              

_vehiclesData set ["vehiclesPlanesCAS", ["O_Plane_CAS_02_dynamicLoadout_F"]];            
_vehiclesData set ["vehiclesPlanesAA", ["O_Plane_CAS_02_dynamicLoadout_F"]];              
_vehiclesData set ["vehiclesPlanesTransport", ["CSLA_CIV_An2_1"]];	

_vehiclesData set ["vehiclesHelisLight", ["CSLA_Mi17_DES"]];            
_vehiclesData set ["vehiclesHelisTransport", ["CSLA_Mi17mg_DES"]];        

_vehiclesData set ["vehiclesHelisLightAttack", ["CSLA_Mi17pylons_DES"]];      
_vehiclesData set ["vehiclesHelisAttack", ["CSLA_Mi24V_DES"]];           

_vehiclesData set ["vehiclesArtillery", ["CSLA_RM51_des","CSLA_RM70_des","CSLA_ShKH77_des"]];
...
_vehiclesData set ["staticMGs", ["CSLA_UK59L_Stat","CSLA_DShKM_h_Stat","CSLA_UK59L_Mount"]];
_vehiclesData set ["staticAT", ["CSLA_9K113_Stat","CSLA_AGS17_Stat","CSLA_BzK59A_Stat","CSLA_T21_Stat"]];
_vehiclesData set ["staticAA", ["CSLA_PLdvK59_Stat"]];
_vehiclesData set ["staticMortars", ["CSLA_M52_Stat"]];
_vehiclesData set ["mortarMagazineHE", "CSLA_8rnd_82EOM52"];               
...
_vehiclesData set ["minefieldAT", ["CSLA_PtMiBa3_charge"]];
_vehiclesData set ["minefieldAPERS", ["CSLA_PPMiNa_charge"]];
...
_militiaVehiclesData set ["vehiclesTrucks", ["CSLA_V3S_des"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["CSLA_AZU_para_des","CSLA_AZU_des","CSLA_AZU_R2_des"]];
_militiaVehiclesData set ["vehiclesAPCs", ["CSLA_OT64C_des"]];
