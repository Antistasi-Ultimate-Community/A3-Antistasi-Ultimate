...
_vehiclesData set ["vehiclesLightArmed", ["3AS_ISP"]];
_vehiclesData set ["vehiclesTrucks", ["CW_Mando_argon_transport"]];
_vehiclesData set ["vehiclesLightUnarmed", ["3AS_ISP_Transport"]];
_vehiclesData set ["vehiclesAPCs", ["3AS_PX10_REB_UP"]];
_vehiclesData set ["vehiclesTanks", ["ls_ground_aat_black"]];
_vehiclesData set ["vehiclesHelis", ["3AS_Aegis_Shuttle_Pirate_F"]];			
