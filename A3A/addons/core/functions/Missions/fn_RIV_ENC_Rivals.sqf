...
private _vehicleClass = selectRandomWeighted ((FactionGoDRival(A3A_faction_riv, "vehiclesCars")) + (FactionGoDRival(A3A_faction_riv, "vehiclesLightArmed")));
...
private _rivalVehData = [_roadPosition, 0, selectRandomWeighted (FactionGetRival(A3A_faction_riv, "vehiclesLightArmed")), Rivals] call A3A_fnc_RivalsSpawnVehicle;
