...
_vehiclesData set ["vehiclesBasic", ["Atlas_O_W_Quadbike_01_F"]];
...
_vehiclesData set ["vehiclesTrucks", ["Atlas_O_W_Truck_02_transport_F", "Atlas_O_W_Truck_02_F", "Atlas_O_W_Truck_03_transport_ghex_F", "Atlas_O_W_Truck_03_covered_ghex_F"]];
...
_vehiclesData set ["vehiclesAmmoTrucks", ["Atlas_O_W_Truck_03_ammo_ghex_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["Atlas_O_W_Truck_03_repair_ghex_F", "Atlas_O_W_Truck_02_box_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["Atlas_O_W_Truck_02_fuel_F", "Atlas_O_W_Truck_03_fuel_ghex_F"]];
_vehiclesData set ["vehiclesMedical", ["Atlas_O_W_Truck_02_medical_F", "Atlas_O_W_Truck_03_medical_ghex_F"]];
_vehiclesData set ["vehiclesLightAPCs", ["Atlas_O_W_APC_Wheeled_02_rcws_v2_ghex_F"]];
private _apcs = ["O_R_APC_Wheeled_04_cannon_ard_F", "O_T_APC_Tracked_02_cannon_ghex_F"];
_vehiclesData set ["vehiclesIFVs", []];
_vehiclesData set ["vehiclesAirborne", ["Atlas_O_W_APC_Wheeled_02_rcws_v2_ghex_F","O_T_UGV_01_rcws_ghex_F"]];
_vehiclesData set ["vehiclesLightTanks", ["O_T_UGV_01_rcws_ghex_F"]];
private _tanks = ["Atlas_O_W_MBT_02_cannon_ghex_F"];
_vehiclesData set ["vehiclesAA", ["Atlas_O_W_APC_Tracked_02_AA_F"]];

_vehiclesData set ["vehiclesTransportBoats", ["O_T_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["O_T_Boat_Armed_01_hmg_F"]];

_vehiclesData set ["vehiclesPlanesCAS", ["Atlas_O_W_Plane_CAS_02_dynamicLoadout_ghex_F","O_T_Plane_Fighter_02_ghex_F","O_T_Plane_Transport_01_infantry_ghex_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["O_T_Plane_Fighter_02_Stealth_ghex_F","O_T_Plane_Transport_01_infantry_ghex_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["O_T_Plane_Transport_01_infantry_ghex_F", "O_T_VTOL_02_infantry_dynamicLoadout_F"]];
...
_vehiclesData set ["vehiclesHelisAttack", ["Atlas_O_W_Heli_Attack_04_F", "Atlas_O_W_Heli_Attack_02_dynamicLoadout_F"]];

_vehiclesData set ["vehiclesArtillery", ["O_T_MBT_02_arty_ghex_F", "O_T_Truck_02_MRL_F"]];
...
_vehiclesData set ["uavsAttack", ["O_T_UAV_04_CAS_F"]];
...
_vehiclesData set ["vehiclesAPCs", _apcs];
_vehiclesData set ["vehiclesHelisLight", _lightHelicopters];
_vehiclesData set ["vehiclesHelisLightAttack", _lightAttackHelicopters];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["Atlas_O_W_MRAP_02_hmg_F"]];
_militiaVehiclesData set ["vehiclesTrucks", ["Atlas_O_W_Truck_02_F", "Atlas_O_W_Truck_02_transport_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["Atlas_O_W_MRAP_02_F"]];
_militiaVehiclesData set ["vehiclesAPCs", _militiaAPCs];
