...
_vehiclesData set ["vehiclesBasic", ["uns_m274"]];
_vehiclesData set ["vehiclesLightUnarmed", ["uns_Type55"]];
_vehiclesData set ["vehiclesLightArmed", ["uns_Type55_LMG"]];
["vehiclesTruck",["uns_nvatruck_open"]] call _fnc_saveToTemplate;
_vehiclesData set ["vehiclesAT", ["uns_Type55_RR57"]];
_vehiclesData set ["vehiclesAA", ["uns_nvatruck_zpu"]];

_vehiclesData set ["vehiclesBoat", ["UNS_VC_Sampan_Transport"]];

_vehiclesData set ["vehiclesPlane", ["uns_an2"]];

_vehiclesData set ["vehiclesCivCar", ["uns_willys"]];
_vehiclesData set ["vehiclesCivTruck", ["uns_zil157"]];
_vehiclesData set ["vehiclesCivHeli", []];
_vehiclesData set ["vehiclesCivBoat", ["UNS_skiff2_C"]];

_vehiclesData set ["staticMGs", ["uns_pk_high_VC"]];
_vehiclesData set ["staticAT", ["uns_Type36_57mm_VC"]];
_vehiclesData set ["staticAA", ["uns_ZPU2_VC"]];
_vehiclesData set ["staticMortars", ["uns_m1941_82mm_mortarVC"]];
_vehiclesData set ["staticMortarMagHE", "uns_8Rnd_82mmHE_M1941"];
_vehiclesData set ["staticMortarMagSmoke", "uns_8Rnd_82mmSMOKE_M1941"];
_vehiclesData set ["staticMortarMagFlare", "uns_8Rnd_82mmILLUM_M1941"];

_vehiclesData set ["minesAT", "uns_mine_AT_mag"];
_vehiclesData set ["minesAPERS", "uns_mine_AP_mag"];
