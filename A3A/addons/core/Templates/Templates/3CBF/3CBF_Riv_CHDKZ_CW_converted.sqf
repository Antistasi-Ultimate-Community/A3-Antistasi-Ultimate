...
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_ins_uaz_ags", "rhsgref_ins_uaz_dshkm", "rhsgref_ins_uaz_spg9", "rhsgref_BRDM2_ins", "rhsgref_BRDM2_ATGM_ins", "rhsgref_BRDM2_HQ_ins"]];
_vehiclesData set ["vehiclesTrucks", ["rhsgref_ins_zil131", "rhsgref_ins_zil131_open"]];
_vehiclesData set ["vehiclesLightUnarmed", ["rhsgref_BRDM2UM_ins", "rhsgref_ins_uaz_open", "rhsgref_ins_uaz"]];
_vehiclesData set ["vehiclesAPCs", ["rhsgref_ins_btr60", "rhsgref_ins_btr70", "rhsgref_ins_bmd1", "rhsgref_ins_bmd1p", "rhsgref_ins_bmd2", "rhsgref_ins_bmp1", "rhsgref_ins_bmp1d", "rhsgref_ins_bmp1k", "rhsgref_ins_bmp1p", "rhsgref_ins_bmp2e", "rhsgref_ins_bmp2", "rhsgref_ins_bmp2d", "rhsgref_ins_bmp2k"]];
_vehiclesData set ["vehiclesTanks", ["rhsgref_ins_t72ba", "rhsgref_ins_t72bb"]];
_vehiclesData set ["vehiclesHelis", ["RHS_Mi8MTV3_vdv"]];			
