...
_vehiclesData set ["vehiclesLightAPCs", ["rhsgref_BRDM2_msv", "rhsgref_BRDM2_HQ_msv", "rhsgref_BRDM2_ATGM_msv" ]];
_vehiclesData set ["vehiclesAirborne", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_ags", "rhsusf_m1151_m2_v1_usarmy_wd"]];
