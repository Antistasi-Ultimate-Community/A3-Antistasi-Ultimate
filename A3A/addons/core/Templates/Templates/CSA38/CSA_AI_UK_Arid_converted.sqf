...
_vehiclesData set ["vehiclesBasic", ["LIB_UK_DR_Willys_MB"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_UK_DR_Willys_MB","LIB_UK_DR_Willys_MB_Hood"]];
private _vehiclesLightArmed = ["LIB_UK_DR_Willys_MB_M1919","LIB_UniversalCarrier_desert"]; 
_vehiclesData set ["vehiclesTrucks", ["LIB_US_NAC_GMC_Tent","LIB_US_NAC_GMC_Open"]];
_vehiclesData set ["vehiclesCargoTrucks", ["LIB_US_NAC_GMC_Tent","LIB_US_NAC_GMC_Open"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["LIB_US_NAC_GMC_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["LIB_US_NAC_GMC_Parm"]];
_vehiclesData set ["vehiclesFuelTrucks", ["LIB_US_NAC_GMC_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["LIB_US_NAC_GMC_Ambulance", "LIB_UK_DR_Willys_MB_Ambulance"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_UniversalCarrier_desert"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_UK_DR_M3_Halftrack","LIB_UniversalCarrier_desert"]];
_vehiclesData set ["vehiclesIFVs", ["csa38_valentineMkII6", "LIB_Churchill_Mk7_desert", "LIB_Churchill_Mk7_Crocodile_desert", "LIB_Churchill_Mk7_Howitzer_desert", "LIB_Churchill_Mk7_AVRE_desert"]];
_vehiclesData set ["vehiclesTanks", ["LIB_UK_DR_M4A3_75", "LIB_UK_Italy_M4A3_75", "csa38_matildaii", "csa38_matildaiiCS"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_UniversalCarrier_desert"]];
_vehiclesData set ["vehiclesLightTanks",  ["csa38_valentineMkII6"]];
...
_vehiclesData set ["staticAT", ["LIB_Zis3"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_UK_DR_Willys_MB_M1919"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_US_NAC_GMC_Open"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_UK_DR_Willys_MB"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_UniversalCarrier_desert"]];
