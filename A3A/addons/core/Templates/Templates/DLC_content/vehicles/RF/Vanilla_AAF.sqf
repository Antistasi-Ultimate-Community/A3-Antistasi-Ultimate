...
_armedVehicles append ["I_Pickup_mmg_rf","I_Pickup_rcws_rf","AU_I_Pickup_Minigun_RF"];
...
_airPatrol append ["a3a_AAF_Heli_light_03_unarmed_RF","a3a_green_Heli_light_03_unarmed_RF","a3a_AAF_Heli_light_03_dynamicLoadout_RF","B_Heli_EC_03_RF"];