...
_vehiclesData set ["vehiclesSDV", ["B_SDV_01_F","I_SDV_01_F"]];
...
_vehiclesData set ["uavsAttack", ["B_T_UAV_03_dynamicLoadout_F", "B_UAV_05_F", "B_UAV_02_dynamicLoadout_F"]];
...
_vehiclesData set ["staticMortars", ["B_T_Mortar_01_F"]];
private _howitzers = [];

private _radar = [];
private _SAM = [];

_vehiclesData set ["howitzerMagazineHE", "magazine_ShipCannon_120mm_HE_shells_x32","magazine_ShipCannon_120mm_HE_cluster_shells_x2"];
...
_vehiclesData set ["vehiclesAirPatrol", _airPatrol];
_vehiclesData set ["vehiclesPlanesLargeCAS", _planesLargeCAS];
_vehiclesData set ["vehiclesPlanesLargeAA", _planesLargeAA];
_vehiclesData set ["vehiclesPlanesTransport", _planesTransport];
_vehiclesData set ["vehiclesPlanesGunship", _gunship];
_vehiclesData set ["vehiclesGunBoats", _gunBoat];
_vehiclesData set ["vehiclesTransportBoats", _transportBoat];
_vehiclesData set ["staticAA", _staticAA];
_vehiclesData set ["uavsPortable", _uavsPortable];
_vehiclesData set ["staticMGs", _staticMG];
_vehiclesData set ["staticAT", _staticAT];

_vehiclesData set ["vehiclesLightUnarmed", _unarmedVehicles];
_vehiclesData set ["vehiclesLightArmed", _armedVehicles];
_vehiclesData set ["vehiclesLightTanks",  _lightTanks];
_vehiclesData set ["vehiclesAirborne", _airborneVehicles];
_vehiclesData set ["vehiclesAA", _aa];
_vehiclesData set ["vehiclesCargoTrucks", _cargoTrucks];
_vehiclesData set ["vehiclesTanks", _tanks];
_vehiclesData set ["vehiclesTrucks", _Trucks];
_vehiclesData set ["vehiclesAmmoTrucks", _ammoTrucks];
_vehiclesData set ["vehiclesRepairTrucks", _repairTrucks];
_vehiclesData set ["vehiclesFuelTrucks", _fuelTrucks];
_vehiclesData set ["vehiclesMedical", _medicalTrucks];
...
_militiaVehiclesData set ["vehiclesTrucks", _militiaTrucks];
_militiaVehiclesData set ["vehiclesLightArmed", _militiaLightArmed];
_militiaVehiclesData set ["vehiclesLightUnarmed", _militiaCars];
