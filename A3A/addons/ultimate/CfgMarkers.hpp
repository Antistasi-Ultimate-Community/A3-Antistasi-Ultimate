...
class A3AU_milbase_mrk_B : A3AU_Factory_mrk
{
	name = "Antistasi Military Base Blufor";
	icon = QPATHTOFOLDER(data\A3AU_milbase_mrk_B);
	texture = QPATHTOFOLDER(data\A3AU_milbase_mrk_B);
	markerClass = "A3AU_Milbase_B";
	size = 32;
};

class A3AU_milbase_mrk_O : A3AU_milbase_mrk_B
{
	name = "Antistasi Military Base Opfor";
	icon = QPATHTOFOLDER(data\A3AU_milbase_mrk_O);
	texture = QPATHTOFOLDER(data\A3AU_milbase_mrk_O);
	markerClass = "A3AU_Milbase_O";
};

class A3AU_milbase_mrk_I : A3AU_milbase_mrk_B
{
	name = "Antistasi Military Base Independent";
	icon = QPATHTOFOLDER(data\A3AU_milbase_mrk_i);
	texture = QPATHTOFOLDER(data\A3AU_milbase_mrk_i);
	markerClass = "A3AU_Milbase_I";
};

class A3AU_seaport_mrk_B : A3AU_milbase_mrk_B
{
