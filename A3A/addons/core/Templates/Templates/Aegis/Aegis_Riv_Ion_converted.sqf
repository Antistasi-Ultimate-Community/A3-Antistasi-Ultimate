...
_vehiclesData set ["vehiclesLightArmed", ["B_ION_Offroad_armed_lxWS"]];
_vehiclesData set ["vehiclesLightUnarmed", ["B_ION_Offroad_lxWS"]];
_vehiclesData set ["vehiclesTrucks", ["B_ION_Truck_02_covered_lxWS"]];
_vehiclesData set ["vehiclesAPCs", ["B_ION_APC_Wheeled_01_command_lxWS", "B_ION_APC_Wheeled_02_hmg_lxWS"]];
_vehiclesData set ["vehiclesTanks", ["Aegis_B_ION_UGV_01_rcws_F"]];
_vehiclesData set ["vehiclesHelis", ["a3a_ION_Heli_Light_02_dynamicLoadout_lxWS"]];			
_vehiclesData set ["vehiclesUavs", ["ION_UAV_01_lxWS"]];			

_vehiclesData set ["staticLowWeapons", ["B_HMG_02_F", "B_HMG_01_F", "B_GMG_01_F"]];
