...
_vehiclesData set ["vehiclesIFVs", ["LIB_Churchill_Mk7_desert", "LIB_Churchill_Mk7_Crocodile_desert", "LIB_Churchill_Mk7_Howitzer_desert", "LIB_Churchill_Mk7_AVRE_desert"]];
_vehiclesData set ["vehiclesTanks", ["LIB_UK_DR_M4A3_75", "LIB_UK_Italy_M4A3_75"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_UniversalCarrier_desert"]];
_vehiclesData set ["vehiclesLightTanks",  ["LIB_Churchill_Mk7_desert"]];
