...
_vehiclesData set ["vehiclesBasic", ["UK3CB_NAP_I_TT650"]];
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_NAP_B_Hilux_Pkm"]];
_vehiclesData set ["vehiclesLightArmed", ["UK3CB_NAP_B_Hilux_M2"]];
_vehiclesData set ["vehiclesTruck", ["UK3CB_I_G_V3S_Open"]];
_vehiclesData set ["vehiclesAT", ["UK3CB_NAP_B_Hilux_Spg9"]];
_vehiclesData set ["vehiclesAA", ["UK3CB_I_G_V3S_Zu23"]];

_vehiclesData set ["vehiclesBoat", ["UK3CB_CHD_I_Fishing_Boat"]];

_vehiclesData set ["vehiclesPlane", ["UK3CB_CHC_I_Antonov_AN2", "UK3CB_NAP_I_C400"]];

_vehiclesData set ["vehiclesCivCar", ["UK3CB_ADC_C_Skoda"]];
_vehiclesData set ["vehiclesCivTruck", ["UK3CB_CHC_C_Ural_Open"]];
_vehiclesData set ["vehiclesCivHeli", ["UK3CB_CHC_C_Mi8AMT"]];
_vehiclesData set ["vehiclesCivBoat", ["UK3CB_CHC_C_Fishing_Boat"]];

_vehiclesData set ["staticMGs", ["UK3CB_LDF_I_M2_TriPod"]];
_vehiclesData set ["staticAT", ["rhsgref_nat_SPG9"]];
_vehiclesData set ["staticAA", ["rhsgref_nat_ZU23"]];
_vehiclesData set ["staticMortars", ["rhsgref_nat_2b14"]];
