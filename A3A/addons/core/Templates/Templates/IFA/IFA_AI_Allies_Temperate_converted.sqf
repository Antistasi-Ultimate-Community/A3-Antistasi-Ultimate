...
_vehiclesData set ["vehiclesBasic", ["LIB_US_Willys_MB"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_US_Willys_MB","LIB_US_Willys_MB_Hood"]];
...
_vehiclesData set ["vehiclesMedical", ["LIB_US_GMC_Ambulance", "LIB_US_Willys_MB_Ambulance"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_US_Scout_M3"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_US_M3_Halftrack","LIB_US_Scout_M3_FFV"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_M8_Greyhound", "LIB_M3A3_Stuart", "LIB_M5A1_Stuart", "LIB_Churchill_Mk7_Howitzer", "LIB_Churchill_Mk7_AVRE"]];
...
_vehiclesData set ["vehiclesAirborne", ["LIB_US_Scout_M3"]];
