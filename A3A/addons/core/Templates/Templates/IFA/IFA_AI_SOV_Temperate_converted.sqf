...
_vehiclesData set ["vehiclesAPCs", ["LIB_Scout_M3_FFV","LIB_SOV_M3_Halftrack"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_SU85", "LIB_T34_76"]];
private _vehiclesTanks = ["LIB_T34_85","LIB_T34_85","LIB_T34_85","LIB_JS2_43"];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_Scout_M3_FFV"]];
