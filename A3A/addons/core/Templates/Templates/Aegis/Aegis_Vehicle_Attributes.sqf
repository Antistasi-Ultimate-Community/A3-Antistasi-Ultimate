["attributesVehicles", [
    ...
    ["gmx_aaf_marder1a1plus_wdl", ["cost", 120], ["threat", 150]],
    ["gmx_aaf_marder1a1a_wdl", ["cost", 120], ["threat", 150]],
    ["gmx_aaf_marder1a2_wdl", ["cost", 120], ["threat", 150]],
    ["gmx_aaf_m113a2dk_wdl", ["cost", 120], ["threat", 150]],

    // Autocannons in light-armed
    ["gmx_aaf_luchsa1_wdl", ["cost", 75], ["threat", 120]],
    ["gmx_aaf_luchsa2_wdl", ["cost", 75], ["threat", 120]],
    ["gm_ge_army_marder1a2_wiw", ["cost", 75], ["threat", 120]],

    // Fragile tanks
    ["gmx_aaf_leopard1a1a1_wdl", ["cost", 170], ["threat", 230]],
    ["gmx_aaf_leopard1a3_wdl", ["cost", 170], ["threat", 230]],
    ["gmx_aaf_leopard1a5_wdl", ["cost", 170], ["threat", 230]],
    ...
    ["gm_ge_army_marder1a2_noinsignia", ["cost", 120], ["threat", 150]],

    // Autocannons in light-armed
    ["gm_ge_army_luchsa1_noinsignia", ["cost", 75], ["threat", 120]],
    ["gm_ge_army_luchsa2_noinsignia", ["cost", 75], ["threat", 120]],
    ...
    ["gm_dk_army_m113a2dk_noinsignia", ["cost", 120], ["threat", 150]],
    ["gm_ge_army_Leopard1a1_noinsignia", ["cost", 170], ["threat", 230]],
    ["gm_ge_army_Leopard1a1a1_noinsignia", ["cost", 170], ["threat", 230]],
    ["gm_ge_army_Leopard1a1a2_noinsignia", ["cost", 170], ["threat", 230]],
    ["gm_ge_army_Leopard1a3_noinsignia", ["cost", 170], ["threat", 230]],
    ["gm_ge_army_Leopard1a3a1_noinsignia", ["cost", 170], ["threat", 230]],
    ["gm_ge_army_Leopard1a5_noinsignia", ["cost", 170], ["threat", 230]],

    //vn
    // These are probably not super effective
    ["vn_o_air_mig19_at_noinsignia", ["cost", 150]],
    ["vn_o_air_mig21_cas_noinsignia", ["cost", 200]],
    ["vn_b_air_f100d_cas", ["cost", 150]],
    ["vn_b_air_f4c_cas", ["cost", 200]],
