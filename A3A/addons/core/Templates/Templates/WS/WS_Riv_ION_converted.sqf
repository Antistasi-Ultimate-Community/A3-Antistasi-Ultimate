...
_vehiclesData set ["staticLowWeapons", _staticLowWeapons];
_vehiclesData set ["staticAT", _staticAT];
_vehiclesData set ["staticMortars", _staticMortars];
_vehiclesData set ["vehiclesLightArmed", _lightArmedVehicles];
_vehiclesData set ["vehiclesTrucks", _trucks];
_vehiclesData set ["vehiclesLightUnarmed", _lightUnarmedVehicles];
_vehiclesData set ["vehiclesAPCs", _apc];
...
_vehiclesData set ["vehiclesHelis", _helis];
_vehiclesData set ["vehiclesUavs", _uav];		
