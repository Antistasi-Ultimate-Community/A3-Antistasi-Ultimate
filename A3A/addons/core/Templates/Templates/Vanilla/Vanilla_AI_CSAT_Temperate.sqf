...
private _APCs = ["O_T_APC_Wheeled_02_rcws_v2_ghex_F"];
...
if (_hasEF) then {
    #include "..\DLC_content\vehicles\EF\Vanilla_CSAT_Temparate.sqf"
...
if (_hasEF) then {
    ...
    #include "..\DLC_content\weapons\EF\Vanilla_CSAT_Temparate.sqf"
};
//
