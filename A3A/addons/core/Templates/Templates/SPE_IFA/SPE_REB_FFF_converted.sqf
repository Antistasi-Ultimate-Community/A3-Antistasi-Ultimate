...
_vehiclesData set ["vehiclesBasic", ["SPE_FFI_R200_Unarmed"]];
_vehiclesData set ["vehiclesLightUnarmed", ["SPE_FFI_R200_Hood"]];
_vehiclesData set ["vehiclesLightArmed", ["SPE_FFI_R200_MG34"]];
_vehiclesData set ["vehiclesTruck", ["SPE_FFI_OpelBlitz_Open","SPE_FFI_OpelBlitz"]];
_vehiclesData set ["vehiclesAT", ["SPE_FR_M8_LAC"]];
_vehiclesData set ["vehiclesAA", ["SPE_OpelBlitz_Flak38"]];
...
_vehiclesData set ["vehiclesPlane", _vehiclesPlanes];

["vehiclesHeli", []] call _fnc_saveToTemplate;

_vehiclesData set ["vehiclesCivCar", ["SPE_Milice_R200_Hood"]];
_vehiclesData set ["vehiclesCivTruck", ["SPE_OpelBlitz_Open"]];
_vehiclesData set ["vehiclesCivHeli", []];
_vehiclesData set ["vehiclesCivBoat", ["B_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesCivPlane", []];

_vehiclesData set ["staticMGs", ["SPE_MG34_Lafette_Deployed"]];
_vehiclesData set ["staticAT", ["SPE_FR_57mm_M1"]];
_vehiclesData set ["staticAA", ["SPE_FR_M45_Quadmount"]];

_vehiclesData set ["staticMortars", ["SPE_MLE_27_31"]];
_vehiclesData set ["staticMortarMagHE", "SPE_8Rnd_81mm_FA_Mle_1932_HE"];
_vehiclesData set ["staticMortarMagSmoke", "SPE_8Rnd_81mm_FA_Mle_1932_Smoke"];

_vehiclesData set ["minesAT", "SPE_US_M1A1_ATMINE_mag"];
_vehiclesData set ["minesAPERS", "SPE_US_M3_Pressure_MINE_mag"];
