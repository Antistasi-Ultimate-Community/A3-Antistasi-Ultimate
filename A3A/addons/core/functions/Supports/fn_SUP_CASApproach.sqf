...
Debug_1("CASApproach called with %1", _this);
...
private _fnc_getFireMatrix =
{
    ...
    if (_targetType in flatten FactionGet(all,"vehiclesTanks")) exitWith
    {
    ...
    if (_targetType in flatten FactionGet(all,"vehiclesArmor")) exitWith
    {
