...
_vehiclesData set ["vehiclesBasic", ["C_Quadbike_01_F"]];
_vehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz", "rhsusf_m1025_w"]];
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_ags", "rhsusf_m1151_m2_v1_usarmy_wd"]];
_vehiclesData set ["vehiclesTrucks", ["rhs_gaz66_msv", "rhs_gaz66o_msv", "RHS_Ural_Open_MSV_01]"]];
_vehiclesData set ["vehiclesCargoTrucks", ["rhs_gaz66_msv", "RHS_Ural_MSV_01"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhs_gaz66_ammo_msv"]];
_vehiclesData set ["vehiclesRepairTrucks", ["RHS_Ural_Repair_MSV_01"]];
_vehiclesData set ["vehiclesFuelTrucks", ["RHS_Ural_Fuel_MSV_01"]];
_vehiclesData set ["vehiclesMedical", ["rhs_gaz66_msv"]];
_vehiclesData set ["vehiclesLightAPCs", ["rhsgref_BRDM2_msv", "rhsgref_BRDM2_HQ_msv", "rhsgref_BRDM2_ATGM_msv", "rhsusf_m113_usarmy"]];
_vehiclesData set ["vehiclesAirborne", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_BRDM2_msv", "rhsusf_m1151_m2_v1_usarmy_wd"]];
_vehiclesData set ["vehiclesAPCs", ["rhs_btr70_msv", "rhs_btr80_msv", "rhs_btr80a_msv" ]];
_vehiclesData set ["vehiclesIFVs", ["rhs_bmp1p_msv", "rhs_Ob_681_2" ]];
_vehiclesData set ["vehiclesLightTanks",  ["rhs_bmp3_late_msv"]];
_vehiclesData set ["vehiclesTanks", ["rhs_t80b", "rhs_t72ba_tv"]];
_vehiclesData set ["vehiclesAA", ["rhs_zsu234_aa", "RHS_Ural_Zu23_VMF_01" ]];

_vehiclesData set ["vehiclesTransportBoats", ["O_T_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["rhsusf_mkvsoc"]];
_vehiclesData set ["vehiclesAmphibious", ["rhs_btr80_msv" ]];

_vehiclesData set ["vehiclesPlanesCAS", ["RHS_Su25SM_vvs"]];
_vehiclesData set ["vehiclesPlanesAA", ["rhs_mig29sm_vvs"]];
_vehiclesData set ["vehiclesPlanesTransport", ["RHS_C130J"]];

_vehiclesData set ["vehiclesHelisLight", ["RHS_Mi8AMT_vdv"]];
_vehiclesData set ["vehiclesHelisTransport", ["RHS_Mi24V_vdv"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["RHS_Mi8MTV3_heavy_vdv"]];
_vehiclesData set ["vehiclesHelisAttack", ["RHS_mi28n_vvsc","RHS_Ka52_vvsc"]];

_vehiclesData set ["vehiclesArtillery", ["RHS_BM21_MSV_01"]];
["magazines", createHashMapFromArray [["RHS_BM21_MSV_01", ["rhs_mag_m21of_1"]]]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["rhs_pchela1t_vvsc"]];
_vehiclesData set ["uavsPortable", []];



_vehiclesData set ["vehiclesPolice", ["rhsgref_cdf_b_reg_uaz"]];

_vehiclesData set ["staticMGs", ["rhsgref_ins_DSHKM", "RHS_M2StaticMG_WD" ]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["rhsgref_cdf_b_reg_uaz_dshkm"]];
_militiaVehiclesData set ["vehiclesTrucks", ["rhs_gaz66_msv"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz"]];
_militiaVehiclesData set ["vehiclesAPCs", ["rhsgref_BRDM2_HQ_msv"]];
