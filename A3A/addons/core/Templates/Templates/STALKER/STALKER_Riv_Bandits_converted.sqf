...
_vehiclesData set ["vehiclesLightArmed", ["CUP_I_Hilux_DSHKM_NAPA", "CUP_O_Hilux_DSHKM_CHDKZ"]];
_vehiclesData set ["vehiclesTrucks", ["CUP_O_Ural_Open_CHDKZ", "CUP_O_Ural_CHDKZ"]];
_vehiclesData set ["vehiclesLightUnarmed", ["CUP_I_Hilux_unarmed_NAPA"]];
_vehiclesData set ["vehiclesAPCs", ["CUP_I_BRDM2_HQ_NAPA", "CUP_I_BRDM2_NAPA"]];
_vehiclesData set ["vehiclesTanks", ["CUP_I_T55_NAPA", "CUP_I_T34_NAPA"]];
