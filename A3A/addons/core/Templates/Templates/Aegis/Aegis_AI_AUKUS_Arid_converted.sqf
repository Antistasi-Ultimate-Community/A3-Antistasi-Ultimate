...
_vehiclesData set ["vehiclesLightUnarmed", ["B_A_MRAP_03_F"]];
_vehiclesData set ["vehiclesLightArmed", ["B_A_MRAP_03_gmg_F", "B_A_MRAP_03_hmg_F"]];
_vehiclesData set ["vehiclesTrucks", ["B_A_Truck_01_transport_F", "B_A_Truck_01_covered_F"]];
_vehiclesData set ["vehiclesCargoTrucks", ["B_A_Truck_01_cargo_F", "B_A_Truck_01_flatbed_F","B_A_UGV_01_F"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["B_A_Truck_01_ammo_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["B_A_Truck_01_Repair_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["B_A_Truck_01_fuel_F"]];
_vehiclesData set ["vehiclesMedical", ["B_A_Truck_01_medical_F"]];
...
_vehiclesData set ["vehiclesAirborne", ["Atlas_B_G_APC_Wheeled_03_cannon_F","B_A_UGV_01_rcws_F"]];
_vehiclesData set ["vehiclesLightTanks",  ["B_A_UGV_01_rcws_F"]];
_vehiclesData set ["vehiclesTanks", ["Atlas_B_A_MBT_03_cannon_F"]];
_vehiclesData set ["vehiclesAA", ["B_APC_Tracked_01_AA_F"]];
...
_vehiclesData set ["vehiclesHelisTransport", ["B_A_Heli_Transport_02_F", "Aegis_B_UN_lxWS_Heli_Transport_02_Heavy_F"]];
_vehiclesData set ["vehiclesHelisLight", ["B_A_Heli_light_03_unarmed_F"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["B_A_Heli_light_03_dynamicLoadout_F"]];
_vehiclesData set ["vehiclesHelisAttack", ["B_A_Heli_Attack_01_dynamicLoadout_F", "Atlas_B_A_Heli_Attack_03_F"]];

_vehiclesData set ["vehiclesArtillery", ["B_MBT_01_arty_F","B_MBT_01_mlrs_F"]];
...
_vehiclesData set ["uavsAttack", ["B_A_UAV_02_dynamicLoadout_F"]];
...
_vehiclesData set ["staticMGs", ["B_G_HMG_02_high_F","B_A_HMG_02_high_F"]];
_vehiclesData set ["staticAT", ["B_static_AT_F"]];
_vehiclesData set ["staticAA", ["B_static_AA_F"]];
_vehiclesData set ["staticMortars", ["B_Mortar_01_F"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "B_A_Radar_System_01_F"];
_vehiclesData set ["vehicleSam", "B_A_SAM_System_03_F"];
