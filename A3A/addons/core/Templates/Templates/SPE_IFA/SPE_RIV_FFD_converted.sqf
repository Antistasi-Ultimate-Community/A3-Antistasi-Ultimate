...
_vehiclesData set ["vehiclesLightArmed", ["SPE_GER_R200_MG34"]];
_vehiclesData set ["vehiclesTrucks", ["SPE_ST_OpelBlitz_Open"]];
_vehiclesData set ["vehiclesLightUnarmed", ["SPE_ST_R200_Unarmed"]];
_vehiclesData set ["vehiclesAPCs", ["SPE_SdKfz250_1"]];
_vehiclesData set ["vehiclesTanks", ["SPE_PzKpfwIII_J"]];
_vehiclesData set ["vehiclesHelis", []];			
...
_vehiclesData set ["minefieldAPERS", ["SPE_SMI_35_MINE"]];
