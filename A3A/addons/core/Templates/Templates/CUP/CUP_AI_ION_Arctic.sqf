...
_vehiclesData set ["vehiclesBasic", ["CUP_I_4WD_unarmed_ION"]];
...
_vehiclesData set ["vehiclesTrucks", ["CUP_I_Van_Transport_ION"]];
...
_vehiclesData set ["mortarMagazineHE", "CUP_8Rnd_82mm_Mo_shells_veh"];
