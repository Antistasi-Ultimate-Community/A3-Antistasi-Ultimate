...
_vehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz", "rhsgref_cdf_b_reg_uaz_open", "rhsgref_BRDM2UM_b"]];
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_BRDM2_b", "rhsgref_BRDM2_ATGM_b", "rhsgref_BRDM2_HQ_b", "rhsgref_cdf_b_gaz66_zu23", "rhsgref_cdf_b_ural_Zu23", "rhsgref_cdf_b_reg_uaz_ags"]];
_vehiclesData set ["vehiclesTrucks", ["rhsgref_cdf_b_gaz66", "rhsgref_cdf_b_gaz66o", "rhsgref_cdf_b_ural_open", "rhsgref_cdf_b_ural"]];
_vehiclesData set ["vehiclesCargoTrucks", ["rhsgref_cdf_b_gaz66_flat", "rhsgref_cdf_b_gaz66o_flat"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhsgref_cdf_b_gaz66_ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["rhsgref_cdf_b_gaz66_repair", "rhsgref_cdf_b_ural_repair"]];
...
_vehiclesData set ["vehiclesLightTanks",  ["rhsgref_cdf_b_bmd1k"]];
...
_vehiclesData set ["vehiclesPlanesCAS", ["rhs_l39_cdf_b_cdf", "rhs_l159_cdf_b_CDF", "rhsgref_cdf_b_su25"]];
...
_vehiclesData set ["vehiclesAirPatrol", ["rhsgref_cdf_reg_Mi8amt","rhsgref_cdf_reg_Mi8amt","rhsgref_cdf_reg_Mi8amt","rhsgref_cdf_b_Mi24D_Early","rhsgref_cdf_b_reg_Mi17Sh"]];
...
_vehiclesData set ["staticMGs", ["rhsgref_cdf_b_DSHKM"]];
...
_militiaVehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz", "rhsgref_cdf_b_reg_uaz_open"]];
_militiaVehiclesData set ["vehiclesAPCs", ["rhsgref_cdf_b_btr60", "rhsgref_cdf_b_btr70"]];
