...
_vehiclesData set ["vehiclesSDV", ["B_SDV_01_F"]];
...
_vehiclesData set ["vehiclesBasic", ["B_A_Quadbike_01_wdl_F"]];
_vehiclesData set ["vehiclesLightUnarmed", ["B_A_MRAP_03_wdl_F"]];
_vehiclesData set ["vehiclesLightArmed", ["B_A_MRAP_03_gmg_wdl_F", "B_A_MRAP_03_hmg_wdl_F"]];
_vehiclesData set ["vehiclesTrucks", ["B_A_Truck_01_transport_wdl_F", "B_A_Truck_01_covered_wdl_F"]];
_vehiclesData set ["vehiclesCargoTrucks", ["B_A_Truck_01_cargo_wdl_F", "B_A_Truck_01_flatbed_wdl_F","B_D_UGV_01_lxWS"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["B_A_Truck_01_ammo_wdl_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["B_A_Truck_01_Repair_wdl_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["B_A_Truck_01_fuel_wdl_F"]];
_vehiclesData set ["vehiclesMedical", ["B_A_Truck_01_medical_wdl_F", "B_W_APC_Wheeled_01_medical_F"]];
_vehiclesData set ["vehiclesLightAPCs", ["Atlas_B_G_APC_Wheeled_03_cannon_F"]];
_vehiclesData set ["vehiclesAPCs", ["B_A_APC_tracked_03_cannon_v2_wdl_F"]];
_vehiclesData set ["vehiclesIFVs", []];
_vehiclesData set ["vehiclesAirborne", ["Atlas_B_G_APC_Wheeled_03_cannon_F","B_D_UGV_01_rcws_lxWS"]];
_vehiclesData set ["vehiclesLightTanks",  ["B_D_UGV_01_rcws_lxWS"]];
_vehiclesData set ["vehiclesTanks", ["Atlas_B_A_MBT_03_cannon_F"]];
_vehiclesData set ["vehiclesAA", ["B_W_APC_Tracked_01_AA_F"]];

_vehiclesData set ["vehiclesTransportBoats", ["B_A_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["B_A_Boat_Armed_01_hmg_F"]];

_vehiclesData set ["vehiclesPlanesCAS", ["B_Plane_CAS_01_dynamicLoadout_F","B_T_Plane_Fighter_01_F","B_A_Plane_Fighter_05_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["B_Plane_Fighter_01_Stealth_F","B_A_Plane_Fighter_05_Stealth_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["Atlas_B_A_Plane_Transport_01_infantry_F"]];

_vehiclesData set ["vehiclesHelisTransport", ["B_A_Heli_Transport_02_wdl_F", "Aegis_B_UN_lxWS_Heli_Transport_02_Heavy_F"]];
_vehiclesData set ["vehiclesHelisLight", ["B_A_Heli_light_03_unarmed_wdl_F"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["B_A_Heli_light_03_dynamicLoadout_wdl_F"]];
_vehiclesData set ["vehiclesHelisAttack", ["B_A_Heli_Attack_01_dynamicLoadout_wdl_F", "Atlas_B_A_Heli_Attack_03_F"]];

_vehiclesData set ["vehiclesArtillery", ["B_W_MBT_01_arty_F","B_W_MBT_01_mlrs_F"]]; 
...
_vehiclesData set ["uavsAttack", ["B_A_UAV_02_dynamicLoadout_wdl_F"]];
...
_vehiclesData set ["staticMGs", ["B_A_HMG_02_high_wdl_F", "B_A_HMG_01_high_wdl_F"]];
_vehiclesData set ["staticAT", ["B_A_Static_AT_wdl_F"]];
_vehiclesData set ["staticAA", ["B_A_Static_AA_wdl_F"]];
_vehiclesData set ["staticMortars", ["B_A_Mortar_01_wdl_F"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "B_A_Radar_System_01_wdl_F"];
_vehiclesData set ["vehicleSam", "B_A_SAM_System_03_wdl_F"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["Atlas_B_A_MRAP_03_hmg_F"]];
_militiaVehiclesData set ["vehiclesTrucks", ["Atlas_B_A_Truck_01_covered_F", "Atlas_B_A_Truck_01_transport_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["Atlas_B_A_MRAP_03_F"]];
_militiaVehiclesData set ["vehiclesAPCs", ["Atlas_B_A_APC_Wheeled_01_cannon_v2_F", "Atlas_B_A_APC_Wheeled_01_command_lxWS"]];
