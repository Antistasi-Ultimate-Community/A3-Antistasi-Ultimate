...
_vehiclesData set ["vehiclesBasic", ["Opf_B_P_Quadbike_01_F"]];
...
_vehiclesData set ["vehiclesTruck", ["Opf_B_P_Truck_02_transport_F"]];;
private _vehiclesAA = [];
...
_vehiclesData set ["vehiclesCivTruck", ["C_Truck_02_transport_F", "C_Van_02_transport_F", "C_Van_02_vehicle_F"]];
