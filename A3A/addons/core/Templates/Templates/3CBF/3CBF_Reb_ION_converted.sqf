...
_vehiclesData set ["vehiclesBasic", ["UK3CB_ION_B_Winter_Quadbike"]];
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_ION_B_Winter_Offroad", "UK3CB_ION_B_Winter_Pickup", "UK3CB_ION_B_Winter_SUV", "UK3CB_ION_B_Winter_M998_2DR"]];
_vehiclesData set ["vehiclesLightArmed", ["UK3CB_ION_B_Winter_Offroad_M2", "UK3CB_ION_B_Winter_Hilux_M2", "UK3CB_ION_B_Winter_LR_M2", "UK3CB_ION_B_Winter_Pickup_M2", "UK3CB_ION_B_Winter_M1025_M2", "UK3CB_ION_B_Winter_SUV_Armed"]];
_vehiclesData set ["vehiclesTruck", ["UK3CB_ION_B_Winter_T810_Open", "UK3CB_NAP_I_Van_Transport"]];
_vehiclesData set ["vehiclesAT", ["UK3CB_B_G_LandRover_SPG9"]];
_vehiclesData set ["vehiclesAA", ["UK3CB_KDF_B_Ural_Zu23", "UK3CB_FIA_B_Hilux_Zu23", "UK3CB_FIA_B_Hilux_Zu23_Front"]];

_vehiclesData set ["vehiclesBoat", ["I_C_Boat_Transport_02_F", "UK3CB_I_G_Fishing_Boat_SPG9", "UK3CB_CHD_I_Fishing_Boat_Zu23_front"]];

_vehiclesData set ["vehiclesPlane", ["UK3CB_FIA_I_Cessna_T41", "RHS_AN2"]];
_vehiclesData set ["vehiclesCivPlane", ["UK3CB_C_AC500", "UK3CB_C_DC3"]];

_vehiclesData set ["vehiclesCivCar", ["UK3CB_C_Golf", "UK3CB_C_Landcruiser", "C_Offroad_01_F", "UK3CB_C_Hilux_Open", "UK3CB_C_Pickup", "UK3CB_C_SUV"]];
_vehiclesData set ["vehiclesCivTruck", ["UK3CB_CHC_C_V3S_Open", "UK3CB_C_Ural_Open", "UK3CB_TKC_C_Kamaz_Open", "UK3CB_C_V3S_Recovery", "UK3CB_C_Ural_Recovery"]];
_vehiclesData set ["vehiclesCivHeli", ["UK3CB_C_Bell412_Civ", "UK3CB_C_Bell412_Medic"]];
_vehiclesData set ["vehiclesCivBoat", ["C_Rubberboat", "UK3CB_CHC_C_Fishing_Boat"]];

_vehiclesData set ["staticMGs", ["UK3CB_NAP_I_DSHKM", "UK3CB_FIA_I_M240_Low", "UK3CB_FIA_I_M240_High", "UK3CB_MEI_I_KORD_high", "UK3CB_MEI_I_KORD", "UK3CB_MEI_I_PKM_Low", "UK3CB_MEI_I_DSHkM_Mini_TriPod"]];
_vehiclesData set ["staticAT", ["UK3CB_UN_I_SPG9"]];
_vehiclesData set ["staticAA", ["UK3CB_UN_I_ZU23"]];
_vehiclesData set ["staticMortars", ["UK3CB_FIA_I_M252", "rhsgref_ins_g_2b14"]];
_vehiclesData set ["staticMortarMagHE", "rhs_12Rnd_m821_HE"];
_vehiclesData set ["staticMortarMagSmoke", "8Rnd_82mm_Mo_Smoke_white"];

_vehiclesData set ["minesAT", ["rhs_mine_smine35_press_mag"]];
_vehiclesData set ["minesAPERS", ["rhs_mine_pmn2_mag"]];
