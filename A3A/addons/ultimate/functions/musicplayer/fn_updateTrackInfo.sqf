...
private _iconCtrl = _display displayCtrl 85111; // IDC новой иконки

if (count A3U_currentTrack > 0) then {
    private _trackClass = A3U_currentTrack#1;
    private _modInfo = [_trackClass] call A3U_fnc_getTrackModIcon; // функция получения иконки и названия
