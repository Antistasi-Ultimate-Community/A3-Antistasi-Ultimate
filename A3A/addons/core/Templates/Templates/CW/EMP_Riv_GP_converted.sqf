...
_vehiclesData set ["vehiclesLightArmed", ["JMSLLTE_B_veh_x34mk2_reb_F"]];
_vehiclesData set ["vehiclesTrucks", ["JMSLLTE_B_veh_v35c_reb_F"]];
_vehiclesData set ["vehiclesLightUnarmed", ["JMSLLTE_B_veh_v35_reb_F"]];
_vehiclesData set ["vehiclesAPCs", ["JMSLLTE_B_veh_AA5_reb_F"]];
_vehiclesData set ["vehiclesTanks", ["JMSLLTE_vehgr_ATST_reb_F"]];
_vehiclesData set ["vehiclesHelis", ["JMSLLTE_UwingHeli_Reb_F"]];			
_vehiclesData set ["vehiclesUavs", ["3as_uas2"]];			
