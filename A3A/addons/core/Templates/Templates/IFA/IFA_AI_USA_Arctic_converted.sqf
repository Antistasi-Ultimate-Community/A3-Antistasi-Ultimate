...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_US_Willys_MB_M1919_w"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_US_GMC_Open_w"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_US_Willys_MB_w"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_US_Scout_m3_w"]];
