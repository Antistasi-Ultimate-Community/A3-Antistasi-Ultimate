...
_vehiclesData set ["vehiclesDropPod", ["OPTRE_HEV"]];

["ammobox", "B_supplyCrate_F"] call _fnc_saveToTemplate;     //Don't touch or you die a sad and lonely death!
["surrenderCrate", "Box_IND_Wps_F"] call _fnc_saveToTemplate; //Changeing this from default will require you to define logistics attachement offset for the box type
["equipmentBox", "Box_NATO_Equip_F"] call _fnc_saveToTemplate; //Changeing this from default will require you to define logistics attachement offset for the box type

_vehiclesData set ["vehiclesBasic", ["OPTRE_M274_ATV"]];
_vehiclesData set ["vehiclesLightUnarmed", ["OPTRE_M813_TT", "OPTRE_M12_FAV"]];
_vehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_LRV", "OPTRE_M12A1_LRV"]]; //this line determines light and armed vehicles -- Example: _vehiclesData set ["vehiclesLightArmed", ["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
["vehiclesTrucks", ["OPTRE_m1087_stallion_unsc"]];
_vehiclesData set ["vehiclesCargoTrucks", ["OPTRE_m1087_stallion_cover_unsc"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["OPTRE_m1087_stallion_unsc_resupply"]];
_vehiclesData set ["vehiclesRepairTrucks", ["OPTRE_m1087_stallion_unsc_repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["OPTRE_m1087_stallion_unsc_refuel"]];
_vehiclesData set ["vehiclesMedical", ["OPTRE_m1087_stallion_unsc_medical"]];
_vehiclesData set ["vehiclesLightAPCs", []];
_vehiclesData set ["vehiclesAirborne", ["OPTRE_M12_LRV"]];
_vehiclesData set ["vehiclesAPCs", ["OPTRE_M412_IFV_UNSC", "OPTRE_M413_MGS_UNSC"]];
_vehiclesData set ["vehiclesIFVs", []];
_vehiclesData set ["vehiclesLightTanks",  ["OPTRE_M494"]];
_vehiclesData set ["vehiclesTanks", ["OPTRE_M808B_UNSC"]];
_vehiclesData set ["vehiclesAA", ["OPTRE_M808B2"]];

_vehiclesData set ["vehiclesTransportBoats", ["optre_catfish_unarmed_f"]];
_vehiclesData set ["vehiclesGunBoats", ["optre_catfish_mg_f"]];
_vehiclesData set ["vehiclesAmphibious", ["optre_catfish_gauss_f"]]; // ghost is basically the only vehicle that actually moves on water

_vehiclesData set ["vehiclesPlanesCAS", ["OPTRE_YSS_1000_A_VTOL"]];
_vehiclesData set ["vehiclesPlanesAA", ["OPTRE_YSS_1000_A"]];
_vehiclesData set ["vehiclesPlanesTransport", ["OPTRE_Pelican_unarmed"]]; // I pray this works

_vehiclesData set ["vehiclesPlanesGunship", ["OPTRE_Pelican_armed_70mm","OPTRE_Pelican_armed_SOCOM"]];

_vehiclesData set ["vehiclesHelisLight", ["OPTRE_UNSC_falcon"]];
_vehiclesData set ["vehiclesHelisTransport", ["OPTRE_UNSC_falcon_s"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["OPTRE_UNSC_hornet_CAS"]];
_vehiclesData set ["vehiclesHelisAttack", ["OPTRE_AV22C_Sparrowhawk"]];

_vehiclesData set ["vehiclesArtillery", ["OPTRE_M875_SPH"]];
["magazines", createHashMapFromArray [
["OPTRE_M875_SPH", ["32Rnd_155mm_Mo_shells"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["OPTRE_Wombat_B"]];
_vehiclesData set ["uavsPortable", ["B_UAV_01_F"]];



_vehiclesData set ["vehiclesPolice", ["OPTRE_M813_TT"]];
...
_vehiclesData set ["vehicleSam", "OPTRE_Lance"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_FAV"]];
_militiaVehiclesData set ["vehiclesTrucks", ["OPTRE_m1087_stallion_unsc"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["OPTRE_M274_ATV"]];
_militiaVehiclesData set ["vehiclesAPCs", ["OPTRE_M12_FAV_APC"]];
