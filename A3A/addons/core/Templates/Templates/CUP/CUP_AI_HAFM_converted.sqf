...
]];			//this line determines ammo to be used with specified SPA, hashMap makes sure that SPA gets proper ammo
...
["mortarMagazineFlare", "8Rnd_82mm_Mo_Flare_white"];		//this line determines flare shells for the static mortar - !needs to be compatible with the mortar! 
...
_militiaVehiclesData set ["vehiclesLightUnarmed", ["HAFM_GD240_Unarmed2", "HAFM_HMMWV1"]];
...
-- Example: _vehiclesData set ["mortarMagazineSmoke", "8Rnd_82mm_Mo_Flare_white"] - ENTER ONLY ONE OPTION
...
["voices", ["Male01GRE","Male02GRE","Male03GRE","Male04GRE","Male05GRE","Male06GRE"]];
