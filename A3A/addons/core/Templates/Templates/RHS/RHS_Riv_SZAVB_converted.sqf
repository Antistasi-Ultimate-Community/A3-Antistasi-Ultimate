...
_vehiclesData set ["vehiclesLightArmed", ["ACM_O_SZAVB_Vehicle_UAZ_dshkm", "ACM_O_SZAVB_Vehicle_UAZ_AGS", "ACM_O_SZAVB_Vehicle_UAZ_spg9"]];
_vehiclesData set ["vehiclesTrucks", ["ACM_O_SZAVB_Vehicle_Gaz66o", "ACM_O_SZAVB_Vehicle_Gaz66", "ACM_O_SZAVB_Vehicle_Gaz66_ammo"]];
_vehiclesData set ["vehiclesLightUnarmed", ["ACM_O_SZAVB_Vehicle_UAZ_open", "ACM_O_SZAVB_Vehicle_UAZ"]];
_vehiclesData set ["vehiclesAPCs", ["ACM_O_SZAVB_Vehicle_BTR70", "ACM_O_SZAVB_Vehicle_bmd1", "ACM_O_SZAVB_Vehicle_bmd1k", "ACM_O_SZAVB_Vehicle_bmd1r", "ACM_O_SZAVB_Vehicle_bmd2", "ACM_O_SZAVB_Vehicle_bmp1", "ACM_O_SZAVB_Vehicle_bmp1p", "ACM_O_SZAVB_Vehicle_bmp2e", "ACM_O_SZAVB_Vehicle_brm1k", "ACM_O_SZAVB_Vehicle_prp3"]];
_vehiclesData set ["vehiclesTanks", ["rhs_t72ba_tv", "rhs_t72bb_tv", "rhs_t72bc_tv", "rhs_t72bd_tv", "rhs_t72be_tv", "rhs_t80", "rhs_t80a"]];
_vehiclesData set ["vehiclesHelis", ["RHS_Mi8AMT_vvsc"]];			
_vehiclesData set ["vehiclesUavs", ["rhs_pchela1t_vvsc"]];			

_vehiclesData set ["staticLowWeapons", ["ACM_O_SZAVB_Turret_DSHKM_mini", "ACM_O_SZAVB_Turret_KORD", "ACM_O_SZAVB_Turret_AGS30"]];
_vehiclesData set ["staticAT", ["ACM_O_SZAVB_Turret_Metis", "ACM_O_SZAVB_Turret_spg9", "ACM_O_SZAVB_Turret_spg9M"]];
_vehiclesData set ["staticMortars", ["rhs_2b14_82mm_vdv"]];
