...
_vehiclesData set ["vehiclesLightArmed", ["WM_V25_Speeder"]];
_vehiclesData set ["vehiclesTrucks", ["CW_Mando_argon_transport"]];
_vehiclesData set ["vehiclesLightUnarmed", ["3AS_ISP_Transport"]];
_vehiclesData set ["vehiclesAPCs", ["3AS_RTT_Wheeled"]];
_vehiclesData set ["vehiclesTanks", ["WM_AAC_Speeder","WM_AAC_Speeder_Rocket"]];
_vehiclesData set ["vehiclesHelis", ["3AS_Patrol_LAAT_Republic"]];			
