...
[Invaders, _cityPos getPos [300, random 360 + 180], (FactionGetMilitia(A3A_faction_inv, "vehiclesLightArmed")) + (FactionGetTiered(A3A_faction_inv, "vehiclesLightArmed")) + (FactionGetTiered(A3A_faction_inv, "vehiclesLightUnarmed")) + (FactionGetMilitia(A3A_faction_inv, "vehiclesLightUnarmed")), selectRandom ([A3A_faction_inv, "groupsTierSmall"] call SCRT_fnc_unit_flattenTier)] call _fnc_spawnForces;
