...
_vehiclesData set ["vehiclesLightArmed", ["Opf_O_S_Offroad_01_AT_F", "Opf_O_S_Offroad_01_armed_F"]];
_vehiclesData set ["vehiclesLightUnarmed", ["Opf_O_S_Offroad_01_F"]];
_vehiclesData set ["vehiclesTrucks", ["Opf_O_S_Truck_02_transport_F", "Opf_O_S_Truck_02_F"]];
_vehiclesData set ["vehiclesAPCs", ["Opf_O_S_APC_Tracked_02_30mm_lxWS"]];
_vehiclesData set ["vehiclesTanks", ["Opf_O_S_MBT_02_cannon_F","Aegis_I_C_UGV_01_rcws_F"]];
_vehiclesData set ["vehiclesHelis", ["O_Raven_Heli_Light_02_dynamicLoadout_F"]];			
_vehiclesData set ["vehiclesUavs", ["O_UAV_01_F"]];			

_vehiclesData set ["staticLowWeapons", ["O_G_HMG_02_F", "O_GMG_01_F", "O_HMG_01_F"]];
