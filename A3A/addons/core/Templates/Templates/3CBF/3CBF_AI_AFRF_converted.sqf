...
_vehiclesData set ["vehiclesLightUnarmed", ["rhs_tigr_msv", "rhs_tigr_m_msv"]];
_vehiclesData set ["vehiclesLightArmed", ["rhs_tigr_sts_3camo_msv", "rhs_tigr_sts_3camo_msv", "RHS_Ural_Zu23_MSV_01", "UK3CB_O_G_MTLB_Zu23"]];
_vehiclesData set ["vehiclesTrucks", ["rhs_kamaz5350_msv", "rhs_kamaz5350_open_msv", "RHS_Ural_Open_MSV_01", "RHS_Ural_MSV_01"]];
_vehiclesData set ["vehiclesCargoTrucks", ["rhs_kamaz5350_flatbed_cover_msv", "rhs_kamaz5350_flatbed_msv", "RHS_Ural_Flat_MSV_01", "RHS_Ural_Open_Flat_MSV_01"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhs_kamaz5350_ammo_msv", "RHS_Ural_Ammo_MSV_01"]];
_vehiclesData set ["vehiclesRepairTrucks", ["RHS_Ural_Repair_MSV_01"]];
_vehiclesData set ["vehiclesFuelTrucks", ["RHS_Ural_Fuel_MSV_01"]];
_vehiclesData set ["vehiclesMedical", ["rhs_gaz66_ap2_msv"]];
_vehiclesData set ["vehiclesLightAPCs", ["UK3CB_O_G_MTLB_PKT", "rhs_btr80_msv", "rhs_btr80a_msv", "rhsgref_BRDM2_msv"]];
_vehiclesData set ["vehiclesAirborne", ["rhs_bmd1", "rhs_bmd1p", "rhs_bmd1pk", "rhs_bmd2m", "rhs_bmd2", "rhs_bmp3_msv", "rhs_bmp3_late_msv", "rhs_bmp1k_msv", "rhs_bmp1p_msv", "rhs_brm1k_msv"]];
_vehiclesData set ["vehiclesAPCs", ["rhsgref_BRDM2_ATGM_msv", "rhs_bmd4m_vdv", "rhs_bmd4ma_vdv", "rhs_bmp3m_msv", "rhs_bmp3mera_msv", "rhs_bmp2e_msv", "rhs_bmp2_msv", "rhs_bmp2d_msv", "rhs_bmp2k_msv", "rhs_Ob_681_2"]];
_vehiclesData set ["vehiclesIFVs", ["rhs_prp3_msv", "rhs_bmp1d_msv"]];

_vehiclesData set ["vehiclesLightTanks",  ["rhs_bmd1pk", "rhs_sprut_vdv", "UK3CB_KDF_O_T55", "rhs_t72ba_tv", "rhs_t72bc_tv", "rhs_t80", "rhs_t80u45m", "rhs_t80ue1"]];
_vehiclesData set ["vehiclesTanks", ["rhs_t80bk", "rhs_t72bd_tv", "rhs_t72be_tv", "rhs_t80a", "rhs_t80bv", "rhs_t80u", "rhs_t80um", "rhs_t72bb_tv", "rhs_t90sab_tv", "rhs_t90a_tv", "rhs_t90_tv", "rhs_t90am_tv", "rhs_t90saa_tv", "rhs_t90sm_tv"]];
_vehiclesData set ["vehiclesAA", ["rhs_zsu234_aa", "rhs_zsu234_aa", "UK3CB_O_2S6M_Tunguska_VPV"]];
...
_vehiclesData set ["vehiclesPlanesCAS", ["RHS_Su25SM_vvs", "RHS_Su25SM_vvsc"]];
_vehiclesData set ["vehiclesPlanesAA", ["rhs_mig29sm_vvs", "rhs_mig29s_vvs", "RHS_T50_vvs_generic_ext"]];
_vehiclesData set ["vehiclesPlanesTransport", ["UK3CB_ADA_O_C130J"]];

_vehiclesData set ["vehiclesHelisTransport", ["RHS_Mi8AMT_vvs", "RHS_Mi8mt_vvsc", "RHS_Mi8AMT_vvs", "RHS_Mi8mt_vvsc", "RHS_Mi8AMT_vvs", "RHS_Mi8mt_vvsc", "RHS_Mi24V_vvsc", "RHS_Mi24V_vvs"]];
_vehiclesData set ["vehiclesHelisLight", ["rhs_ka60_c", "RHS_Mi8T_vvsc", "RHS_Mi8T_vvs"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["RHS_Mi8MTV3_vvs", "RHS_Mi8MTV3_vvsc", "RHS_Mi8MTV3_vvs", "RHS_Mi8MTV3_vvsc", "RHS_Mi24P_vvs", "RHS_Mi24P_vvsc"]];
_vehiclesData set ["vehiclesHelisAttack", ["RHS_Ka52_vvsc", "rhs_mi28n_vvsc", "RHS_Ka52_vvs", "rhs_mi28n_vvs"]];

_vehiclesData set ["vehiclesArtillery", ["rhs_2s1_tv", "rhs_2s3_tv", "RHS_BM21_VV_01"]];
...
_vehiclesData set ["uavsAttack", ["O_T_UAV_04_CAS_F", "O_UAV_02_dynamicLoadout_F"]];
_vehiclesData set ["uavsPortable", ["rhs_pchela1t_vvsc"]];

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:


_vehiclesData set ["vehiclesPolice", ["rhs_uaz_open_vv", "rhs_uaz_vv"]];

_vehiclesData set ["staticMGs", ["rhs_KORD_high_MSV", "UK3CB_CW_SOV_O_Early_PKM_High"]];
_vehiclesData set ["staticAT", ["rhs_Kornet_9M133_2_msv"]];
_vehiclesData set ["staticAA", ["rhs_Igla_AA_pod_msv", "RHS_ZU23_MSV"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["rhsgref_BRDM2_msv", "rhs_tigr_sts_msv"]];
_militiaVehiclesData set ["vehiclesTrucks", ["rhs_gaz66o_msv", "rhs_gaz66_msv", "rhs_zil131_msv", "rhs_zil131_open_msv"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["RHS_UAZ_MSV_01", "rhs_uaz_open_MSV_01", "rhsgref_BRDM2UM_msv"]];
_militiaVehiclesData set ["vehiclesAPCs", ["UK3CB_O_G_MTLB_PKT", "rhsgref_BRDM2UM_msv", "rhsgref_BRDM2_HQ_msv", "rhs_btr60_msv", "rhs_btr70_msv", "rhs_bmp1_msv", "rhs_bmp1d_msv"]];
