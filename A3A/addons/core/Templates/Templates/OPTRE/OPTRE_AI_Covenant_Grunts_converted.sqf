...
_vehiclesData set ["vehiclesBasic", ["OPTRE_FC_Ghost_Driverless"]];
_vehiclesData set ["vehiclesLightUnarmed", ["OPTRE_FC_Ghost_Driverless"]];
_vehiclesData set ["vehiclesLightArmed", ["OPTRE_FC_Ghost_Needler_Driverless", "OPTRE_FC_Ghost_Armor_Driverless"]]; //this line determines light and armed vehicles -- Example: _vehiclesData set ["vehiclesLightArmed", ["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
["vehiclesTrucks", ["OPTRE_m1015_mule_ins", "OPTRE_m1015_mule_cover_ins"]];
_vehiclesData set ["vehiclesCargoTrucks", ["OPTRE_m1015_mule_ins", "OPTRE_m1015_mule_cover_ins"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["OPTRE_m1015_mule_ammo_ins"]];
_vehiclesData set ["vehiclesRepairTrucks", ["OPTRE_m1015_mule_repair_ins"]];
_vehiclesData set ["vehiclesFuelTrucks", ["OPTRE_m1015_mule_fuel_ins"]];
_vehiclesData set ["vehiclesMedical", ["OPTRE_m1015_mule_medical_ins"]];
_vehiclesData set ["vehiclesLightAPCs", ["OPTRE_FC_Spectre_Recovery_Ultra"]];
_vehiclesData set ["vehiclesAirborne", ["OPTRE_FC_Spectre", "OPTRE_FC_Spectre_AI_Ultra"]];
_vehiclesData set ["vehiclesAPCs", ["OPTRE_FC_Spectre", "OPTRE_FC_Spectre_Empty"]];
_vehiclesData set ["vehiclesIFVs", []];
_vehiclesData set ["vehiclesLightTanks",  ["OPTRE_FC_Spectre", "OPTRE_FC_Spectre_AI_Ultra"]];
_vehiclesData set ["vehiclesTanks", ["OPTRE_FC_Wraith"]];
_vehiclesData set ["vehiclesAA", ["OPTRE_FC_AA_Wraith", "OPTRE_FC_Spectre_AA_Ultra"]];
...
_vehiclesData set ["vehiclesAmphibious", ["OPTRE_FC_Ghost_Driverless"]]; // ghost is basically the only vehicle that actually moves on water

_vehiclesData set ["vehiclesPlanesCAS", ["OPTRE_FC_Type26B_Banshee"]];
_vehiclesData set ["vehiclesPlanesAA", ["OPTRE_FC_Type26N_Banshee"]];
_vehiclesData set ["vehiclesPlanesTransport", ["OPTRE_FC_Spirit"]]; // I pray this works

_vehiclesData set ["vehiclesPlanesGunship", ["OPTRE_FC_Spirit"]];

_vehiclesData set ["vehiclesHelisLight", ["OPTRE_FC_Spirit"]];

if (["MEU_Covenant"] call A3U_fnc_hasAddon) then {
    _vehiclesData set ["vehiclesHelisTransport", ["MEU_Phantom_Light"]];
    _vehiclesData set ["vehiclesHelisAttack", ["MEU_Phantom"]];
} else {
    _vehiclesData set ["vehiclesHelisTransport", ["OPTRE_FC_Spirit"]];
    _vehiclesData set ["vehiclesHelisAttack", ["OPTRE_FC_Spirit_Concussion"]];
};

_vehiclesData set ["vehiclesHelisLightAttack", ["OPTRE_FC_Spirit_Concussion"]];

_vehiclesData set ["vehiclesArtillery", ["OPTRE_m1015_mule_mlr_ins_IND"]];
["magazines", createHashMapFromArray [
["OPTRE_m1015_mule_mlr_ins_IND", ["12Rnd_230mm_rockets"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["B_UAV_02_CAS_F"]];
_vehiclesData set ["uavsPortable", ["B_UAV_01_F"]];



_vehiclesData set ["vehiclesPolice", ["OPTRE_FC_Spectre_Empty"]];

_vehiclesData set ["staticMGs", ["OPTRE_Static_M247H_Tripod"]]; // none of the MGs fit in outpost towers, they just blow up.
_vehiclesData set ["staticAT", ["OPTRE_FC_T26_AT"]];
_vehiclesData set ["staticAA", ["OPTRE_FC_T26_AA"]];
_vehiclesData set ["staticMortars", ["Plasma_Mortar"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "O_Radar_System_02_F"];
_vehiclesData set ["vehicleSam", "OPTRE_FC_TyrantAA"];

_vehiclesData set ["howitzerMagazineHE", ""];

_vehiclesData set ["mortarMagazineHE", "Guided_Plasma_Mag_Test"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["OPTRE_FC_Ghost_Driverless"]];
_militiaVehiclesData set ["vehiclesTrucks", ["B_T_Truck_01_transport_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["OPTRE_FC_Spectre_Empty"]];
_militiaVehiclesData set ["vehiclesAPCs", ["OPTRE_FC_Spectre"]];
