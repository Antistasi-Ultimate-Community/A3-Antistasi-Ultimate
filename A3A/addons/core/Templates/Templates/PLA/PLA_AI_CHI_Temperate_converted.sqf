...
_vehiclesData set ["vehiclesBasic", ["O_mas_chi_Quadbike_01_F"]];
_vehiclesData set ["vehiclesLightUnarmed", ["O_mas_chi_LSV_02_unarmed_F", "O_mas_chi_MRAP_02_F"]];
_vehiclesData set ["vehiclesLightArmed", ["O_mas_chi_LSV_02_armed_F", "O_mas_chi_LSV_02_AT_F", "O_mas_chi_MRAP_02_hmg_F", "O_mas_chi_MRAP_02_gmg_F"]];
_vehiclesData set ["vehiclesTrucks", ["O_mas_chi_Truck_02_transport_F","O_mas_chi_Truck_02_covered_F"]];
_vehiclesData set ["vehiclesCargoTrucks", ["O_mas_chi_Truck_02_transport_F"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["O_mas_chi_Truck_02_reammo_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["O_mas_chi_Truck_02_repair_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["O_mas_chi_Truck_02_refuel_F"]];
_vehiclesData set ["vehiclesMedical", ["O_T_Truck_03_medical_ghex_F","O_T_Truck_02_Medical_F"]];
_vehiclesData set ["vehiclesLightAPCs", ["O_mas_chi_APC_Wheeled_02_rcws_F", "O_ZBL09"]];
_vehiclesData set ["vehiclesAPCs", ["O_mas_chi_APC_Tracked_02_cannon_F", "O_ZBD04A"]];
_vehiclesData set ["vehiclesIFVs", ["O_ZTL11"]];
_vehiclesData set ["vehiclesTanks", ["O_ZTQ15", "O_ZTZ96B", "O_ZTZ99", "O_ZTZ99A", "O_mas_chi_MBT_02_cannon_F"]];
_vehiclesData set ["vehiclesAA", ["O_PGZ09_AA", "O_mas_chi_APC_Tracked_02_AA_F"]];
_vehiclesData set ["vehiclesAirborne", ["O_mas_chi_APC_Tracked_02_cannon_F"]];
_vehiclesData set ["vehiclesLightTanks",  ["O_ZTL11"]];

_vehiclesData set ["vehiclesTransportBoats", ["O_mas_chi_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["O_mas_chi_Boat_Armed_01_F"]];
_vehiclesData set ["vehiclesAmphibious", []];

_vehiclesData set ["vehiclesPlanesCAS", ["O_mas_chi_Plane_CAS_02_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["O_mas_chi_Plane_Fighter_02_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["CUP_O_AN2_TK"]];

_vehiclesData set ["vehiclesHelisLight", ["Z20"]];
_vehiclesData set ["vehiclesHelisTransport", ["Z8L","O_mas_chi_Heli_Light_02_F"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["Z11WA", "Z11WA_2"]];
_vehiclesData set ["vehiclesHelisAttack", ["Z19","Z10", "O_mas_chi_Heli_Attack_02_F"]];

_vehiclesData set ["vehiclesArtillery", ["O_mas_chi_MBT_02_arty_F"]];
["magazines", createHashMapFromArray [["O_mas_chi_MBT_02_arty_F", ["32Rnd_155mm_Mo_shells_O"]]]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["O_mas_chi_UAV_02_F"]];
_vehiclesData set ["uavsPortable", ["O_mas_chi_UAV_01_F"]];



_vehiclesData set ["vehiclesPolice", ["B_GEN_Offroad_01_gen_F"]];

_vehiclesData set ["staticMGs", ["O_mas_chi_HMG_01_high_F"]];
_vehiclesData set ["staticAT", ["O_mas_chi_static_AT_F"]];
_vehiclesData set ["staticAA", ["O_mas_chi_static_AA_F"]];
_vehiclesData set ["staticMortars", ["O_mas_chi_Mortar_01_F"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "O_Radar_System_02_F"];
_vehiclesData set ["vehicleSam", "O_SAM_System_04_F"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["O_mas_chi_LSV_02_armed_F"]];
_militiaVehiclesData set ["vehiclesTrucks", ["O_mas_chi_Truck_02_transport_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["O_mas_chi_LSV_02_unarmed_F"]];
_militiaVehiclesData set ["vehiclesAPCs", ["O_ZBD04A"]];
