...
_vehiclesData set ["vehiclesBasic", ["JMSLLTE_B_veh_74z_imp_F"]]; 			//this line determines basic vehicles, the lightest kind available. -- Example: _vehiclesData set ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["JMSLLTE_B_veh_v35_reb_F", "CW_Ifrit_Empire"]]; 		
["vehiclesLightArmed",["CW_Ifrit_Imperial_HMG", "CW_Ifrit_Imperial_AT"]] call _fnc_saveToTemplate; 		
_vehiclesData set ["vehiclesTrucks", ["JMSLLTE_B_veh_v35c_reb_F"]]; 		
_vehiclesData set ["vehiclesCargoTrucks", []]; 		
_vehiclesData set ["vehiclesAmmoTrucks", ["JMSLLTE_B_veh_ITTc_imp_F"]]; 	
_vehiclesData set ["vehiclesRepairTrucks", ["JMSLLTE_B_veh_ITTc_impR_F"]]; 	
_vehiclesData set ["vehiclesFuelTrucks", ["3AS_ITT_Logistic"]];	
_vehiclesData set ["vehiclesMedical", ["3AS_ITT_Medical"]];
_vehiclesData set ["vehiclesLightAPCs", ["JMSLLTE_B_veh_AA5_reb_F"]];
_vehiclesData set ["vehiclesAPCs", ["JMSLLTE_B_veh_ITT_imp_F", "3AS_ITT"]];
_vehiclesData set ["vehiclesAirborne", ["CW_Ifrit_Imperial_HMG", "CW_Ifrit_Imperial_AT"]];
_vehiclesData set ["vehiclesIFVs", ["JMSLLTE_vehgr_ATST_F"]];
_vehiclesData set ["vehiclesLightTanks",  ["JMSLLTE_vehgr_ATST_F", "JMSLLTE_veh_S1firehawke_emp_F"]];
_vehiclesData set ["vehiclesTanks", ["3AS_ATTE_Imperial","JMSLLTE_veh_S1firehawke_emp_F"]];
...
_vehiclesData set ["vehiclesPlanesCAS", ["JMSLLTE_TIEBomber_veh_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["JMSLLTE_TIEinterceptor_veh_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["3AS_Imperial_Transport_01"]];
...
_vehiclesData set ["vehiclesHelisTransport", ["JMSLLTE_veh_IDT_inf_empire"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["442_laat_empire_ab"]];
_vehiclesData set ["vehiclesHelisAttack", ["442_laat_empire"]];
...
_vehiclesData set ["vehiclesPolice", ["CW_Offroad_Imperial"]];
...
_vehiclesData set ["vehicleSam", "3as_XX9"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["CW_Offroad_Imperial_HMG"]];
_militiaVehiclesData set ["vehiclesTrucks", ["JMSLLTE_B_veh_v35c_reb_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["CW_Offroad_Imperial"]];
_militiaVehiclesData set ["vehiclesAPCs", ["JMSLLTE_B_veh_AA5_reb_F"]];
