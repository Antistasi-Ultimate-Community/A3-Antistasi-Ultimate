...
_vehiclesData set ["vehiclesPolice", _police]; 			
_vehiclesData set ["staticMGs", _staticMG];					
_vehiclesData set ["staticAT", ["BWA3_MELLS_static_Fleck"]]; 					
_vehiclesData set ["staticAA", _staticAA]; 		

_vehiclesData set ["staticMortars", ["BWA3_MRS120_Tropen"]]; 				
_vehiclesData set ["mortarMagazineHE", "BWA3_8Rnd_120mm_Mo_shells"]; 			
_vehiclesData set ["mortarMagazineSmoke", "BWA3_8Rnd_120mm_Mo_Smoke_white"]; 
_vehiclesData set ["mortarMagazineFlare", "BWA3_8Rnd_120mm_Mo_Flare_white"];

//Minefield definition
_vehiclesData set ["minefieldAT", ["BWA3_DM31AT", "BWA3_AT2"]];
...
_militiaVehiclesData set ["vehiclesAPCs", ["BWA3_Puma_Tropen"]];
_militiaVehiclesData set ["vehiclesLightArmed", _miltiaLightArmed];
_militiaVehiclesData set ["vehiclesTrucks", _miltiaTrucks];
_militiaVehiclesData set ["vehiclesLightUnarmed", _miltiaCars];
