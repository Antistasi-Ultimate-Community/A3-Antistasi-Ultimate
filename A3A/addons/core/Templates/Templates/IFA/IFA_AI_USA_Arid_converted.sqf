...
_vehiclesData set ["vehiclesTanks", ["LIB_US_NAC_M4A3_75"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_US_NAC_Willys_MB_M1919"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_US_NAC_GMC_Open"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_US_NAC_Willys_MB"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_US_NAC_Scout_M3"]];
