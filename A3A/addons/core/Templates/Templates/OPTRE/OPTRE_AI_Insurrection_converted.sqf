...
_vehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_LRV_ins"]]; //this line determines light and armed vehicles -- Example: _vehiclesData set ["vehiclesLightArmed", ["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
...
_vehiclesData set ["vehiclesLightAPCs", ["OPTRE_M412_IFV_INS", "OPTRE_M493_M37_RCWS_Ins"]];
_vehiclesData set ["vehiclesAirborne", ["OPTRE_M413_MGS_INS", "OPTRE_M494_INS"]];
_vehiclesData set ["vehiclesAPCs", ["OPTRE_M413_MGS_INS", "OPTRE_M412_IFV_INS"]];
_vehiclesData set ["vehiclesIFVs", ["OPTRE_M494_INS"]];
_vehiclesData set ["vehiclesLightTanks",  []];
_vehiclesData set ["vehiclesTanks", ["OPTRE_M808B_INS"]];
_vehiclesData set ["vehiclesAA", ["OPTRE_M12R_AA_ins"]];

_vehiclesData set ["vehiclesTransportBoats", ["optre_catfish_ins_unarmed_f"]];
_vehiclesData set ["vehiclesGunBoats", ["optre_catfish_ins_mg_f"]];
_vehiclesData set ["vehiclesAmphibious", ["OPTRE_M412_IFV_INS"]];

_vehiclesData set ["vehiclesPlanesCAS", ["OPTRE_YSS_1000_A_Single"]];
_vehiclesData set ["vehiclesPlanesAA", ["OPTRE_YSS_1000_A_Single"]];
_vehiclesData set ["vehiclesPlanesTransport", ["B_T_VTOL_01_infantry_F"]]; // I pray this works

_vehiclesData set ["vehiclesHelisLight", ["OPTRE_ins_falcon_unarmed", "OPTRE_UNSC_falcon_S_ins"]];
_vehiclesData set ["vehiclesHelisTransport", ["OPTRE_Pelican_unarmed_ins"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["OPTRE_UNSC_hornet_ins"]];
_vehiclesData set ["vehiclesHelisAttack", ["OPTRE_UNSC_falcon_armed_S_ins", "OPTRE_INS_MHS_144_Falcon"]];
...
_vehiclesData set ["uavsAttack", ["OPTRE_mako_drone_CAS_ins"]];
_vehiclesData set ["uavsPortable", ["B_UAV_01_F"]];



_vehiclesData set ["vehiclesPolice", ["OPTRE_M12_FAV_ins"]];
...
_vehiclesData set ["staticMortars", ["OPTRE_AU_44_INS_Mortar"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "B_Radar_System_01_F"];
_vehiclesData set ["vehicleSam", "OPTRE_Lance_INS"];

_vehiclesData set ["howitzerMagazineHE", ""];

_vehiclesData set ["mortarMagazineHE", "OPTRE_10Rnd_122mm_SABOT_81mm_Mo_shells"];
_vehiclesData set ["mortarMagazineSmoke", "OPTRE_10Rnd_122mm_Mo_Smoke_white"];
_vehiclesData set ["mortarMagazineFlare", "OPTRE_10Rnd_122mm_Mo_Flare_white"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_TD_ins"]];
_militiaVehiclesData set ["vehiclesTrucks", ["OPTRE_m1015_mule_cover_ins"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["OPTRE_M12_FAV_ins"]];
_militiaVehiclesData set ["vehiclesAPCs", ["OPTRE_M12_ins_APC"]];
