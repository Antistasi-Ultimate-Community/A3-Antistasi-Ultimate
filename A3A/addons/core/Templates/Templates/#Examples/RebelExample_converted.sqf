...
_vehiclesData set ["vehiclesCivSupply", []];

_vehiclesData set ["staticMGs", []];
_vehiclesData set ["staticAT", []];
_vehiclesData set ["staticAA", []];
_vehiclesData set ["staticMortars", []];
_vehiclesData set ["staticMortarMagHE", ""];
_vehiclesData set ["staticMortarMagSmoke", ""];
