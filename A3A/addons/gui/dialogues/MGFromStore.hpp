class A3A_BuyVehicleMGDialog : A3A_TabbedDialog
{
  ...
  onUnload = "['onUnload'] spawn A3A_fnc_buyVehicleDialog";
    ...
    class Controls
    {
        ...
        class TabButtons : A3A_ControlsGroupNoScrollbars
        {
            ...
            class Controls
            {
                class rebelVehicleTabButton : A3A_Button ///rebels light armed
                {
                    idc = -1;
                ...
                class staticsTabButton : A3A_Button ///rebels static mg
                {
                    idc = -1;
        ...
        // Main content
        class civilianVehicleTab : A3A_DefaultControlsGroup ///rebels light armed
        {
        ...
        class staticsTab : A3A_DefaultControlsGroup ///rebels static mg
        {
