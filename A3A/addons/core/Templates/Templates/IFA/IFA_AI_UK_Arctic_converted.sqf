...
_vehiclesData set ["vehiclesIFVs", ["LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_w", "LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Crocodile_w", "LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Howitzer_w", "LIB_Churchill_Mk7_AVRE_w"]];
_vehiclesData set ["vehiclesTanks", ["LIB_M4A4_FIREFLY"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_UniversalCarrier_w"]];
_vehiclesData set ["vehiclesLightTanks",  ["LIB_Cromwell_Mk4_w"]];
