...
_vehiclesData set ["vehiclesLightUnarmed", ["rhssaf_army_o_m1025_olive", "rhssaf_army_o_m1152_tcv_olive", "rhssaf_army_o_m998_olive_2dr_fulltop"]];
_vehiclesData set ["vehiclesLightArmed", ["rhssaf_army_o_m1025_olive_m2", "rhssaf_army_o_m1151_olive_pkm", "rhs_tigr_sts_vmf", "rhs_tigr_sts_3camo_vmf", "RHS_Ural_Zu23_VMF_01"]];
_vehiclesData set ["vehiclesTrucks", ["rhssaf_army_o_ural_open", "rhssaf_army_o_ural", "rhs_kamaz5350_open_vmf", "rhs_kamaz5350_vmf"]];
_vehiclesData set ["vehiclesCargoTrucks", ["RHS_Ural_Open_Flat_VMF_01", "RHS_Ural_Flat_VMF_01", "rhs_kamaz5350_flatbed_cover_vmf", "rhs_kamaz5350_flatbed_vmf"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhs_gaz66_ammo_vmf", "rhs_kamaz5350_ammo_vmf"]];
_vehiclesData set ["vehiclesRepairTrucks", ["RHS_Ural_Repair_VMF_01"]];
_vehiclesData set ["vehiclesFuelTrucks", ["rhssaf_army_o_ural_fuel"]];
_vehiclesData set ["vehiclesMedical", ["rhs_gaz66_ap2_msv"]];
_vehiclesData set ["vehiclesLightAPCs", ["rhsgref_cdf_btr60", "rhsgref_cdf_btr70", "rhsgref_cdf_btr80", "rhsgref_BRDM2_HQ", "rhsgref_BRDM2"]];
_vehiclesData set ["vehiclesAPCs", ["rhs_bmp1d_vmf", "rhs_bmp1k_vmf", "rhs_bmp1p_vmf", "rhs_bmp2e_vmf"]];
_vehiclesData set ["vehiclesIFVs", []];
_vehiclesData set ["vehiclesTanks", ["rhssaf_army_o_t72s", "rhssaf_army_o_t72s", "rhs_t72be_tv", "rhs_t72be_tv", "rhs_t72bb_tv", "rhs_t72bb_tv"]];
_vehiclesData set ["vehiclesAA", ["rhs_zsu234_aa"]];
_vehiclesData set ["vehiclesAirborne", ["rhsgref_cdf_btr60", "rhsgref_cdf_btr70", "rhsgref_cdf_btr80", "rhsgref_BRDM2_HQ", "rhsgref_BRDM2"]];
_vehiclesData set ["vehiclesLightTanks",  ["rhs_bmp1d_vmf", "rhs_bmp1k_vmf", "rhs_bmp1p_vmf", "rhs_bmp2e_vmf"]];

_vehiclesData set ["vehiclesTransportBoats", ["O_G_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["rhsusf_mkvsoc"]];
_vehiclesData set ["vehiclesAmphibious", ["rhsgref_cdf_btr80", "rhs_tigr_sts_vmf", "rhs_bmp2k_vmf"]];

_vehiclesData set ["vehiclesPlanesCAS", ["rhsgref_cdf_su25", "rhssaf_airforce_l_18"]];
_vehiclesData set ["vehiclesPlanesAA", ["rhssaf_airforce_o_l_18_101"]];
_vehiclesData set ["vehiclesPlanesTransport", ["RHS_C130J"]];

_vehiclesData set ["vehiclesHelisLight", ["rhssaf_airforce_o_ht40"]];
_vehiclesData set ["vehiclesHelisTransport", ["rhssaf_airforce_o_ht40", "rhssaf_airforce_o_ht48"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["RHS_Mi8MTV3_vvsc", "RHS_Mi8MTV3_heavy_vvsc", "RHS_Mi24Vt_vvsc", "rhsgref_cdf_reg_Mi17Sh"]];
_vehiclesData set ["vehiclesHelisAttack", ["rhsgref_cdf_Mi24D", "rhsgref_cdf_Mi35", "rhsgref_mi24g_CAS"]];

_vehiclesData set ["vehiclesAirPatrol", ["rhssaf_airforce_o_ht40", "RHS_Mi8MTV3_vvsc", "RHS_Mi8MTV3_heavy_vvsc", "RHS_Mi24Vt_vvsc", "rhsgref_cdf_reg_Mi17Sh"]];
...
_vehiclesData set ["vehiclesPolice", ["rhs_tigr_vmf", "rhs_uaz_open_vmf"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["rhs_tigr_sts_3camo_vmf", "rhs_tigr_sts_vmf"]];
_militiaVehiclesData set ["vehiclesTrucks", ["rhs_zil131_vmf", "RHS_Ural_VMF_01", "RHS_Ural_Open_VMF_01", "rhs_zil131_open_vmf", "rhs_zil131_flatbed_vmf"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["rhs_uaz_vmf", "rhs_uaz_open_vmf", "rhs_tigr_m_vmf", "rhs_tigr_m_3camo_vmf"]];
_militiaVehiclesData set ["vehiclesAPCs", ["rhsgref_cdf_btr60", "rhsgref_BRDM2_HQ"]];
