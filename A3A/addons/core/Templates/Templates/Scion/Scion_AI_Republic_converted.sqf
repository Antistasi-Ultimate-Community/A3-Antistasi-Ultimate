...
_vehiclesData set ["vehiclesBasic", ["SC_Ferret_AR"]];
_vehiclesData set ["vehiclesLightUnarmed", ["SCEXT_Dingo_AR"]];
_vehiclesData set ["vehiclesLightArmed", ["SCEXT_Dingo_A_AR", "SC_Ferret_AA_AR"]];
_vehiclesData set ["vehiclesTrucks", ["SC_Gator_TO_AR", "SC_Gator_TC_AR"]];
_vehiclesData set ["vehiclesCargoTrucks", ["SC_Gator_FB_AR", "SCEXT_Gator_Flatbed_Trans_AR"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["SCEXT_Gator_Crate_AR"]];
_vehiclesData set ["vehiclesRepairTrucks", ["SCEXT_Gator_Logistics_AR"]];
_vehiclesData set ["vehiclesFuelTrucks", ["SCEXT_Gator_Crate_AR"]];
_vehiclesData set ["vehiclesMedical", ["SC_Gator_TC_AR"]];
_vehiclesData set ["vehiclesLightAPCs", ["SCEXT_Gator_APC_AR"]];
_vehiclesData set ["vehiclesAirborne", ["SC_AR_IFV"]];
_vehiclesData set ["vehiclesAPCs", ["SC_AR_IFV", "SCEXT_Gator_APC_AR"]];
_vehiclesData set ["vehiclesIFVs", []];

_vehiclesData set ["vehiclesLightTanks",  ["SCEXT_Grizzly_AR", "SC_EXT_Rhino_AR"]];
_vehiclesData set ["vehiclesTanks", ["SCEXT_Grizzly_AR", "SC_EXT_Rhino_AR"]];
_vehiclesData set ["vehiclesAA", ["SC_Ferret_AA_AR"]];
...
_vehiclesData set ["vehiclesPlanesCAS", ["SCR_TF3LInterceptor_AR"]];
_vehiclesData set ["vehiclesPlanesAA", ["SCR_TF3LInterceptor_AR"]];
_vehiclesData set ["vehiclesPlanesTransport", ["SC_ProwlerClassCorvette_VTOL"]];

_vehiclesData set ["vehiclesHelisTransport", ["SC_VTOL_X42S_AR", "SC_EXT_Comanche_AR", "SC_EXT_Comanche_V_AR"]];
_vehiclesData set ["vehiclesHelisLight", ["SC_EXT_Comanche_V_AR"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["SC_VTOL_X41A_AR"]];
_vehiclesData set ["vehiclesHelisAttack", ["SC_EXT_Wyvern_AR"]];

_vehiclesData set ["vehiclesArtillery", ["SCEXT_Gator_ArtyGun_AR"]];
...
_vehiclesData set ["vehiclesPolice", ["SCEXT_Gator_Flatbed_Trans_AR"]];

_vehiclesData set ["staticMGs", ["B_G_HMG_02_high_F", "B_HMG_01_high_F"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["SCEXT_Dingo_A_AR"]];
_militiaVehiclesData set ["vehiclesTrucks", ["SC_Gator_FB_AR"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["SCEXT_Dingo_AR"]];
_militiaVehiclesData set ["vehiclesAPCs", ["SCEXT_Gator_APC_AR"]];
