...
_vehiclesData set ["vehiclesTruck", ["I_G_Van_01_transport_F"]];
private _vehiclesAT = ["O_SFIA_Offroad_AT_lxWS","O_Tura_Offroad_armor_AT_lxWS"];
_vehiclesData set ["vehiclesAA", ["I_G_Offroad_01_AT_F"]];
...
_vehiclesData set ["vehiclesCivTruck", ["C_Truck_02_transport_F"]];
...
_vehiclesData set ["staticAA", ["I_Tura_ZU23_lxWS"]];
...
_vehiclesData set ["vehiclesCivHeli", _vehiclesCivHeli];
