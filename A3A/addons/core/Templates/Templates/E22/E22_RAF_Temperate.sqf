...
private _unarmedVehicles = ["E22_B_RAF_LSV_02_unarmed_F"];
private _armedVehicles = ["E22_B_RAF_LSV_02_armed_F", "E22_B_RAF_MRAP_02_hmg_F"];
private _Trucks = ["E22_B_RAF_Truck_03_transport_F", "E22_B_RAF_Truck_03_covered_F"];
private _cargoTrucks = ["E22_B_RAF_Truck_03_transport_F", "E22_B_RAF_Truck_03_covered_F"];
private _ammoTrucks = ["E22_B_RAF_Truck_03_ammo_F"];
private _repairTrucks = ["E22_B_RAF_Truck_03_repair_F"];
private _fuelTrucks = ["E22_B_RAF_Truck_03_fuel_F"];
private _medicalTrucks = ["E22_B_RAF_Truck_03_medical_F"];
private _lightAPCs = [];
private _APCs = ["E22_B_RAF_APC_Wheeled_02_rcws_F"];
private _IFVs = ["E22_B_RAF_APC_Tracked_02_cannon_AT_F"];
private _airborneVehicles = ["E22_B_RAF_APC_Wheeled_02_rcws_F","E22_B_RAF_APC_Tracked_02_cannon_AT_F"];
private _tanks = ["E22_B_RAF_MBT_04_cannon_F"];
private _lightTanks = ["E22_B_RAF_MBT_02_cannon_F"];
private _aa = ["E22_B_RAF_APC_Tracked_02_AA_F"];

private _transportBoat = ["E22_B_RAF_Boat_Transport_02_F"];
private _gunBoat = ["a3a_Boat_Armed_01_hmg_blufor_F"];

private _planesCAS = ["E22_B_RAF_Plane_CAS_02_dynamicLoadout_F"];
private _planesAA = ["E22_B_RAF_Plane_Fighter_02_Stealth_F"];

private _planesTransport = [];
private _gunship = [];

private _helisLight = ["E22_B_RAF_Heli_Light_02_unarmed_F"];
private _transportHelicopters = ["E22_B_RAF_Heli_Transport_04_covered_F", "E22_B_RAF_Heli_Transport_04_bench_F"];
private _helisLightAttack =  ["E22_B_RAF_Heli_Light_02_dynamicLoadout_F"];
private _helisAttack = ["E22_B_RAF_Heli_Attack_02_dynamicLoadout_F"];

private _airPatrol = ["E22_B_RAF_Heli_Light_02_dynamicLoadout_F", "E22_B_RAF_Heli_Attack_02_dynamicLoadout_F"];
...
private _artillery = ["E22_B_RAF_Truck_02_MRL_F"];
["magazines", createHashMapFromArray [
    ["E22_B_RAF_Truck_02_MRL_F", ["12Rnd_230mm_rockets"]]
]] call _fnc_saveToTemplate;

["uavsAttack", ["E22_B_RAF_UAV_02_dynamicLoadout_F"]] call _fnc_saveToTemplate;
private _uavsPortable = ["I_UAV_01_F"];

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:

private _militiaLightArmed = ["E22_B_RAF_LSV_02_armed_F"];
private _militiaTrucks = ["E22_B_RAF_Truck_03_transport_F"];
private _militiaCars = ["E22_B_RAF_LSV_02_unarmed_F"];
private _militiaAPCs = ["E22_B_RAF_MRAP_02_hmg_F"];
...
_loadoutData set ["traitorUniforms", ["E22_RAF_U_CombatUniform_01_lesnoy_shortsleeve_F"]];
...
_loadoutData set ["officerUniforms", ["E22_RAF_U_CombatUniform_01_lesnoy_shortsleeve_F"]];
...
_loadoutData set ["atBackpacks", ["E22_RAF_B_Kitbag_lesnoy"]];
...
_sfLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_lesnoy_F", 2, "E22_RAF_U_CombatUniform_01_lesnoy_shortsleeve_F", 2]];
_sfLoadoutData set ["vests", ["JCA_V_CarrierRigKBT_01_combat_olive_F", 5, "JCA_V_CarrierRigKBT_01_compact_olive_F", 3, "JCA_V_CarrierRigKBT_01_CQB_olive_F", 5, "JCA_V_CarrierRigKBT_01_light_olive_F", 3]];
_sfLoadoutData set ["Hvests", ["JCA_V_CarrierRigKBT_01_command_olive_F", 10]];
_sfLoadoutData set ["backpacks", ["E22_RAF_B_Kitbag_lesnoy", 4, "E22_RAF_B_CombatPack_lesnoy", 4, "E22_RAF_B_TacticalPack_lesnoy", 2]];
_sfLoadoutData set ["helmets", ["E22_RAF_H_Helmet_Sparrow_standard_lesnoy_cover_F", 3, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_cover_F", 3, "E22_RAF_H_HelmetHBK_lesnoy_F", 3, "E22_RAF_H_HelmetHBK_headset_lesnoy_F", 3]];
_sfLoadoutData set ["slHat", ["E22_RAF_H_Helmet_Sparrow_standard_lesnoy_cover_F", 3, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_cover_F", 3, "E22_RAF_H_HelmetHBK_lesnoy_F", 3, "E22_RAF_H_HelmetHBK_headset_lesnoy_F", 3]];
...
_sfLoadoutData set ["slRifles", [
    ...
    ["arifle_MSBS65_F", "muzzle_snds_H", _sfAttachments, _sfRifleOptics, ["30Rnd_65x39_caseless_msbs_mag", "30Rnd_65x39_caseless_msbs_mag"], [], ""], 4,
...
_sfLoadoutData set ["grenadeLaunchers", [
    ...
    ["arifle_MSBS65_GL_F", "muzzle_snds_H", _sfAttachments, _sfRifleOptics, ["30Rnd_65x39_caseless_msbs_mag", "30Rnd_65x39_caseless_msbs_mag"], ["UGL_FlareWhite_F", "UGL_FlareWhite_F", "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell"], ""], 6
]];
...
_sfLoadoutData set ["sniperRifles", [
    ["arifle_MSBS65_Mark_F", "muzzle_snds_H", "", _sfSniperOptics, ["30Rnd_65x39_caseless_msbs_mag","30Rnd_65x39_caseless_msbs_mag"], [], "bipod_02_F_blk"], 10
]];
...
if (_hasWS) then {
    ...
    (_sfLoadoutData get "rifles") append [
        ["arifle_XMS_khk_lxWS", "muzzle_snds_M", _sfAttachments, _sfRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5,
        ["arifle_XMS_M_khk_lxWS", "muzzle_snds_M", _sfAttachments, _sfRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5
    ];
};
...
_eliteLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_lesnoy_F", 2, "E22_RAF_U_CombatUniform_01_lesnoy_shortsleeve_F", 2]];
_eliteLoadoutData set ["vests", ["JCA_V_CarrierRigKBT_01_combat_olive_F", 5, "JCA_V_CarrierRigKBT_01_compact_olive_F", 3, "JCA_V_CarrierRigKBT_01_CQB_olive_F", 5, "JCA_V_CarrierRigKBT_01_light_olive_F", 3]];
_eliteLoadoutData set ["Hvests", ["JCA_V_CarrierRigKBT_01_command_olive_F", 10]];
_eliteLoadoutData set ["backpacks", ["E22_RAF_B_Kitbag_lesnoy", 4, "E22_RAF_B_CombatPack_lesnoy", 4, "E22_RAF_B_TacticalPack_lesnoy", 2]];
_eliteLoadoutData set ["helmets", ["E22_RAF_H_Helmet_Sparrow_standard_lesnoy_cover_F", 3, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_cover_F", 3, "E22_RAF_H_HelmetHBK_lesnoy_F", 3, "E22_RAF_H_HelmetHBK_headset_lesnoy_F", 3]];
_eliteLoadoutData set ["slHat", ["E22_RAF_H_Helmet_Sparrow_standard_lesnoy_cover_F", 3, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_cover_F", 3, "E22_RAF_H_HelmetHBK_lesnoy_F", 3, "E22_RAF_H_HelmetHBK_headset_lesnoy_F", 3]];
...
_eliteLoadoutData set ["slRifles", [
    ...
    ["arifle_MSBS65_F", "", _eliteAttachments, _eliteRifleOptics, ["30Rnd_65x39_caseless_msbs_mag", "30Rnd_65x39_caseless_msbs_mag"], [], ""], 4,
...
_eliteLoadoutData set ["grenadeLaunchers", [
    ...
    ["arifle_MSBS65_GL_F", "", _eliteAttachments, _eliteRifleOptics, ["30Rnd_65x39_caseless_msbs_mag", "30Rnd_65x39_caseless_msbs_mag"], ["UGL_FlareWhite_F", "UGL_FlareWhite_F", "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell"], ""], 6
]];
...
_eliteLoadoutData set ["sniperRifles", [
    ["arifle_MSBS65_Mark_F", "", "", _eliteSniperOptics, ["30Rnd_65x39_caseless_msbs_mag","30Rnd_65x39_caseless_msbs_mag"], [], "bipod_02_F_blk"], 10
]];
...
if (_hasWS) then {
    (_eliteLoadoutData get "slRifles") append [
        ["arifle_XMS_khk_lxWS", "", _eliteAttachments, _eliteSlRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5,
    ...
    (_eliteLoadoutData get "rifles") append [
        ["arifle_XMS_khk_lxWS", "", _eliteAttachments, _eliteRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5,
        ["arifle_XMS_M_khk_lxWS", "", _eliteAttachments, _eliteRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5
    ];
};
...
_militaryLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_lesnoy_F", 4, "E22_RAF_U_CombatUniform_01_sweater_lesnoy_shortsleeve_F", 4]];
_militaryLoadoutData set ["slUniform", ["E22_RAF_U_CombatUniform_01_lesnoy_shortsleeve_F", 10]];
_militaryLoadoutData set ["vests", ["JCA_V_CarrierRigKBT_01_combat_olive_F", 5, "JCA_V_CarrierRigKBT_01_compact_olive_F", 5, "JCA_V_CarrierRigKBT_01_CQB_olive_F", 3, "JCA_V_CarrierRigKBT_01_light_olive_F", 5]];
_militaryLoadoutData set ["Hvests", ["JCA_V_CarrierRigKBT_01_command_olive_F", 10]];
_militaryLoadoutData set ["backpacks", ["E22_RAF_B_Kitbag_lesnoy", 4, "E22_RAF_B_CombatPack_lesnoy", 4, "E22_RAF_B_TacticalPack_lesnoy", 2]];
_militaryLoadoutData set ["helmets", ["E22_RAF_H_Helmet_Sparrow_standard_lesnoy_F", 1, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_F", 1, "E22_RAF_H_Helmet_Sparrow_standard_lesnoy_cover_F", 3, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_cover_F", 3]];
...
_militaryLoadoutData set ["slRifles", [
    ...
    ["arifle_MSBS65_F", "", _militaryAttachments, _militaryRifleOptics, ["30Rnd_65x39_caseless_msbs_mag", "30Rnd_65x39_caseless_msbs_mag"], [], ""], 4,
...
_militaryLoadoutData set ["grenadeLaunchers", [
    ...
    ["arifle_MSBS65_GL_F", "", _militaryAttachments, _militaryRifleOptics, ["30Rnd_65x39_caseless_msbs_mag", "30Rnd_65x39_caseless_msbs_mag"], ["UGL_FlareWhite_F", "UGL_FlareWhite_F", "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell"], ""], 6
]];
...
_militaryLoadoutData set ["sniperRifles", [
    ["arifle_MSBS65_Mark_F", "", "", _militarySniperOptics, ["30Rnd_65x39_caseless_msbs_mag","30Rnd_65x39_caseless_msbs_mag"], [], "bipod_02_F_blk"], 10
]];
...
if (_hasWS) then {
    (_militaryLoadoutData get "slRifles") append [
        ["arifle_XMS_khk_lxWS", "", _militaryAttachments, _militarySlRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5,
    ...
    (_militaryLoadoutData get "rifles") append [
        ["arifle_XMS_khk_lxWS", "", _militaryAttachments, _militaryRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5,
        ["arifle_XMS_M_khk_lxWS", "", _militaryAttachments, _militaryRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5
    ];
};
...
_policeLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_sweater_lesnoy_shortsleeve_F", 10]];
_policeLoadoutData set ["vests", ["JCA_V_CarrierRigKBT_01_compact_black_F", 4, "JCA_V_CarrierRigKBT_01_command_black_F", 2]];
_policeLoadoutData set ["helmets", ["E22_RAF_H_Beret_01_red_F", 10, "JCA_H_Beret_01_black_F", 10, "E22_RAF_H_Cap_Military_lesnoy_F", 10]];
...
_militiaLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_tanktop_lesnoy_F", 3, "E22_RAF_U_CombatUniform_01_sweater_lesnoy_F", 2, "E22_RAF_U_CombatUniform_01_shirt_lesnoy_F", 4]];
_militiaLoadoutData set ["vests", ["JCA_V_CarrierRigKBT_01_holster_black_F", 1.25, "JCA_V_CarrierRigKBT_01_olive_F", 5, "JCA_V_CarrierRigKBT_01_combat_olive_F", 3.75]];
_militiaLoadoutData set ["Hvests", ["JCA_V_CarrierRigKBT_01_command_olive_F", 10]];
_militiaLoadoutData set ["backpacks", ["E22_RAF_B_Kitbag_lesnoy", 4, "E22_RAF_B_CombatPack_lesnoy", 4, "E22_RAF_B_TacticalPack_lesnoy", 2]];
_militiaLoadoutData set ["helmets", ["E22_RAF_H_Cap_Military_lesnoy_F", 5, "E22_RAF_H_Beret_01_green_F", 4, "E22_RAF_H_Helmet_Sparrow_standard_lesnoy_F", 2, "E22_RAF_H_Helmet_Sparrow_headset_lesnoy_F", 1]];
...
_militiaLoadoutData set ["sniperRifles", [
    ["arifle_MSBS65_Mark_F", "", "", _militiaSniperOptics, ["30Rnd_65x39_caseless_msbs_mag","30Rnd_65x39_caseless_msbs_mag"], [], "bipod_02_F_blk"], 10
]];
...
if (_hasWS) then {
    (_militiaLoadoutData get "slRifles") append [
        ["arifle_XMS_khk_lxWS", "", _militiaAttachments, _militiaSlRifleOptics, ["30Rnd_556x45_Stanag", "30Rnd_556x45_Stanag"], [], ""], 5.5,
...
_crewLoadoutData set ["uniforms", ["E22_RAF_U_CombatUniform_01_lesnoy_shortsleeve_F", 10]];
_crewLoadoutData set ["vests", ["E22_RAF_V_CarrierRigKBT_01_crew_lesnoy_F", 10]];
