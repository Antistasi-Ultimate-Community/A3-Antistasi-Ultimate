...
private _boatClass = selectRandomWeighted (FactionGetTiered(_faction, "vehiclesGunBoats"));
private _officerClass = _faction get "unitOfficial";
private _truckClass = selectRandomWeighted (FactionGetTiered(_faction, "vehiclesTrucks"));
