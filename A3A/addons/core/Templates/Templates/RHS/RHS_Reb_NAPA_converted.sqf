...
_vehiclesData set ["vehiclesLightUnarmed", ["rhsgref_nat_uaz_open"]];
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_nat_uaz_dshkm"]];
_vehiclesData set ["vehiclesTruck", ["rhsgref_nat_ural_open"]];
_vehiclesData set ["vehiclesAT", ["rhsgref_nat_uaz_spg9"]];
_vehiclesData set ["vehiclesAA", ["rhsgref_nat_ural_Zu23"]];

_vehiclesData set ["vehiclesBoat", ["I_C_Boat_Transport_02_F"]];

_vehiclesData set ["vehiclesPlane", ["RHS_AN2"]];

_vehiclesData set ["vehiclesCivCar", ["C_Offroad_01_F"]];
_vehiclesData set ["vehiclesCivTruck", ["RHS_Ural_Open_Civ_03"]];
_vehiclesData set ["vehiclesCivHeli", ["RHS_Mi8t_civilian"]];
_vehiclesData set ["vehiclesCivBoat", ["C_Rubberboat"]];

_vehiclesData set ["staticMGs", ["rhsgref_nat_DSHKM"]];
