...
_vehiclesData set ["vehiclesLightUnarmed", ["tmt_landrover_w", "CUP_B_nM1025_Unarmed_USA_WDL", "CUP_B_nM1038_4s_USA_WDL"]];
_vehiclesData set ["vehiclesLightArmed", ["TMT_Cobra_RCWS_W", "CUP_B_nM1025_M240_USA_WDL", "CUP_B_nM1025_SOV_M2_USA_WDL"]];
_vehiclesData set ["vehiclesTrucks", ["TMT_Unimog_Transport_W"]];
_vehiclesData set ["vehiclesCargoTrucks", ["CUP_I_T810_Unarmed_LDF"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["TMT_Unimog_Ammo_W"]];
_vehiclesData set ["vehiclesRepairTrucks", ["CUP_I_T810_Repair_LDF"]];
_vehiclesData set ["vehiclesFuelTrucks", ["CUP_I_T810_Refuel_LDF"]];
_vehiclesData set ["vehiclesMedical", ["tmt_landrover_w_amb", "TMT_ACV300_W_Amb"]];
_vehiclesData set ["vehiclesLightAPCs", ["TMT_ACV300_W_M2", "TMT_Ejder_RCWS_GEN"]];
_vehiclesData set ["vehiclesAirborne", ["TMT_KirpiII_MRAP_W", "TMT_ACV300_W_M242", "TMT_ACV300_W_M2", "TMT_M113_W_M2"]];
_vehiclesData set ["vehiclesAPCs", ["TMT_KirpiII_MRAP_W", "TMT_ACV300_W_M242", "TMT_M113_W_M2"]];
_vehiclesData set ["vehiclesIFVs", ["TMT_ACV300_W_M242", "TMT_M113_W_M2"]];
_vehiclesData set ["vehiclesLightTanks",  ["TMT_M60A3_W"]];
_vehiclesData set ["vehiclesTanks", ["TMT_LEO2A4_w", "TMT_Leopard2_NG_W"]];
_vehiclesData set ["vehiclesAA", ["TMT_Landrover_w_AA"]];

_vehiclesData set ["vehiclesTransportBoats", ["CUP_B_MK10_GB", "CUP_B_RHIB_USMC"]];
_vehiclesData set ["vehiclesGunBoats", ["CUP_B_RHIB2Turret_USMC"]];
_vehiclesData set ["vehiclesAmphibious", ["TMT_M113_W_M2"]];

_vehiclesData set ["vehiclesPlanesCAS", ["CUP_B_A10_DYN_USA", "CUP_B_CESSNA_T41_ARMED_USA"]];
_vehiclesData set ["vehiclesPlanesAA", ["CUP_B_F35B_USMC"]];
_vehiclesData set ["vehiclesPlanesTransport", ["TMT_C130"]];

_vehiclesData set ["vehiclesHelisLight", ["CUP_B_SA330_Puma_HC2_BAF", "CUP_B_UH1D_GER_KSK_Des"]];
_vehiclesData set ["vehiclesHelisTransport", ["TMT_T70", "TMT_CH47F"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["CUP_B_AH6J_USA", "CUP_B_AH6M_USA"]];
_vehiclesData set ["vehiclesHelisAttack", ["TMT_AH1W", "TMT_AH1W_HIRSS"]];

_vehiclesData set ["vehiclesArtillery", ["TMT_T155_W"]];
["magazines", createHashMapFromArray [
    ["TMT_T155_W",["32Rnd_155mm_Mo_shells"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["TMT_BayraktarTB2"]];
_vehiclesData set ["uavsPortable", ["B_UAV_01_F"]];



_vehiclesData set ["vehiclesPolice", ["TMT_Cobra_RCWS_PSO", "TMT_Ejder_RCWS_PSO", "TMT_Kirpi_MRAP_PSO"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["TMT_Cobra_RCWS_GEN"]];
_militiaVehiclesData set ["vehiclesTrucks", ["TMT_Unimog_Transport_W"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["tmt_landrover_w"]];
_militiaVehiclesData set ["vehiclesAPCs", ["TMT_Ejder_RCWS_GEN", "TMT_Kirpi_MRAP_GEN"]];
