...
_vehiclesData set ["vehiclesBasic", ["3AS_Barc"]];
_vehiclesData set ["vehiclesLightUnarmed", ["3AS_ISP_Transport"]];
_vehiclesData set ["vehiclesLightArmed", ["3AS_ISP"]];
_vehiclesData set ["vehiclesTruck", ["442_argon_transport","442_argon_covered"]];
_vehiclesData set ["vehiclesAT", ["3as_saber_m1"]];
_vehiclesData set ["vehiclesAA", ["3as_saber_m1Recon"]];

_vehiclesData set ["vehiclesBoat", ["I_C_Boat_Transport_02_F"]];

_vehiclesData set ["vehiclesPlane", ["3AS_BTLB_Bomber", "3AS_Republic_Transport_01"]];
