class vehicles_aegis : vehicles_base
{
    ...
    ITEM(B_AFV_Wheeled_01_unarmed_F, 2250, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_AFV_Wheeled_01_up_unarmed_F, 2625, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_APC_Tracked_01_unarmed_F, 4125, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_APC_Tracked_01_med_F, 9450, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_APC_Tracked_01_CRV_unarmed_F, 16500, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_APC_Wheeled_01_unarmed_F, 3450, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(O_APC_Wheeled_02_med_lxWS, 8120, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_G_APC_Wheeled_03_unarmed_F, 3300, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(B_APC_Wheeled_03_med_F, 8550, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
    ITEM(O_APC_Tracked_02_unarmed_F, 3640, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
};
