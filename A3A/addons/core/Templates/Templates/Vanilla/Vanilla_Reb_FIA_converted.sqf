...
_vehiclesData set ["vehiclesCivPlane", _vehicleCivPlane];
_vehiclesData set ["vehiclesCivSupply", _vehiclesSupply];
_vehiclesData set ["vehiclesMedical", _vehiclesMedical];
_vehiclesData set ["vehiclesBoat", _vehiclesBoat];
_vehiclesData set ["staticMortars", _staticMortars];
_vehiclesData set ["staticMGs", _staticMG];
_vehiclesData set ["staticAT", _staticAT];
_vehiclesData set ["vehiclesCivHeli", _civHelicopters];
_vehiclesData set ["vehiclesBasic", _vehiclesBasic];
_vehiclesData set ["vehiclesPlane", _vehiclePlane];
_vehiclesData set ["vehiclesCivTruck", _CivTruck];
_vehiclesData set ["vehiclesTruck", _VehTruck];
_vehiclesData set ["vehiclesCivBoat", _CivBoat];
