...
_vehiclesData set ["vehiclesHelis", ["I_C_Heli_Light_01_civil_F"]];			
_vehiclesData set ["vehiclesUavs", ["O_UAV_01_F"]];			

_vehiclesData set ["staticLowWeapons", ["O_G_HMG_02_F"]];

_vehiclesData set ["staticAT", ["O_static_AT_F"]];
_vehiclesData set ["staticAA", ["O_static_AA_F"]];
