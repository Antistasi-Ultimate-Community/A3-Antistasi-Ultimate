...
_vehiclesData set ["vehiclesBasic", ["BRAF_AM11_Unarmed"]];
_vehiclesData set ["vehiclesLightUnarmed", ["BRAF_LMV_EB", "BRAF_AM21_GLO", "BRAF_AM21_Opened"]];
_vehiclesData set ["vehiclesLightArmed", ["BRAF_LMV_EB_RCWS", "BRAF_AM11_Armed"]];
_vehiclesData set ["vehiclesTrucks", ["BRAF_AM21_Covered", "BRAF_Worker_Covered"]];
_vehiclesData set ["vehiclesCargoTrucks", ["BRAF_Worker_Cargo", "BRAF_AM21_Cargo"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["BRAF_Worker_Ammo", "BRAF_AM21_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["BRAF_Worker_Repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["BRAF_Worker_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["BRAF_Worker_Health"]];
_vehiclesData set ["vehiclesLightAPCs", ["CUP_B_M113A3_USA", "CUP_B_M113A3_USA", "CUP_B_M113A1_USA"]];
_vehiclesData set ["vehiclesAPCs", ["braf_guarani_eb_remax","braf_guarani_eb_remax","braf_guarani_eb_remax"]];            // mortar carrier: "CUP_B_M1129_MC_MK19_Woodland"
_vehiclesData set ["vehiclesIFVs", ["BRAF_EE9_Cascavel_EB","BRAF_EE9_Cascavel_EB","BRAF_EE9_Cascavel_EB"]];
_vehiclesData set ["vehiclesTanks", ["CUP_B_M60A3_USMC", "CUP_B_M60A3_TTS_USMC"]];
_vehiclesData set ["vehiclesAA", ["CUP_B_M163_Vulcan_USA"]];
_vehiclesData set ["vehiclesAirborne", ["CUP_B_M113A1_USA", "CUP_B_M113A1_USA"]];
_vehiclesData set ["vehiclesLightTanks",  ["BRAF_EE9_Cascavel_EB", "braf_guarani_eb_remax"]];

_vehiclesData set ["vehiclesTransportBoats", ["braf_voadeira_01", "braf_voadeira_02", "braf_voadeira_07"]];
...
_vehiclesData set ["vehiclesHelisLight", ["BRAF_Fennec_Cargo", "BRAF_Fennec_Unarmed"]];
_vehiclesData set ["vehiclesHelisTransport", ["BRAF_Pantera_K2_2BAvEx", "BRAF_Pantera_K2_FFV_2BAvEx", "BRAF_Caracal_3", "BRAF_Pantera_K2_3BAvEx", "BRAF_Caracal_3", "BRAF_Pantera_K2_FFV_3BAvEx", "BRAF_Pantera_K2_4BAvEx", "BRAF_Pantera_K2_FFV_4BAvEx", "BRAF_Caracal_3"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["BRAF_Fennec_Armed"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["BRAF_AM11_Armed"]];
_militiaVehiclesData set ["vehiclesTrucks", ["BRAF_AM21_Covered"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["BRAF_AM11_Unarmed"]];
_militiaVehiclesData set ["vehiclesAPCs", ["CUP_B_M113A1_USA"]];
