...
_vehiclesData set ["vehiclesBasic", ["CSLA_CIV_JARA250"]];
...
_vehiclesData set ["vehiclesTruck", ["CSLA_FIA_V3S_des"]];
private _vehiclesAT = [];
private _vehicleAA = ["CSLA_FIA_PLdvK59V3S_des"];

_vehiclesData set ["vehiclesBoat", ["I_C_Boat_Transport_02_F"]];

_vehiclesData set ["vehiclesPlane", ["I_C_Plane_Civil_01_F","CSLA_CIV_An2_1"]];

private _vehiclesCivCar = ["CSLA_CIV_AZU"];
_vehiclesData set ["vehiclesCivTruck", ["CSLA_CIV_V3S"]];
_vehiclesData set ["vehiclesCivHeli", ["C_Heli_Light_01_civil_F"]];
_vehiclesData set ["vehiclesCivBoat", ["C_Boat_Civil_01_F", "C_Rubberboat"]];

_vehiclesData set ["staticMGs", ["CSLA_UK59L_Stat","FIA_DShKM_h_Stat","US85_M60E3_Stat_DES","US85_M60_Stat_DES"]];
_vehiclesData set ["staticAT", ["CSLA_9K113_Stat","FIA_AGS17_Stat"]];
private _staticAA = [];
_vehiclesData set ["staticMortars", ["CSLA_M52_Stat"]];
_vehiclesData set ["staticMortarMagHE", "CSLA_8rnd_82EOM52"];
...
_vehiclesData set ["minesAT", "CSLA_PtMiBa3_mag"];
_vehiclesData set ["minesAPERS", "CSLA_PPMiNa_mag"];
...
_vehiclesData set ["vehiclesLightUnarmed", _vehiclesLightUnarmed];
_vehiclesData set ["vehiclesLightArmed", _vehiclesLightArmed];
_vehiclesData set ["vehiclesAT", _vehiclesAT];
