class A3A_StaticMGFromGarageDisplay : A3A_GARAGEDialog
{
	idd = A3A_IDD_DISPLAYGARAGEVEHICLES;
	onLoad = "[""Static""] call A3A_fnc_ui_StaticsMGFromGarage";
	onUnload = "['onUnload'] call A3A_fnc_ui_StaticsMGFromGarage";
    //onLoad = "[""Static"", ""MG""] call A3A_fnc_ui_StaticsFromGarage";
    //onUnload = "[""onUnload"", ""MG""] call A3A_fnc_ui_StaticsFromGarage";
        ...
        class TabButtons : A3A_ControlsGroupNoScrollbars
        {
            ...
            class Controls
            {
				class VehicleTabButton : A3A_Button
                {
                    ...
                    onButtonClick = "[""Static""] call A3A_fnc_ui_StaticsMGFromGarage";
                    //onButtonClick = "[""Static"", ""MG""] call A3A_fnc_ui_StaticsFromGarage";
                    x = 0 * GRID_W;
                    y = 0;
                    w = 142 * GRID_W;
                    h = 5 * GRID_H;
