...
// Logistics nodes for "H225M Super Cougar SOCAT" (a3a_LDF_Heli_EC_02_RF)
// Generated by A3U Cargo Nodes Editor
class lxRF_air_rf_heli_medium_ec_Heli_EC_02_RF_p3d : TRIPLES(ADDON,Nodes,Base)
{
    class Nodes
    {
        class Node1
        {
            offset[] = {0.000279997, -1.9118, -1.132};
        };

        class Node2
        {
            offset[] = {0.000279997, -1.1778, -1.132};
        };
    };
};
