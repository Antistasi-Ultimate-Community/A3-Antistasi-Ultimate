...
["vehiclesLightUnarmed", ["AFR_O_Iran_tigr_msv"]] call _fnc_saveToTemplate;
["vehiclesLightArmed", ["AFR_O_Iran_tigr_sts_msv", "AFR_O_Iran_tigr_m_msv"]] call _fnc_saveToTemplate;
["vehiclesTrucks", ["AFR_O_Iran_kamaz5350", "AFR_O_Iran_kamaz5350_open_msv"]] call _fnc_saveToTemplate;
...
["vehiclesLightAPCs", ["AFR_O_Iran_btr80_msv", "AFR_O_Iran_btr80a_msv"]] call _fnc_saveToTemplate;
["vehiclesAirborne", ["rhs_bmd1", "rhs_bmd1p", "rhs_bmd1pk", "rhs_bmd2m", "rhs_bmd2", "AFR_O_Iran_bmp3mera_msv"]] call _fnc_saveToTemplate;
["vehiclesAPCs", ["rhs_bmd4m_vdv", "rhs_bmd4ma_vdv", "rhs_bmp3m_msv", "rhs_bmp3mera_msv", "rhs_bmp2e_msv", "rhs_bmp2_msv", "rhs_bmp2d_msv", "rhs_bmp2k_msv"]] call _fnc_saveToTemplate;
["vehiclesIFVs", []] call _fnc_saveToTemplate;

["vehiclesLightTanks",  ["rhs_bmd1k", "rhs_bmd1pk", "rhs_sprut_vdv", "rhs_t72ba_tv", "rhs_t80"]] call _fnc_saveToTemplate;
["vehiclesTanks", ["rhs_t80a", "rhs_t80bv", "rhs_t80u", "rhs_t80um", "rhs_t90sab_tv", "rhs_t90a_tv", "rhs_t90_tv", "rhs_t90sm_tv", "rhs_t90am_tv", "AFR_O_Iran_t90sm_tv"]] call _fnc_saveToTemplate;
...
["vehiclesPlanesCAS", ["AFR_O_Iran_su25_Iran"]] call _fnc_saveToTemplate;
["vehiclesPlanesAA", ["rhs_mig29sm_vvs", "rhs_mig29s_vvs", "RHS_T50_vvs_generic_ext"]] call _fnc_saveToTemplate;
["vehiclesPlanesTransport", []] call _fnc_saveToTemplate;

["vehiclesHelisTransport", ["AFR_O_Iran_Mi8AMT", "AFR_O_Iran_Mi8AMT_Cargo", "RHS_Mi24V_vdv"]] call _fnc_saveToTemplate;
...
["vehiclesHelisAttack", ["RHS_Ka52_vvsc", "AFR_O_Iran_MI17_Armed"]] call _fnc_saveToTemplate;
...
["vehiclesMilitiaLightArmed", ["rhsgref_BRDM2_msv", "AFR_O_Iran_tigr_m_msv"]] call _fnc_saveToTemplate;
["vehiclesMilitiaTrucks", ["AFR_O_Iran_kamaz5350_open_msv"]] call _fnc_saveToTemplate;
["vehiclesMilitiaCars", ["AFR_O_Iran_tigr_msv", "rhsgref_BRDM2UM_msv"]] call _fnc_saveToTemplate;
["vehiclesMilitiaAPCs", ["AFR_O_Iran_btr80_msv", "rhs_bmp1_msv", "rhs_bmp1d_msv"]] call _fnc_saveToTemplate;

["vehiclesPolice", ["AFR_O_Iran_tigr_m_msv", "AFR_O_Iran_kamaz5350_open_msv"]] call _fnc_saveToTemplate;
...
_loadoutData set ["traitorUniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop", "U_AFR_CSATIran_BDU_Blench_knee_nomex_trop"]];
_loadoutData set ["traitorVests", ["AFR_CSATIran_Vest_6b45_Off_IRPAT"]];
_loadoutData set ["traitorHats", ["H_Beret_CSAT_01_F"]];

_loadoutData set ["officerUniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop", "U_AFR_CSATIran_BDU_Blench_knee_nomex_trop"]];
_loadoutData set ["officerVests", ["AFR_CSATIran_Vest_6b45_Off_IRPAT"]];
...
_loadoutData set ["cloakVests", ["rhs_belt_svd", "rhs_chicom_khk"]];
...
_loadoutData set ["ATvests", ["AFR_CSATIran_Vest_6b45_Rifleman_IRPAT"]];
_loadoutData set ["MGvests", ["AFR_CSATIran_Vest_6b45_MG_IRPAT"]];
_loadoutData set ["MEDvests", ["AFR_CSATIran_Vest_6b45_IRPAT"]];
_loadoutData set ["SLvests", ["AFR_CSATIran_Vest_6b45_Off_IRPAT"]];
_loadoutData set ["SNIvests", ["AFR_CSATIran_Vest_6b45_Light_IRPAT"]];
_loadoutData set ["GLvests", ["AFR_CSATIran_Vest_6b45_Grn_IRPAT"]];
...
_loadoutData set ["slHat", ["H_Beret_CSAT_01_F", "AFR_CSATIran_6b7_1m_ess", "AFR_CSATIran_6b7_1m_ess_bala2"]];
_loadoutData set ["sniHats", ["H_Booniehat_tan", "H_Booniehat_khk_hs"]];
...
_sfLoadoutData set ["uniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop", "U_AFR_CSATIran_BDU_Blench_knee"]];
_sfLoadoutData set ["vests", ["AFR_CSATIran_Vest_6b45_IRPAT", "AFR_CSATIran_Vest_6b45_Holster_IRPAT", "AFR_CSATIran_Vest_6b45_Light_IRPAT"]];
_sfLoadoutData set ["backpacks", ["AFR_CSATIran_assault_Molle_asspack_OCP_thermos_od3_IRPAT", "AFR_CSATIran_assault_Molle_asspack_OCP_thermos_od7_IRPAT", "AFR_CSATIran_assault_Molle_asspack_OCP_wasser_IRPAT"]];
_sfLoadoutData set ["medBackpacks", ["AFR_CSATIran_assault_umbts"]];
_sfLoadoutData set ["atBackpacks", ["rhs_rpg_6b3"]];
_sfLoadoutData set ["helmets", ["H_Cap_tan", "H_Cap_oli", "H_Cap_blk", "H_Booniehat_khk"]];

_sfLoadoutData set ["goggles", ["rhsusf_shemagh2_od", "rhsusf_shemagh_od", "rhsusf_shemagh_tan", "rhsusf_shemagh2_tan"]];
_sfLoadoutData set ["glasses", ["rhsusf_shemagh2_od", "rhsusf_shemagh_od", "rhsusf_shemagh_tan", "rhsusf_shemagh2_tan"]];
...
_sfLoadoutData set ["slRifles", [
    ["rhs_weap_ak74m_zenitco01_b33", "rhs_acc_pbs1", "rhs_acc_perst3_2dp_h", "rhs_acc_rakursPM", ["rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_AK_plum_green"], [], "rhs_acc_grip_rk6"],
    ["rhs_weap_ak74m_zenitco01_b33", "rhs_acc_pbs1", "rhs_acc_perst3_2dp_h", "rhs_acc_1p87", ["rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_AK_plum_green"], [], "rhs_acc_grip_rk6"],
    ["rhs_weap_ak74m_zenitco01_b33", "rhs_acc_pbs1", "rhs_acc_perst3_2dp_h", "rhs_acc_ekp8_18", ["rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_7N10_AK", "rhs_30Rnd_545x39_AK_plum_green"], [], "rhs_acc_grip_rk6"],
...
_eliteLoadoutData set ["uniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop", "U_AFR_CSATIran_BDU_Blench_knee"]];
_eliteLoadoutData set ["vests", ["AFR_CSATIran_Vest_6b45_IRPAT", "AFR_CSATIran_Vest_6b45_Holster_IRPAT", "AFR_CSATIran_Vest_6b45_Light_IRPAT"]];
_eliteLoadoutData set ["backpacks", ["AFR_CSATIran_assault_umbts", "AFR_CSATIran_assault_Molle_asspack_OCP_thermos_IRPAT"]];
_eliteLoadoutData set ["medBackpacks", ["AFR_CSATIran_assault_umbts"]];
_eliteLoadoutData set ["atBackpacks", ["rhs_rpg_6b3"]];
_eliteLoadoutData set ["helmets", ["AFR_CSATIran_6b7_1m", "AFR_CSATIran_6b7_1m_ess", "AFR_RUS_6b47_ATACS_emr", "AFR_RUS_6b47_ATACS_emr_2"]];
...
_militaryLoadoutData set ["uniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop", "U_AFR_CSATIran_BDU_Blench_knee"]];
_militaryLoadoutData set ["vests", ["AFR_CSATIran_Vest_6b45_IRPAT", "AFR_CSATIran_Vest_6b45_Holster_IRPAT", "AFR_CSATIran_Vest_6b45_Light_IRPAT"]];
_militaryLoadoutData set ["backpacks", ["AFR_CSATIran_assault_umbts", "AFR_CSATIran_assault_Molle_asspack_OCP_thermos_IRPAT"]];
_militaryLoadoutData set ["medBackpacks", ["AFR_CSATIran_assault_umbts"]];
_militaryLoadoutData set ["atBackpacks", ["rhs_rpg_6b3"]];
_militaryLoadoutData set ["helmets", ["AFR_CSATIran_6b7_1m", "AFR_CSATIran_6b7_1m_ess", "AFR_RUS_6b47_ATACS_emr", "AFR_RUS_6b47_ATACS_emr_2"]];
...
_policeLoadoutData set ["uniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop"]];
_policeLoadoutData set ["vests", ["AFR_CSATIran_Vest_6b45_Light_IRPAT", "AFR_CSATIran_Vest_6b45_Holster_IRPAT", "AFR_CSATIran_Vest_6b45_IRPAT_2"]];
_policeLoadoutData set ["helmets", ["rhsusf_bowman_cap", "H_Bandanna_sand", "H_Beret_blk"]];
...
_militiaLoadoutData set ["uniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop", "U_AFR_CSATIran_BDU_Blench_knee"]];
_militiaLoadoutData set ["vests", ["AFR_CSATIran_Vest_6b45_IRPAT", "AFR_CSATIran_Vest_6b45_Holster_IRPAT", "AFR_CSATIran_Vest_6b45_Light_IRPAT"]];
_militiaLoadoutData set ["backpacks", ["AFR_CSATIran_assault_Molle_asspack_OCP_thermos_od3_IRPAT", "AFR_CSATIran_assault_Molle_asspack_OCP_wasser_IRPAT", "AFR_CSATIran_assault_Molle_asspack_Low_OCP_thermos_IRPAT", "AFR_CSATIran_assault_Molle_asspack_OCP_thermos_IRPAT", "AFR_CSATIran_assault_umbts"]];
_militiaLoadoutData set ["medBackpacks", ["AFR_CSATIran_assault_umbts"]];
_militiaLoadoutData set ["atBackpacks", ["rhs_rpg_6b3"]];
_militiaLoadoutData set ["helmets", ["AFR_CSATIran_6b7_1m", "AFR_CSATIran_6b7_1m_ess", "AFR_RUS_6b47_ATACS_emr", "AFR_RUS_6b47_ATACS_emr_2", "H_Bandanna_sand", "H_Bandanna_cbr", "H_Bandanna_khk_hs"]];
...
_crewLoadoutData set ["vests", ["AFR_CSATIran_Vest_6b45_IRPAT_2", "AFR_CSATIran_Vest_6b45_IRPAT", "AFR_CSATIran_Vest_6b45_Holster_IRPAT"]];
...
_pilotLoadoutData set ["uniforms", ["U_AFR_CSATIran_BDU_Blench", "U_AFR_CSATIran_BDU_Blench_trop"]];			
