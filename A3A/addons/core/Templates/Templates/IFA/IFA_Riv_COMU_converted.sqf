...
_vehiclesData set ["vehiclesLightArmed", ["LIB_Kfz1_MG42"]];
_vehiclesData set ["vehiclesTrucks", ["LIB_Zis5v"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_GazM1_SOV"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_SdKfz251_captured", "LIB_SdKfz251_captured_FFV"]];
_vehiclesData set ["vehiclesTanks", ["LIB_M4A2_SOV", "LIB_T34_76"]];
_vehiclesData set ["vehiclesHelis", ["LIB_Li2"]];			
