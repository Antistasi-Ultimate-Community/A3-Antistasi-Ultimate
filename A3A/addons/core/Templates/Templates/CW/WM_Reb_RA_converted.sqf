...
_vehiclesData set ["vehiclesTruck", ["CW_rebel_argon_covered"]];
_vehiclesData set ["vehiclesAT", ["WM_AAC_Speeder_Rocket"]];
_vehiclesData set ["vehiclesAA", ["WM_AAC_Speeder"]];

_vehiclesData set ["vehiclesBoat", ["I_C_Boat_Transport_02_F"]];

_vehiclesData set ["vehiclesPlane", ["442_a10_plane_cas", "3AS_Civilian_Transport_01"]];
