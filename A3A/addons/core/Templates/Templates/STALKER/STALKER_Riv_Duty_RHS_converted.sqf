...
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_cdf_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz"]];
_vehiclesData set ["vehiclesTrucks", ["RHS_Ural_Open_MSV_01", "RHS_Ural_MSV_01"]];
_vehiclesData set ["vehiclesLightUnarmed", ["I_G_Offroad_01_F"]];
_vehiclesData set ["vehiclesAPCs", ["rhs_btr60_msv", "rhsgref_BRDM2_msv"]];
_vehiclesData set ["vehiclesTanks", ["rhs_t72ba_tv", "rhs_t80"]];
_vehiclesData set ["vehiclesHelis", ["RHS_MELB_AH6M"]];			
_vehiclesData set ["vehiclesUavs", ["rhs_pchela1t_vvs"]];			
...
_vehiclesData set ["staticMortars", ["rhsgref_ins_g_2b14"]];
