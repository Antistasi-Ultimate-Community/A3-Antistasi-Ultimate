...
_vehiclesData set ["vehiclesBasic", ["SPE_GER_R200_Unarmed"]];
_vehiclesData set ["vehiclesLightUnarmed", ["SPE_GER_R200_Unarmed", "SPE_GER_R200_Hood"]];
_vehiclesData set ["vehiclesLightArmed", ["SPE_GER_R200_MG34", "LIB_SdKfz251", "SPE_ST_OpelBlitz_Flak38"]];
_vehiclesData set ["vehiclesTrucks", ["SPE_OpelBlitz_Open", "SPE_OpelBlitz", "LIB_SdKfz_7"]];
_vehiclesData set ["vehiclesCargoTrucks", ["SPE_OpelBlitz_Open"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["SPE_OpelBlitz_Ammo", "LIB_SdKfz_7_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["SPE_OpelBlitz_Repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["SPE_OpelBlitz_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["SPE_OpelBlitz_Ambulance"]];
_vehiclesData set ["vehiclesLightAPCs", ["SPE_SdKfz250_1", "LIB_SdKfz251"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_SdKfz251_FFV", "SPE_PzKpfwIII_J"]];
_vehiclesData set ["vehiclesIFVs", ["SPE_PzKpfwIII_N", "SPE_PzKpfwIII_M", "SPE_PzKpfwIII_L", "SPE_StuG_III_G_Early", "SPE_StuG_III_G_Late", "SPE_StuG_III_G_SKB", "SPE_StuH_42"]];
_vehiclesData set ["vehiclesTanks", ["SPE_PzKpfwVI_H1", "SPE_PzKpfwV_G", "SPE_PzKpfwIV_G", "SPE_Jagdpanther_G1"]];
_vehiclesData set ["vehiclesAA", ["SPE_ST_OpelBlitz_Flak38", "LIB_SdKfz_7_AA", "LIB_FlakPanzerIV_Wirbelwind"]];
_vehiclesData set ["vehiclesAirborne", ["SPE_SdKfz250_1"]];
_vehiclesData set ["vehiclesLightTanks",  ["SPE_PzKpfwIII_J"]];

_vehiclesData set ["vehiclesTransportBoats", ["B_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["B_Boat_Transport_01_F"]];
...
_vehiclesData set ["vehiclesArtillery", ["SPE_leFH18"]];
...
_vehiclesData set ["vehiclesPolice", ["SPE_Milice_R200_Unarmed"]];

_vehiclesData set ["staticMGs", ["SPE_MG42_Lafette_trench_Deployed", "SPE_MG34_Lafette_Trench_Deployed"]];
_vehiclesData set ["staticAT", ["SPE_leFH18_AT", "SPE_Pak40"]];
_vehiclesData set ["staticAA", ["SPE_FlaK_30", "SPE_FlaK_38"]];
_vehiclesData set ["staticMortars", ["SPE_GrW278_1"]];
_vehiclesData set ["staticHowitzers", ["SPE_leFH18"]];
...
_vehiclesData set ["mortarMagazineHE", "SPE_8Rnd_81mm_FA_Mle_1932_HE"];
_vehiclesData set ["mortarMagazineSmoke", "SPE_8Rnd_81mm_FA_Mle_1932_Smoke"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["SPE_ST_R200_MG34"]];
_militiaVehiclesData set ["vehiclesTrucks", ["SPE_ST_OpelBlitz_Open"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["SPE_ST_R200_Unarmed"]];
_militiaVehiclesData set ["vehiclesAPCs", ["SPE_SdKfz250_1"]];
