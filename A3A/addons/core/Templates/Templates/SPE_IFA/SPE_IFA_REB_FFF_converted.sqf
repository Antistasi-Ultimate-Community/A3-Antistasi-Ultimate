...
_vehiclesData set ["vehiclesBasic", ["LIB_Kfz1_sernyt"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1_Hood_sernyt","LIB_UK_Willys_MB_Hood"]];
_vehiclesData set ["vehiclesLightArmed", ["LIB_UK_Willys_MB_M1919","LIB_Kfz1_MG42_sernyt"]];
_vehiclesData set ["vehiclesTruck", ["LIB_US6_Open"]];
_vehiclesData set ["vehiclesAT", []];
...
_vehiclesData set ["vehiclesPlane", ["SPE_FW190F8"]];
