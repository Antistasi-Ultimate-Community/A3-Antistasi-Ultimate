...
_vehiclesData set ["vehiclesBasic", ["gm_gc_army_p601"]];
_vehiclesData set ["vehiclesLightUnarmed", ["gm_gc_army_uaz469_cargo_un", "gm_gc_army_uaz469_cargo_win", "gm_gc_army_uaz469_cargo_un", "gm_gc_army_uaz469_cargo_win", 
...
_vehiclesData set ["vehiclesTrucks", ["gm_gc_army_btr60pa_win", "gm_gc_army_btr60pa_un", "gm_gc_army_ural375d_cargo_un", "gm_gc_army_ural4320_cargo_un", 
...
_vehiclesData set ["vehiclesCargoTrucks", ["gm_gc_army_ural4320_cargo_olw", "gm_gc_army_ural375d_cargo_olw", "gm_gc_army_ural375d_cargo_un", "gm_gc_army_ural4320_cargo_un", "gm_gc_army_ural4320_cargo_win", "gm_gc_army_ural375d_cargo_win", "gm_gc_army_ural44202_win", "gm_gc_army_ural44202_un", "gm_gc_army_ural44202_olw"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["gm_gc_army_ural4320_reammo_win", "gm_gc_army_ural4320_reammo_un", "gm_gc_army_ural4320_reammo_olw"]];
_vehiclesData set ["vehiclesRepairTrucks", ["gm_gc_army_ural4320_repair_win", "gm_gc_army_ural4320_repair_un", "gm_gc_army_ural4320_repair_olw"]];
_vehiclesData set ["vehiclesFuelTrucks", ["gm_gc_army_ural375d_refuel_un", "gm_gc_army_ural375d_refuel_olw", "gm_gc_army_ural375d_refuel_win"]];
_vehiclesData set ["vehiclesMedical", ["gm_gc_army_ural375d_medic_win", "gm_gc_army_ural375d_medic_un", "gm_gc_army_ural375d_medic_olw"]];
_vehiclesData set ["vehiclesLightAPCs", ["gm_gc_army_btr60pb_win", "gm_gc_army_btr60pb_un", "gm_gc_army_btr60pb_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU", 
    "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU", "gm_gc_army_btr60pa_dshkm_win", "gm_gc_army_btr60pa_dshkm_un", "gm_gc_army_btr60pa_dshkm_olw"]];
_vehiclesData set ["vehiclesAPCs", ["gm_pl_army_ot64a_olw", "gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BTR80_CAMO_RU", "CUP_O_BTR80A_CAMO_RU"]];
_vehiclesData set ["vehiclesIFVs", ["gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU"]];
_vehiclesData set ["vehiclesTanks", ["gm_gc_army_pt76b_win", "gm_gc_army_t55_win", "gm_gc_army_t55a_win", "gm_gc_army_t55ak_win", "gm_gc_army_t55am2_win", "gm_gc_army_t55am2b_win", "gm_gc_army_pt76b_un", "gm_gc_army_t55_un", "gm_gc_army_t55a_un", "gm_gc_army_t55ak_un", "gm_gc_army_t55am2_un", "gm_gc_army_t55am2_un", "gm_gc_army_pt76b_olw", "gm_gc_army_t55_olw", "gm_gc_army_t55a_olw", "gm_gc_army_t55ak_olw", "gm_gc_army_t55am2_olw", "gm_gc_army_t55am2b_olw"]];
_vehiclesData set ["vehiclesAA", ["gm_gc_army_zsu234v1_win", "gm_gc_army_zsu234v1_un", "gm_gc_army_zsu234v1_olw", "CUP_O_Ural_ZU23_RU"]];

_vehiclesData set ["vehiclesAirborne", ["gm_gc_army_btr60pb_win", "gm_gc_army_btr60pb_un", "gm_gc_army_btr60pb_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU", 
    "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU", "gm_gc_army_btr60pa_dshkm_win", "gm_gc_army_btr60pa_dshkm_un", "gm_gc_army_btr60pa_dshkm_olw"]];
_vehiclesData set ["vehiclesLightTanks",  ["gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU"]];

_vehiclesData set ["vehiclesTransportBoats", ["CUP_O_PBX_RU"]];
_vehiclesData set ["vehiclesGunBoats", ["CUP_B_RHIB2Turret_USMC"]];
_vehiclesData set ["vehiclesAmphibious", ["gm_gc_army_bmp1sp2_olw", "gm_gc_army_bmp1sp2_un", "gm_gc_army_bmp1sp2_win", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU", "CUP_O_BTR80A_CAMO_RU","gm_gc_army_brdm2_win", "gm_gc_army_brdm2_un", "gm_gc_army_brdm2_olw", "gm_gc_army_btr60pa_win", "gm_gc_army_btr60pa_un", "gm_gc_army_btr60pa_olw",
    "gm_gc_army_btr60pu12_un", "gm_gc_army_btr60pu12_win", "gm_gc_army_btr60pu12_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU"]];

_vehiclesData set ["vehiclesPlanesCAS", ["CUP_O_Su25_Dyn_RU"]];
_vehiclesData set ["vehiclesPlanesAA", ["CUP_O_SU34_RU"]];
_vehiclesData set ["vehiclesPlanesTransport", ["gm_gc_airforce_l410t"]];

_vehiclesData set ["vehiclesHelisLight", ["gm_pl_airforce_mi2ch_un", "gm_gc_airforce_mi2p_un"]];
_vehiclesData set ["vehiclesHelisTransport", ["gm_gc_airforce_mi2t_un", "gm_pl_airforce_mi2t_un", "CUP_O_Mi8AMT_RU"]];
_vehiclesData set ["vehiclesHelisAttack", ["CUP_O_Mi24_P_Dynamic_RU"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["gm_gc_airforce_mi2urn_un", "gm_gc_airforce_mi2us_un", "gm_pl_airforce_mi2urp_un", "gm_pl_airforce_mi2urpg_un", "CUP_O_Mi8_RU"]];

_vehiclesData set ["vehiclesArtillery", ["gm_gc_army_2s1_win", "gm_gc_army_ural375d_mlrs_win", "gm_gc_army_2s1_un", "gm_gc_army_ural375d_mlrs_un", "gm_gc_army_2s1_olw", "gm_gc_army_ural375d_mlrs_olw"]];
...
_vehiclesData set ["vehiclesPolice", ["gm_gc_pol_p601"]];

_vehiclesData set ["staticMGs", ["gm_pl_army_dshkm_aatripod", "gm_gc_army_dshkm_aatripod"]];
_vehiclesData set ["staticAT", ["gm_gc_army_spg9_tripod", "gm_gc_army_fagot_launcher_tripod", "gm_pl_army_fagot_launcher_tripod", "gm_pl_army_spg9_tripod"]];
_vehiclesData set ["staticAA", ["CUP_O_Igla_AA_pod_RU", "CUP_O_ZU23_RU"]];
_vehiclesData set ["staticMortars", ["CUP_O_2b14_82mm_RU"]];
...
_vehiclesData set ["minefieldAT", ["gm_minestatic_at_tm46"]];
_vehiclesData set ["minefieldAPERS", ["gm_minestatic_ap_pfm1"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["gm_pl_army_uaz469_dshkm_olw"]];
_militiaVehiclesData set ["vehiclesTrucks", ["gm_pl_army_ural4320_cargo_olw"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["gm_pl_army_uaz469_cargo_olw"]];
_militiaVehiclesData set ["vehiclesAPCs", ["gm_gc_army_btr60pb_win", "gm_gc_army_btr60pb_un", "gm_gc_army_btr60pb_olw", "CUP_O_GAZ_Vodnik_Unarmed_RU", 
    "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU", "gm_gc_army_btr60pa_dshkm_win", "gm_gc_army_btr60pa_dshkm_un", "gm_gc_army_btr60pa_dshkm_olw"]];
