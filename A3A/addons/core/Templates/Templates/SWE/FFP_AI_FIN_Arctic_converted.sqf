...
["vehiclesLightUnarmed", ["ffp_bv206", "ffp_rg32m"]]; 		//this line determines light and unarmed vehicles. -- Example: _vehiclesData set ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
["vehiclesLightArmed",["sfp_tgb16_ksp58", "sfp_tgb16_rws"]]; 		//this line determines light and armed vehicles -- Example: ["vehiclesLightArmed",["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
_vehiclesData set ["vehiclesTrucks", ["ffp_susi_sa420", "ffp_susi_sa420_covered"]]; 			//this line determines the trucks -- Example: _vehiclesData set ["vehiclesTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
["vehiclesCargoTrucks", ["ffp_susi_sa420", "ffp_susi_sa420_covered"]]; 		//this line determines cargo trucks -- Example: _vehiclesData set ["vehiclesCargoTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
["vehiclesAmmoTrucks", ["ffp_susi8x8_ammo"]]; 		//this line determines ammo trucks -- Example: _vehiclesData set ["vehiclesAmmoTrucks", ["B_Truck_01_ammo_F"]] -- Array, can contain multiple assets
["vehiclesRepairTrucks", ["ffp_susi_sa420_repair"]]; 		//this line determines repair trucks -- Example: _vehiclesData set ["vehiclesRepairTrucks", ["B_Truck_01_Repair_F"]] -- Array, can contain multiple assets
["vehiclesFuelTrucks", ["ffp_susi_sa420_fuel"]];		//this line determines fuel trucks -- Array, can contain multiple assets
_vehiclesData set ["vehiclesMedical", ["ffp_van_ambulance"]];			//this line determines medical vehicles -- Array, can contain multiple assets
_vehiclesData set ["vehiclesAPCs", ["ffp_bmp2", "ffp_bmp2_atgm", "ffp_cv9030"]]; 				//this line determines APCs -- Example: _vehiclesData set ["vehiclesAPCs", ["B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_CRV_F"]] -- Array, can contain multiple assets
["vehiclesTanks", ["ffp_leopard2a4", "ffp_leopard2a6"]]; 			//this line determines tanks -- Example: _vehiclesData set ["vehiclesTanks", ["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"]] -- Array, can contain multiple assets
["vehiclesAA", ["sfp_lvkv90c"]]; 				//this line determines AA vehicles -- Example: _vehiclesData set ["vehiclesAA", ["B_APC_Tracked_01_AA_F"]] -- Array, can contain multiple assets
["vehiclesLightAPCs", _vehiclesLightAPCs];			//this line determines light APCs
...
_vehiclesData set ["vehiclesTransportBoats", ["ffp_gruppbat"]]; 	//this line determines transport boats -- Example: _vehiclesData set ["vehiclesTransportBoats", ["B_Boat_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesGunBoats", ["sfp_strb90", "sfp_strb90_rws"]]; 			//this line determines gun boats -- Example: _vehiclesData set ["vehiclesGunBoats", ["B_Boat_Armed_01_minigun_F"]] -- Array, can contain multiple assets
...
["vehiclesPlanesCAS", ["ffp_jas39e", "ffp_jas39e_rb15"]]; 		//this line determines CAS planes -- Example: _vehiclesData set ["vehiclesPlanesCAS", ["B_Plane_CAS_01_dynamicLoadout_F"]] -- Array, can contain multiple assets
["vehiclesPlanesAA", ["ffp_jas39e", "ffp_jas39e_rb15"]]; 			//this line determines air supperiority planes -- Example: _vehiclesData set ["vehiclesPlanesAA", ["B_Plane_Fighter_01_F"]] -- Array, can contain multiple assets
["vehiclesPlanesTransport", []]; 	//this line determines transport planes -- Example: _vehiclesData set ["vehiclesPlanesTransport", ["B_T_VTOL_01_infantry_F"]] -- Array, can contain multiple assets

["vehiclesHelisLight", ["ffp_md500"]]; 		//this line determines light helis -- Example: _vehiclesData set ["vehiclesHelisLight", ["B_Heli_Light_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisTransport", ["ffp_nh90"]]; 	//this line determines transport helis -- Example: _vehiclesData set ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisLightAttack", ["ffp_nh90_armed"]];		// this line determines light attack helicopters
...
["vehiclesArtillery", ["ffp_rsrakh06"]];		//this line determines SPAs
...
["uavsPortable", ["ffp_orbiter"]]; 				//this line determines portable UAVs -- Example: _vehiclesData set ["uavsPortable", ["B_UAV_01_F"]] -- Array, can contain multiple assets

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:
						//this line determines militia APCs

_vehiclesData set ["vehiclesPolice", ["ffp_rg32m"]]; 			//this line determines police cars -- Example: _vehiclesData set ["vehiclesPolice", ["B_GEN_Offroad_01_gen_F"]] -- Array, can contain multiple assets
...
_vehiclesData set ["staticAT", ["ffp_pstohj83"]]; 					//this line determinesstatic ATs -- Example: _vehiclesData set ["staticAT", ["B_static_AT_F"]] -- Array, can contain multiple assets
["staticAA", ["CUP_B_ZU23_CDF", "ffp_ito2005m"]]; 					//this line determines static AAs -- Example: _vehiclesData set ["staticAA", ["B_static_AA_F"]] -- Array, can contain multiple assets
...
["staticHowitzers", ["ffp_122h63"]];							//this line determines static howitzers. Basically it's just a stronger mortar, use same syntax as above.
...
["howitzerMagazineHE", "32Rnd_155mm_Mo_shells"];			//this line determines available HE-shells for the static howitzers - !needs to be compatible with the howitzer! -- same syntax as above - ENTER ONLY ONE OPTION

//Minefield definition
_vehiclesData set ["minefieldAT", ["ffp_telamiina"]];
_vehiclesData set ["minefieldAPERS", ["ffp_sm_65_98"]];
