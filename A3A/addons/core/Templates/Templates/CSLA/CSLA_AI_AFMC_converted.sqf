...
_vehiclesData set ["vehiclesBasic", ["AFMC_M1008_S250"]];
_vehiclesData set ["vehiclesLightUnarmed", ["AFMC_M1008"]];
_vehiclesData set ["vehiclesLightArmed", ["US85_M998SFGT","AFMC_M1008_MK19","AFMC_M923A1_GT"]];
_vehiclesData set ["vehiclesTrucks", ["AFMC_M923o","AFMC_M923c"]];
_vehiclesData set ["vehiclesCargoTrucks", ["AFMC_M1008c","AFMC_M923cargo"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["AFMC_M923a"]];
_vehiclesData set ["vehiclesRepairTrucks", ["AFMC_M113A2_DTP","AFMC_M923r"]];
_vehiclesData set ["vehiclesFuelTrucks", ["AFMC_M923f"]];
_vehiclesData set ["vehiclesMedical", ["AFMC_M113A2_AMB"]];
_vehiclesData set ["vehiclesLightAPCs", []];
_vehiclesData set ["vehiclesAPCs", ["AFMC_LAV25"]];
_vehiclesData set ["vehiclesIFVs", ["AFMC_M113A1","AFMC_M113A2ext","AFMC_M113A1_Mk19"]];
_vehiclesData set ["vehiclesTanks", ["AFMC_M1A1"]];
_vehiclesData set ["vehiclesAA", ["AFMC_M163"]];
_vehiclesData set ["vehiclesLightTanks", ["AFMC_M1IP"]];  
_vehiclesData set ["vehiclesTransportBoats", ["US85_zodiac"]];
_vehiclesData set ["vehiclesGunBoats", ["B_Boat_Armed_01_minigun_F"]];
_vehiclesData set ["vehiclesAirborne", ["AFMC_LAV25"]];
...
_vehiclesData set ["vehiclesHelisLight", ["AFMC_UH60"]];
_vehiclesData set ["vehiclesHelisTransport", ["AFMC_UH60M240","AFMC_UH60"]];
_vehiclesData set ["vehiclesHelisLightAttack", []];
_vehiclesData set ["vehiclesHelisAttack", ["AFMC_AH1F"]];

_vehiclesData set ["vehiclesArtillery", ["AFMC_M270"]];
...
_vehiclesData set ["staticMGs", ["AFMC_M2h"]];
_vehiclesData set ["staticAT", ["AFMC_TOW_Stat","AFMC_Mk19"]];
_vehiclesData set ["staticAA", []];
_vehiclesData set ["staticMortars", ["AFMC_M252_Stat"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["AFMC_M1008_M2"]];
_militiaVehiclesData set ["vehiclesTrucks", ["AFMC_M923o","AFMC_M923c"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["AFMC_M1008"]];
_militiaVehiclesData set ["vehiclesAPCs", ["AFMC_M113A1"]];
