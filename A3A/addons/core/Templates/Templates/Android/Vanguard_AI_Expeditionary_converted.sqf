...
_vehiclesData set ["vehiclesLightUnarmed", ["ssv_vanguard_vehicle_m12_black", "ssv_vanguard_vehicle_m813_black"]];
_vehiclesData set ["vehiclesLightArmed", ["ssv_vanguard_vehicle_m12_mg_black"]];
_vehiclesData set ["vehiclesTrucks", ["OPTRE_m1015_mule_cma", "OPTRE_m1015_mule_cover_cma"]];
_vehiclesData set ["vehiclesCargoTrucks", ["OPTRE_m1015_mule_cma", "OPTRE_m1015_mule_cover_cma"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["OPTRE_m1015_mule_ammo_cma"]];
_vehiclesData set ["vehiclesRepairTrucks", ["OPTRE_m1015_mule_repair_cma"]];
_vehiclesData set ["vehiclesFuelTrucks", ["OPTRE_m1015_mule_fuel_cma"]];
_vehiclesData set ["vehiclesMedical", ["SSV_Vehicle_Vanguard_Ifrit", "OPTRE_M12_FAV_APC_MED_CMA"]];
_vehiclesData set ["vehiclesLightAPCs", ["ssv_vanguard_vehicle_m411_black", "ssv_vanguard_vehicle_m412_black"]];
_vehiclesData set ["vehiclesAirborne", ["ssv_vanguard_vehicle_m413_black", "ssv_vanguard_vehicle_m494_black", "SSV_Vehicle_Vanguard_Futura_Tank"]];
_vehiclesData set ["vehiclesAPCs", ["ssv_vanguard_vehicle_m413_black", "ssv_vanguard_vehicle_m494_black"]];
_vehiclesData set ["vehiclesIFVs", ["ssv_vanguard_vehicle_m494_black"]];
_vehiclesData set ["vehiclesLightTanks",  ["OPTRE_M808B_CMA"]];
_vehiclesData set ["vehiclesTanks", ["SSV_Vehicle_Vanguard_Futura_Tank", "ssv_vanguard_vehicle_m808b_black"]];
_vehiclesData set ["vehiclesAA", ["ssv_vanguard_vehicle_m808b2a1_black"]];

_vehiclesData set ["vehiclesTransportBoats", ["ssv_vanguard_vehicle_catfish_black"]];
_vehiclesData set ["vehiclesGunBoats", ["ssv_vanguard_vehicle_catfish_mg_black", "ssv_vanguard_vehicle_catfish_aa_black"]];
_vehiclesData set ["vehiclesAmphibious", ["SSV_Vehicle_Vanguard_APC"]];

_vehiclesData set ["vehiclesPlanesCAS", ["OPTRE_YSS_1000_A"]];
_vehiclesData set ["vehiclesPlanesAA", ["OPTRE_YSS_1000_A"]];
_vehiclesData set ["vehiclesPlanesTransport", ["SSV_Vehicle_Vanguard_VTOL_Infantry"]];

_vehiclesData set ["vehiclesHelisLight", ["ssv_vanguard_vehicle_falcon_black"]];
_vehiclesData set ["vehiclesHelisTransport", ["ssv_vanguard_vehicle_pelican_unarmed_black"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["ssv_vanguard_vehicle_hornet_CAS_black"]];
_vehiclesData set ["vehiclesHelisAttack", ["ssv_vanguard_vehicle_hornet_CAS_black"]];

_vehiclesData set ["vehiclesArtillery", ["ssv_vanguard_vehicle_m875_black"]];
["magazines", createHashMapFromArray [
    ["ssv_vanguard_vehicle_m875_black",["32Rnd_155mm_Mo_shells"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["OPTRE_Wombat_B_CMA", "OPTRE_Wombat_CMA"]];
_vehiclesData set ["uavsPortable", ["SSV_Drone_Cargo"]];



_vehiclesData set ["vehiclesPolice", ["OPTRE_M12_FAV_PD"]];

_vehiclesData set ["staticMGs", ["OPTRE_Static_M247H_Tripod"]];
_vehiclesData set ["staticAT", ["OPTRE_Static_FG75_CMA"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_LRV_CMA"]];
_militiaVehiclesData set ["vehiclesTrucks", ["OPTRE_m1015_mule_cover_cma"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["SSV_Vehicle_Vanguard_Ifrit"]];
_militiaVehiclesData set ["vehiclesAPCs", ["SSV_Vehicle_Vanguard_APC", "OPTRE_M12_FAV_APC_CMA"]];
