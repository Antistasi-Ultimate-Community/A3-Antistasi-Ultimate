...
_vehiclesData set ["vehiclesDropPod", ["3as_droid_container"]]; //"ls_ground_droidDispenser"

["ammobox", "B_supplyCrate_F"] call _fnc_saveToTemplate;     //Don't touch or you die a sad and lonely death!
["surrenderCrate", "Box_IND_Wps_F"] call _fnc_saveToTemplate; //Changeing this from default will require you to define logistics attachement offset for the box type
["equipmentBox", "Box_NATO_Equip_F"] call _fnc_saveToTemplate; //Changeing this from default will require you to define logistics attachement offset for the box type

_vehiclesData set ["vehiclesBasic", ["3AS_Fliknot_F"]]; 			//this line determines basic vehicles, the lightest kind available. -- Example: _vehiclesData set ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["3AS_Combat_Speeder_F"]]; 		
["vehiclesLightArmed",["3AS_Combat_Speeder_F", "lsd_car_ast"]] call _fnc_saveToTemplate; 		
_vehiclesData set ["vehiclesTrucks", ["442_argon_covered_cis"]]; 			
_vehiclesData set ["vehiclesCargoTrucks", ["442_argon_covered_cis", "442_argon_transport_cis"]]; 	
_vehiclesData set ["vehiclesAmmoTrucks", ["442_argon_ammo_cis"]]; 
_vehiclesData set ["vehiclesRepairTrucks", ["3AS_SAC_Repair_F"]]; 	
_vehiclesData set ["vehiclesFuelTrucks", ["442_argon_fuel_cis"]];		
_vehiclesData set ["vehiclesMedical", ["442_argon_medical_cis"]];
_vehiclesData set ["vehiclesLightAPCs", ["3AS_SAC_F"]];
_vehiclesData set ["vehiclesAirborne", ["3AS_Advanced_DSD", "3AS_PAC_F"]];
_vehiclesData set ["vehiclesAPCs", ["3AS_PAC_F"]];
_vehiclesData set ["vehiclesIFVs", ["3AS_AAT_CIS"]];
_vehiclesData set ["vehiclesLightTanks",  ["3AS_N99","3AS_Advanced_DSD","3AS_Heavy_AAT_Flamer_F"]];
_vehiclesData set ["vehiclesTanks", ["3AS_AAT_CIS", "3AS_AAT_CIS", "3AS_GAT", "3AS_N99"]];
_vehiclesData set ["vehiclesAA", ["3AS_GAT_Light"]];

_vehiclesData set ["vehiclesTransportBoats", ["B_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["442_boat_armed"]];
_vehiclesData set ["vehiclesAmphibious", []];

_vehiclesData set ["vehiclesPlanesCAS", ["3AS_BTLB_Bomber_Shadow"]];
_vehiclesData set ["vehiclesPlanesLargeCAS", ["3AS_CIS_Vulture_CAS_F","3AS_CIS_Vulture_CAS_F","3AS_CIS_Vulture_CAS_F","3AS_CIS_Vulture_CAS_F","3AS_CIS_Vulture_CAS_F","3AS_CIS_Vulture_CAS_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["3AS_Z95_Blue"]];
_vehiclesData set ["vehiclesPlanesLargeAA", ["3AS_CIS_Vulture_AA_F","3AS_CIS_Vulture_AA_F","3AS_CIS_Vulture_AA_F","3AS_CIS_Vulture_AA_F","3AS_CIS_Vulture_AA_F","3AS_CIS_Vulture_AA_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["3AS_Civilian_Transport_01"]];

_vehiclesData set ["vehiclesPlanesGunship", ["ls_cis_hmp","3AS_HMP_Gunship"]];

_vehiclesData set ["vehiclesHelisLight", ["3AS_Patrol_LAAT_Police"]]; 		//this line determines light helis -- Example: _vehiclesData set ["vehiclesHelisLight", ["B_Heli_Light_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisTransport", ["3AS_HMP_Transport", "3AS_MAF_Transport_F"]]; 	//this line determines transport helis -- Example: _vehiclesData set ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisLightAttack", ["3AS_MAF_Gunship_F"]];
_vehiclesData set ["vehiclesHelisAttack", ["3AS_HMP_Gunship"]]; 		

_vehiclesData set ["vehiclesArtillery", ["3AS_Hailfire_Rocket","3AS_Heavy_AAT_Defoliator_F"]];
["magazines", createHashMapFromArray [
["3AS_Hailfire_Rocket", ["12Rnd_230mm_rockets"]],
["3AS_Heavy_AAT_Defoliator_F", ["3AS_6Rnd_200mm_Mo_shells"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["lsd_ground_agtRaptor"]];
_vehiclesData set ["uavsPortable", ["3as_CIS_ScavDroid"]];

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:


_vehiclesData set ["vehiclesPolice", ["3AS_ISP_Transport"]];

_vehiclesData set ["staticMGs", ["3AS_J10s_F"]];
_vehiclesData set ["staticAT", ["3as_ParticleCannon"]];
_vehiclesData set ["staticAA", ["AA_Turret"]];
_vehiclesData set ["staticMortars", ["3AS_CIS_Mortar"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "lsd_cis_radarDish"];
_vehiclesData set ["vehicleSam", "3as_FlakCannon"];
...
_vehiclesData set ["minefieldAPERS", ["APERSMine", "APERSBoundingMine_Range_Mag"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["3AS_ISP"]];
_militiaVehiclesData set ["vehiclesTrucks", ["442_argon_transport_cis"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["3AS_ISP_Transport"]];
_militiaVehiclesData set ["vehiclesAPCs", ["3AS_SAC_F"]];
