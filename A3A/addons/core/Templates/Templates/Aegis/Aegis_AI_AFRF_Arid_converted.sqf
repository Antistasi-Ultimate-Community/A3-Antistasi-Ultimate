...
_vehiclesData set ["vehiclesSDV", ["O_SDV_01_F"]];

_vehiclesData set ["vehiclesDropPod", ["Land_Pod_Heli_Transport_04_covered_F"]];
...
_vehiclesData set ["vehiclesBasic", ["O_R_Quadbike_01_F"]];
...
_vehiclesData set ["vehiclesLightUnarmed", _lightUnarmed];
_vehiclesData set ["vehiclesLightArmed", _lightArmed];

_vehiclesData set ["vehiclesTrucks", ["O_R_Truck_03_covered_ard_F","O_R_Truck_03_transport_ard_F"]];
_vehiclesData set ["vehiclesCargoTrucks", ["O_R_Truck_02_flatbed_ard_F", "O_R_Truck_02_cargo_ard_F","O_R_UGV_01_F"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["O_R_Truck_03_ammo_ard_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["O_R_Truck_02_box_ard_F", "O_R_Truck_02_box_ard_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["O_R_Truck_03_fuel_ard_F", "O_R_Truck_02_fuel_ard_F"]];
_vehiclesData set ["vehiclesMedical", ["O_R_Truck_03_medical_ard_F", "O_R_Truck_02_medical_ard_F", "O_R_APC_Tracked_02_medical_ard_F"]];
_vehiclesData set ["vehiclesLightAPCs", ["O_R_APC_Wheeled_04_cannon_ard_F"]];
_vehiclesData set ["vehiclesAPCs", ["Aegis_O_R_APC_Tracked_02_30mm_ard_lxWS"]];
_vehiclesData set ["vehiclesIFVs", ["Aegis_O_R_APC_Tracked_02_30mm_ard_lxWS"]];
_vehiclesData set ["vehiclesAirborne", ["O_R_APC_Wheeled_04_cannon_ard_F","O_R_UGV_01_rcws_F"]];
_vehiclesData set ["vehiclesLightTanks", ["O_R_UGV_01_rcws_F"]];
private _tanks = ["O_R_MBT_02_cannon_ard_F"];
if (_hasTanks) then {
    _tanks append ["O_R_MBT_04_cannon_ard_F", "O_R_MBT_04_command_ard_F"];
};
_vehiclesData set ["vehiclesTanks", _tanks];
_vehiclesData set ["vehiclesAA", ["Aegis_O_R_Truck_02_aa_ard_F", "O_R_APC_Tracked_02_AA_ard_F"]];

_vehiclesData set ["vehiclesTransportBoats", ["O_R_Boat_Transport_01_ard_F"]];
_vehiclesData set ["vehiclesGunBoats", ["O_R_Boat_Armed_01_hmg_ard_F"]];

_vehiclesData set ["vehiclesPlanesCAS", ["O_R_Plane_CAS_02_dynamicLoadout_ard_F","O_R_Plane_Fighter_02_ard_F","O_T_VTOL_02_infantry_dynamicLoadout_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["O_R_Plane_Fighter_02_Stealth_ard_F","O_T_VTOL_02_infantry_dynamicLoadout_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["O_T_VTOL_02_infantry_dynamicLoadout_F", "O_Plane_Transport_01_infantry_F"]];
...
_vehiclesData set ["vehiclesHelisLight", _lightHelicopters];
_vehiclesData set ["vehiclesHelisTransport", _transportHelicopters];
_vehiclesData set ["vehiclesHelisLightAttack", ["O_R_Heli_Light_02_dynamicLoadout_ard_F"]];
_vehiclesData set ["vehiclesHelisAttack", ["Aegis_O_R_Heli_Attack_04_ard_F", "O_R_Heli_Attack_02_dynamicLoadout_ard_F"]];

_vehiclesData set ["vehiclesArtillery", ["O_R_MBT_02_arty_ard_F", "O_R_Truck_02_MRL_F"]];
...
_vehiclesData set ["uavsAttack", ["O_R_UAV_02_dynamicLoadout_ard_F"]];
private _uavsPortable = if (_hasWs) then {["Aegis_O_R_UAV_02_ard_lxWS", "O_R_UAV_01_ard_F"]} else {["O_R_UAV_01_ard_F"]};
_vehiclesData set ["uavsPortable", _uavsPortable];
...
_vehiclesData set ["vehiclesPolice", _policeVehs];

_vehiclesData set ["staticMGs", ["O_HMG_01_high_F", "O_HMG_01_high_F", "O_HMG_01_high_F", "O_GMG_01_high_F"]];
_vehiclesData set ["staticAT", ["O_R_Static_AT_ard_F"]];
_vehiclesData set ["staticAA", ["O_R_Static_AA_ard_F"]];
_vehiclesData set ["staticMortars", ["O_R_Mortar_01_ard_F"]];
_vehiclesData set ["staticHowitzers", []];

_vehiclesData set ["vehicleRadar", "O_R_Radar_System_02_ard_F"];
_vehiclesData set ["vehicleSam", "O_R_SAM_System_04_ard_F"];
...
_vehiclesData set ["minefieldAT", ["ATMine"]];
_vehiclesData set ["minefieldAPERS", ["APERSMine", "APERSBoundingMine"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["O_G_Offroad_01_armed_F", "O_G_Offroad_01_AT_F"]];
_militiaVehiclesData set ["vehiclesTrucks", ["O_R_Truck_02_ard_F", "O_R_Truck_02_transport_ard_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["O_G_Offroad_01_F"]];
_militiaVehiclesData set ["vehiclesAPCs", ["O_R_APC_Wheeled_04_cannon_ard_F"]];
