class A3A_BuyVehicleATDialog : A3A_TabbedDialog
{
  ...
  onUnload = "['onUnload'] spawn A3A_fnc_buyVehicleDialog";
    ...
    class Controls
    {
        ...
        class TabButtons : A3A_ControlsGroupNoScrollbars
        {
            ...
            class Controls
            {
                class rebelVehicleTabButton : A3A_Button ///rebels vehicle at
                {
                    idc = -1;
        ...
        // Main content
        class civilianVehicleTab : A3A_DefaultControlsGroup ///rebels vehicle at
        {
        ...
        class staticsTab : A3A_DefaultControlsGroup ///rebels static at
        {
