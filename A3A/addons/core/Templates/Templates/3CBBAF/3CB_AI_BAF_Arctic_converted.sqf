...
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_BAF_LandRover_Hard_Arctic_A", "UK3CB_BAF_LandRover_Snatch_FFR_Green_A_DPMT", "UK3CB_BAF_LandRover_Soft_Arctic_A"]];
