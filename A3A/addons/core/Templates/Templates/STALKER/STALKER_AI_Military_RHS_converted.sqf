...
_vehiclesData set ["vehiclesBasic", ["rhsgref_cdf_b_reg_uaz"]];
_vehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz"]];
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_ags", "rhs_tigr_sts_msv"]];
_vehiclesData set ["vehiclesTrucks", ["rhs_kamaz5350_msv", "rhs_kamaz5350_open_msv"]];
_vehiclesData set ["vehiclesCargoTrucks", ["rhs_kamaz5350_msv", "rhs_kamaz5350_open_msv"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhs_kamaz5350_ammo_msv"]];
_vehiclesData set ["vehiclesRepairTrucks", ["rhs_typhoon_vdv"]];
_vehiclesData set ["vehiclesFuelTrucks", ["RHS_Ural_Fuel_MSV_01"]];
_vehiclesData set ["vehiclesMedical", ["rhs_kamaz5350_msv"]];
_vehiclesData set ["vehiclesLightAPCs", ["rhsgref_BRDM2_msv", "rhsgref_BRDM2_HQ_msv", "rhsgref_BRDM2_ATGM_msv"]];
_vehiclesData set ["vehiclesAirborne", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_ags", "rhs_tigr_sts_msv"]];
_vehiclesData set ["vehiclesAPCs", ["rhs_btr80a_msv", "rhs_btr80_msv"]];
_vehiclesData set ["vehiclesIFVs", ["rhs_bmp2k_msv", "rhs_bmp1p_msv"]];
_vehiclesData set ["vehiclesLightTanks",  ["rhs_bmp3mera_msv"]];
_vehiclesData set ["vehiclesTanks", ["rhs_t90_tv", "rhs_t72bd_tv", "rhs_t80u45m"]];
...
_vehiclesData set ["vehiclesHelisLight", ["RHS_Mi8MTV3_heavy_vdv"]];
_vehiclesData set ["vehiclesHelisTransport", ["RHS_Mi8mt_vdv"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["RHS_Mi24V_vdv"]];
_vehiclesData set ["vehiclesHelisAttack", ["RHS_Ka52_vvs"]];
...
_militiaVehiclesData set ["vehiclesTrucks", ["rhs_kamaz5350_msv"]];
