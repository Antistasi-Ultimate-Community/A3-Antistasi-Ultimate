...
_vehiclesData set ["vehiclesBasic", ["LIB_Kfz1_w"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1_w","LIB_Kfz1_Hood_w"]];
["vehiclesLightArmed",["LIB_Kfz1_MG42_sernyt", "CSA38_pzbfwI_W", "CSA38_8radW", "CSA38_8rad2W"]] call _fnc_saveToTemplate;
_vehiclesData set ["vehiclesTrucks", ["LIB_OpelBlitz_Open_Y_Camo_w","LIB_OpelBlitz_Tent_G_Camo_w","LIB_SdKfz_7_w"]];
_vehiclesData set ["vehiclesCargoTrucks", ["LIB_OpelBlitz_Open_Y_Camo_w","LIB_SdKfz_7_w"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["LIB_OpelBlitz_Ammo_w"]];
_vehiclesData set ["vehiclesRepairTrucks", ["LIB_OpelBlitz_Parm_w"]];
_vehiclesData set ["vehiclesFuelTrucks", ["LIB_OpelBlitz_Fuel_w"]];
_vehiclesData set ["vehiclesMedical", ["LIB_OpelBlitz_Ambulance_w"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_SdKfz251_FFV_w","LIB_SdKfz251_w"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_SdKfz_7_AA_w", "LIB_SdKfz251_FFV_w","LIB_SdKfz251_w"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_PzKpfwIV_H_w", "LIB_StuG_III_G_w", "CSA38_pzIIID_W", "CSA38_pzIVC_W"]];
_vehiclesData set ["vehiclesTanks", ["LIB_PzKpfwV_w", "LIB_PzKpfwV_w", "LIB_PzKpfwV_w", "LIB_PzKpfwVI_E_w", "LIB_PzKpfwVI_B_w"]];
_vehiclesData set ["vehiclesAA", ["LIB_FlakPanzerIV_Wirbelwind_w"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_SdKfz251_w"]];
_vehiclesData set ["vehiclesLightTanks",  ["CSA38_pzkpfwIA_W","CSA38_pzkpfwI_W","CSA38_pzII_W","CSA38_ltm35_W","CSA38_ltm38_W","CSA38_ltm38_FR2_W"]];
...
_vehiclesData set ["staticMGs", ["LIB_MG34_Lafette_Deployed","LIB_MG42_Lafette_Deployed"]];
_vehiclesData set ["staticAT", ["LIB_Pak40_w","csa38_pak35_W"]];
_vehiclesData set ["staticAA", ["LIB_FlaK_38_w"]];
_vehiclesData set ["staticMortars", ["LIB_GrWr34_g"]];
_vehiclesData set ["staticHowitzers", ["LIB_leFH18"]];

_vehiclesData set ["vehicleRadar", "LIB_FlaK_36_AA_w"];
_vehiclesData set ["vehicleSam", "LIB_FlaK_36_AA_w"];
...
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_OpelBlitz_Open_Y_Camo_w","LIB_OpelBlitz_Tent_Y_Camo_w"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1_w","LIB_Kfz1_Hood_w"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_SdKfz251_w"]];
