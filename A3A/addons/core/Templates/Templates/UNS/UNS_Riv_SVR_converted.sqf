...
_vehiclesData set ["vehiclesTrucks", ["uns_nvatruck_open"]];
_vehiclesData set ["vehiclesLightUnarmed", ["uns_m274", "uns_Type55"]];
_vehiclesData set ["vehiclesAPCs", ["uns_Type55_MG", "uns_BTR152_DSHK"]];
_vehiclesData set ["vehiclesTanks", ["uns_t34_85_nva"]];
_vehiclesData set ["vehiclesHelis", ["uns_Mi8T_VPAF"]];			
