...
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_B_LandRover_Closed_CDF", "UK3CB_B_LandRover_Open_CDF", "rhsgref_BRDM2UM_b"]];
_vehiclesData set ["vehiclesLightArmed", ["UK3CB_B_LandRover_AGS30_CDF", "UK3CB_B_LandRover_M2_CDF", "UK3CB_B_LandRover_SPG9_CDF", "rhsgref_BRDM2_b", "rhsgref_BRDM2_ATGM_b", "rhsgref_BRDM2_HQ_b", "rhsgref_cdf_b_gaz66_zu23", "rhsgref_cdf_b_ural_Zu23", "rhsgref_cdf_b_reg_uaz_ags"]];
_vehiclesData set ["vehiclesTrucks", ["UK3CB_B_Kamaz_Open_CDF", "UK3CB_B_Kamaz_Covered_CDF", "rhsgref_cdf_b_gaz66", "rhsgref_cdf_b_gaz66o", "rhsgref_cdf_b_ural_open", "rhsgref_cdf_b_ural"]];
_vehiclesData set ["vehiclesCargoTrucks", ["rhsgref_cdf_b_gaz66_flat", "rhsgref_cdf_b_gaz66o_flat"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["UK3CB_B_Ural_Ammo_CDF", "rhsgref_cdf_b_gaz66_ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["UK3CB_B_Kamaz_Repair_CDF", "UK3CB_B_Ural_Repair_CDF", "rhsgref_cdf_b_gaz66_repair", "rhsgref_cdf_b_ural_repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["rhsgref_cdf_b_ural_fuel"]];
_vehiclesData set ["vehiclesMedical", ["rhsgref_cdf_b_gaz66_ap2"]];
_vehiclesData set ["vehiclesLightAPCs", ["rhsgref_cdf_b_btr60", "rhsgref_cdf_b_btr70", "rhsgref_cdf_b_btr80"]];
_vehiclesData set ["vehiclesAirborne", ["rhsgref_cdf_b_bmd1", "rhsgref_cdf_b_bmd1k", "rhsgref_cdf_b_bmd1p", "rhsgref_cdf_b_bmd1pk", "rhsgref_cdf_b_bmd2","rhsgref_cdf_b_bmd2k"]];
_vehiclesData set ["vehiclesAPCs", ["rhsgref_cdf_b_bmp2e", "rhsgref_cdf_b_bmp2", "rhsgref_cdf_b_bmp2d", "rhsgref_cdf_b_bmp2k", "rhsgref_cdf_b_bmd1", "rhsgref_cdf_b_bmd1p", "rhsgref_cdf_b_bmd1pk", "rhsgref_cdf_b_bmd2", "rhsgref_cdf_b_bmd2k"]];
_vehiclesData set ["vehiclesIFVs", []];

_vehiclesData set ["vehiclesLightTanks",  ["rhsgref_cdf_b_bmd1k", "UK3CB_B_T55_CDF"]];
_vehiclesData set ["vehiclesTanks", ["rhsgref_cdf_b_2s1_at","rhsgref_cdf_b_t72ba_tv", "rhsgref_cdf_b_t72bb_tv", "rhsgref_cdf_b_t80b_tv", "rhsgref_cdf_b_t80bv_tv", "rhsgref_cdf_b_t80u_tv", "rhsgref_cdf_b_t80uk_tv"]];
_vehiclesData set ["vehiclesAA", ["rhsgref_cdf_b_zsu234"]];
...
_vehiclesData set ["vehiclesPlanesCAS", ["rhs_l159_cdf_b_CDF", "rhsgref_cdf_b_su25"]];   //Socrat deleted rhs_l39_cdf_b_cdf
_vehiclesData set ["vehiclesPlanesAA", ["rhs_l159_cdf_b_CDF_CAP", "rhsgref_cdf_b_mig29s"]];
_vehiclesData set ["vehiclesPlanesTransport", ["RHS_C130J"]];

_vehiclesData set ["vehiclesHelisTransport", ["rhsgref_cdf_reg_Mi8amt","rhsgref_cdf_reg_Mi8amt","rhsgref_cdf_reg_Mi8amt","rhsgref_cdf_b_Mi24D_Early"]];
_vehiclesData set ["vehiclesHelisLight", ["rhsgref_cdf_b_reg_Mi8amt"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["rhsgref_cdf_b_reg_Mi17Sh"]];
_vehiclesData set ["vehiclesHelisAttack", ["rhsgref_cdf_b_Mi24D", "rhsgref_cdf_b_Mi24D_Early", "rhsgref_b_mi24g_CAS", "rhsgref_cdf_b_Mi35"]];

_vehiclesData set ["vehiclesArtillery", ["rhsgref_cdf_b_2s1", "rhsgref_cdf_b_reg_BM21"]];
...
_vehiclesData set ["vehiclesPolice", ["UK3CB_CPD_B_UAZ_Closed", "UK3CB_CPD_B_Gaz24", "UK3CB_CPD_B_Lada", "UK3CB_CPD_B_S1203"]];

_vehiclesData set ["staticMGs", ["rhsgref_cdf_b_DSHKM", "UK3CB_NFA_B_PKM_High", "RHS_M2StaticMG_WD"]];
_vehiclesData set ["staticAT", ["rhsgref_cdf_b_SPG9", "rhsgref_cdf_b_SPG9M"]];
_vehiclesData set ["staticAA", ["rhsgref_cdf_b_ZU23", "rhsgref_cdf_b_Igla_AA_pod"]];
_vehiclesData set ["staticMortars", ["rhsgref_ins_2b14"]];
_vehiclesData set ["staticHowitzers", ["rhsgref_cdf_b_reg_d30"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_spg9"]];
_militiaVehiclesData set ["vehiclesTrucks", ["rhsgref_cdf_b_gaz66", "rhsgref_cdf_b_gaz66_flat", "rhsgref_cdf_b_gaz66o", "rhsgref_cdf_b_gaz66o_flat"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz", "rhsgref_cdf_b_reg_uaz_open", "UK3CB_B_BTR40_CDF"]];
_militiaVehiclesData set ["vehiclesAPCs", ["rhsgref_cdf_b_btr60", "rhsgref_cdf_b_btr70", "UK3CB_B_BTR40_MG_CDF"]];
