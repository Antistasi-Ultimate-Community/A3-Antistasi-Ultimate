...
_vehiclesData set ["vehiclesCivIndustrial", _vehiclesCivIndustrial];
_vehiclesData set ["vehiclesCivBoat", _vehiclesCivBoat];
_vehiclesData set ["vehiclesCivRepair", _vehiclesCivRepair];
_vehiclesData set ["vehiclesCivMedical", _vehiclesCivMedical];
_vehiclesData set ["vehiclesCivFuel", _vehiclesCivFuel];
