...
if (_victim isKindOf "Man") then {
	_injuredComrade = [localize "STR_A3A_punishment_injured_comrade",name _victim] joinString "";
	[localize "STR_A3A_punishment_ff_notification", [_name, localize "STR_A3A_punishment_hurt_you"] joinString ""] remoteExecCall ["A3A_fnc_customHint", _victim, false];
...
if (_instigator isEqualTo _originalBody) then {
	...
	[localize "STR_A3A_punishment_unitcontrol", localize "STR_A3A_punishment_unitcontrol_desc"] remoteExecCall ["A3A_fnc_customHint",_instigator,false];
