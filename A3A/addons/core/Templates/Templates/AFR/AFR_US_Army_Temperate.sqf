...
_loadoutData set ["NVGs", ["psq42_blk"]];
_loadoutData set ["binoculars", ["Binocular"]];
_loadoutData set ["rangefinders", ["rhsusf_bino_lerca_1200_black"]];

_loadoutData set ["traitorUniforms", ["U_tweed_acu_summer_ocp_crye_trop", "U_tweed_acu_summer_ocp_blench_trop"]];
_loadoutData set ["traitorVests", ["V_tweed_msv_mk2_cell_1", "V_tweed_msv_mk2_cell_2"]];
_loadoutData set ["traitorHats", ["H_tweed_Hat_Patrol_ocp"]];

_loadoutData set ["officerUniforms", ["U_tweed_acu_summer_ocp_crye_trop"]];
_loadoutData set ["officerVests", ["V_tweed_iotv_mk4_e_2"]];
_loadoutData set ["officerHats", ["H_tweed_Hat_Patrol_ocp"]];
...
_loadoutData set ["atBackpacks", ["rhsusf_assault_eagleaiii_ocp"]];
_loadoutData set ["longRangeRadios", ["B_RadioBag_01_black_F"]];
_loadoutData set ["helmets", []];
_loadoutData set ["slHat", ["H_tweed_ech_psq_OCP_b_ESS_2", "H_tweed_ech_psq_OCP_b_ESS", "H_tweed_ech_psq_OCP_b", "H_tweed_ech_psq_OCP_ESS_2"]];
...
_loadoutData set ["glasses", ["rhsusf_oakley_goggles_clr", "G_tweed_tacticool_comba"]];
_loadoutData set ["goggles", ["G_oak_2", "G_oak_2_cut"]];
...
_sfLoadoutData set ["uniforms", ["U_tweed_acu_summer_ocp_crye_knee", "U_tweed_acu_summer_ocp_crye_knee_jedi", "U_tweed_acu_summer_ocp_crye_knee_trop"]];
_sfLoadoutData set ["vests", ["V_tweed_msv_mk2_e_1", "V_tweed_msv_mk2_1", "V_tweed_msv_mk2_2", "V_tweed_msv_mk2_3", "V_tweed_msv_mk2_cell_1", "V_tweed_msv_mk2_cell_2", "V_tweed_iotv_mk4_1"]];
_sfLoadoutData set ["MGvests", ["V_tweed_msv_mk2_240", "V_tweed_msv_mk2_249", "V_tweed_iotv_mk4_240", "V_tweed_iotv_mk4_249"]];
_sfLoadoutData set ["MEDvests", ["V_tweed_msv_mk2_45_1", "V_tweed_msv_mk2_cell_45_1", "V_tweed_iotv_mk4_45_1", "V_tweed_iotv_mk4_cell_45_1"]];
_sfLoadoutData set ["SLvests", ["V_tweed_msv_mk2_45_2", "V_tweed_msv_mk2_cell_45_2"]];
_sfLoadoutData set ["SNIvests", ["V_tweed_msv_mk2_3"]];
_sfLoadoutData set ["GLvests", ["V_tweed_msv_mk2_4cm_2", "V_tweed_msv_mk2_cell_4cm_1", "V_tweed_iotv_mk4_4cm_2", "V_tweed_iotv_mk4_cell_4cm_1"]];
_sfLoadoutData set ["backpacks", ["B_simc_US_Molle_sturm_OCP_etool", "B_simc_US_Molle_sturm_OCP", "B_simc_US_Molle_sturm_OCP_thermos_OCP", "rhsusf_assault_eagleaiii_ocp"]];
_sfLoadoutData set ["helmets", ["tsp_gear_fast_mt_MulticamDarkCover_peltor_manta_tec", "tsp_gear_fast_mt_MulticamDarkCover_peltor_fold_manta_tec", "tsp_gear_fast_mt_MulticamDarkCover_peltor_fold_manta", "tsp_gear_fast_mt_MulticamDarkCover_tec"]];
...
_sfLoadoutData set ["rifles", [
    ["rhs_weap_hk416d145", "rhsusf_acc_nt4_black", "rhsusf_acc_anpeq15_bk", "rhsusf_acc_eotech_552", ["rhs_mag_30Rnd_556x45_Mk318_PMAG"], [], ""],
    ["rhs_weap_hk416d145", "rhsusf_acc_nt4_black", "rhsusf_acc_anpeq15_bk", "rhsusf_acc_ACOG_RMR", ["rhs_mag_30Rnd_556x45_Mk318_PMAG"], [], ""],
    ["rhs_weap_hk416d145", "rhsusf_acc_nt4_black", "rhsusf_acc_anpeq15_bk", "rhsusf_acc_su230a", ["rhs_mag_30Rnd_556x45_Mk318_PMAG"], [], ""],
    ["rhs_weap_hk416d145", "rhsusf_acc_nt4_black", "rhsusf_acc_anpeq15_bk", "rhsusf_acc_su230a_mrds", ["rhs_mag_30Rnd_556x45_Mk318_PMAG"], [], ""],
...
_sfLoadoutData set ["carbines", [
    ...
    ["rhs_weap_hk416d10", "rhsusf_acc_nt4_black", "rhsusf_acc_anpeq15_bk", "rhsusf_acc_eotech_xps3", ["rhs_mag_30Rnd_556x45_Mk318_PMAG"], [], ""],
    ["rhs_weap_hk416d10", "rhsusf_acc_nt4_black", "rhsusf_acc_anpeq15_bk", "rhsusf_acc_compm4", ["rhs_mag_30Rnd_556x45_Mk318_PMAG"], [], ""]
]];
...
_sfLoadoutData set ["machineGuns", [
    ["rhs_weap_m249_light_S", "rhsusf_acc_rotex5_grey", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_eotech_552", ["rhsusf_100Rnd_556x45_M995_soft_pouch"], [], "rhsusf_acc_kac_grip_saw_bipod"],
    ["rhs_weap_m249_light_S", "rhsusf_acc_rotex5_grey", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_compm4", ["rhsusf_100Rnd_556x45_M995_soft_pouch"], [], "rhsusf_acc_kac_grip_saw_bipod"],
    ["rhs_weap_m249_light_S", "rhsusf_acc_rotex5_grey", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_su230", ["rhsusf_100Rnd_556x45_M995_soft_pouch"], [], "rhsusf_acc_kac_grip_saw_bipod"],
...
_sfLoadoutData set ["marksmanRifles", [
    ...
    ["rhs_weap_m14ebrri", "rhsusf_acc_aac_m14dcqd_silencer", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_M8541", ["rhsusf_20Rnd_762x51_m993_Mag"], [], "rhsusf_acc_harris_bipod"],
    ["rhs_weap_m14ebrri", "rhsusf_acc_aac_m14dcqd_silencer", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_LEUPOLDMK4", ["rhsusf_20Rnd_762x51_m993_Mag"], [], "rhsusf_acc_harris_bipod"],
    ["rhs_weap_m14ebrri", "rhsusf_acc_aac_m14dcqd_silencer", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_premier_mrds", ["rhsusf_20Rnd_762x51_m993_Mag"], [], "rhsusf_acc_harris_bipod"],
    ["rhs_weap_sr25_ec", "rhsusf_acc_aac_762sd_silencer", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_M8541", ["rhsusf_20Rnd_762x51_SR25_m993_Mag"], [], "rhsusf_acc_harris_bipod"],
    ["rhs_weap_sr25_ec", "rhsusf_acc_aac_762sd_silencer", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_LEUPOLDMK4_2", ["rhsusf_20Rnd_762x51_SR25_m993_Mag"], [], "rhsusf_acc_harris_bipod"],
    ["rhs_weap_sr25_ec", "rhsusf_acc_aac_762sd_silencer", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_premier_mrds", ["rhsusf_20Rnd_762x51_SR25_m993_Mag"], [], "rhsusf_acc_harris_bipod"]
]];
_sfLoadoutData set ["sniperRifles", [
    ["rhs_weap_XM2010", "rhsusf_acc_M2010S_wd", "rhsusf_acc_anpeq15side_bk", "rhsusf_acc_M8541_d", [], [], "rhsusf_acc_harris_bipod"],
...
_eliteLoadoutData set ["uniforms", ["U_tweed_acu_summer_ocp_crye_knee", "U_tweed_acu_summer_ocp_crye_knee_jedi", "U_tweed_acu_summer_ocp_crye_knee_trop"]];
_eliteLoadoutData set ["vests", ["V_tweed_msv_mk2_e_1", "V_tweed_msv_mk2_1", "V_tweed_msv_mk2_2", "V_tweed_msv_mk2_3", "V_tweed_msv_mk2_cell_1", "V_tweed_msv_mk2_cell_2", "V_tweed_iotv_mk4_1"]];
_eliteLoadoutData set ["MGvests", ["V_tweed_msv_mk2_240", "V_tweed_msv_mk2_249", "V_tweed_iotv_mk4_240", "V_tweed_iotv_mk4_249"]];
_eliteLoadoutData set ["MEDvests", ["V_tweed_msv_mk2_45_1", "V_tweed_msv_mk2_cell_45_1", "V_tweed_iotv_mk4_45_1", "V_tweed_iotv_mk4_cell_45_1"]];
_eliteLoadoutData set ["SLvests", ["V_tweed_msv_mk2_45_2", "V_tweed_msv_mk2_cell_45_2"]];
_eliteLoadoutData set ["SNIvests", ["V_tweed_msv_mk2_3"]];
_eliteLoadoutData set ["GLvests", ["V_tweed_msv_mk2_4cm_2", "V_tweed_msv_mk2_cell_4cm_1", "V_tweed_iotv_mk4_4cm_2", "V_tweed_iotv_mk4_cell_4cm_1"]];
_eliteLoadoutData set ["backpacks", ["B_simc_US_Molle_sturm_OCP_etool", "B_simc_US_Molle_sturm_OCP", "B_simc_US_Molle_sturm_OCP_thermos_OCP", "rhsusf_assault_eagleaiii_ocp"]];
_eliteLoadoutData set ["helmets", ["tsp_gear_fast_mt_MulticamDarkCover_peltor_manta_tec", "tsp_gear_fast_mt_MulticamDarkCover_peltor_fold_manta_tec", "tsp_gear_fast_mt_MulticamDarkCover_peltor_fold_manta", "tsp_gear_fast_mt_MulticamDarkCover_tec"]];
_eliteLoadoutData set ["NVGs", ["psq42_blk_lenscap"]];
...
_militaryLoadoutData set ["uniforms", ["U_tweed_acu_summer_ocp_crye_knee", "U_tweed_acu_summer_ocp_crye_knee_trop", "U_tweed_acu_summer_ocp_unbl", "U_tweed_acu_summer_ocp_trop"]];
_militaryLoadoutData set ["vests", ["V_tweed_msv_mk2_e_1", "V_tweed_msv_mk2_1", "V_tweed_msv_mk2_2", "V_tweed_msv_mk2_3", "V_tweed_msv_mk2_cell_1", "V_tweed_msv_mk2_cell_2", "V_tweed_iotv_mk4_1"]];
_militaryLoadoutData set ["MGvests", ["V_tweed_msv_mk2_240", "V_tweed_msv_mk2_249", "V_tweed_iotv_mk4_240", "V_tweed_iotv_mk4_249"]];
_militaryLoadoutData set ["MEDvests", ["V_tweed_msv_mk2_45_1", "V_tweed_msv_mk2_cell_45_1", "V_tweed_iotv_mk4_45_1", "V_tweed_iotv_mk4_cell_45_1"]];
_militaryLoadoutData set ["SLvests", ["V_tweed_msv_mk2_45_2", "V_tweed_msv_mk2_cell_45_2"]];
...
_policeLoadoutData set ["uniforms", ["U_tweed_acu_summer_ocp_crye_trop", "U_tweed_acu_summer_ocp_blench_unbl"]];
_policeLoadoutData set ["vests", ["V_tweed_msv_mk2_e_1", "V_tweed_msv_mk2_cell_1"]];
_policeLoadoutData set ["helmets", ["H_tweed_Hat_Patrol_ocp", "rhs_Booniehat_ocp"]];
...
_militiaLoadoutData set ["uniforms", ["U_tweed_acu_summer_ocp_crye_knee", "U_tweed_acu_summer_ocp_crye_knee_trop", "U_tweed_acu_summer_ocp_unbl", "U_tweed_acu_summer_ocp_trop"]];
_militiaLoadoutData set ["vests", ["V_tweed_msv_mk2_e_1", "V_tweed_msv_mk2_3", "V_tweed_msv_mk2_cell_1"]];
_militiaLoadoutData set ["backpacks", ["B_simc_US_Molle_sturm_OCP_etool", "B_simc_US_Molle_sturm_OCP", "B_simc_US_Molle_sturm_OCP_thermos_OCP", "rhsusf_assault_eagleaiii_ocp"]];
_militiaLoadoutData set ["atBackpacks", ["rhsusf_assault_eagleaiii_ocp"]];
_militiaLoadoutData set ["helmets", ["H_tweed_Hat_fleece_od3", "H_tweed_Hat_Patrol_ocp", "rhs_Booniehat_ocp", "H_tweed_ech_psq_OCP_b_ESS_2", "H_tweed_ech_psq_OCP_b_ESS", "H_tweed_ech_psq_OCP_b", "H_tweed_ech_psq_OCP_ESS_2"]];
_militiaLoadoutData set ["slHat", ["H_tweed_ech_psq_OCP_b_ESS_2", "H_tweed_ech_psq_OCP_b_ESS", "H_tweed_ech_psq_OCP_b", "H_tweed_ech_psq_OCP_ESS_2"]];
...
_crewLoadoutData set ["helmets", ["rhsusf_cvc_helmet", "rhsusf_cvc_alt_helmet"]];
...
_pilotLoadoutData set ["helmets", ["rhsusf_hgu56p_white", "rhsusf_hgu56p_visor_white", "rhsusf_hgu56p_black", "rhsusf_hgu56p_visor_black"]];
