...
_vehiclesData set ["vehiclesSDV", ["I_SDV_01_F"]];
...
_vehiclesData set ["vehiclesLightUnarmed", ["I_MRAP_03_F"]];
_vehiclesData set ["vehiclesLightArmed", ["I_MRAP_03_hmg_F", "I_MRAP_03_gmg_F"]];
_vehiclesData set ["vehiclesTrucks", ["I_Truck_02_transport_F", "I_Truck_02_covered_F"]];
private _cargoTrucks = ["I_Truck_02_transport_F", "I_Truck_02_covered_F","I_UGV_01_F"];
_vehiclesData set ["vehiclesAmmoTrucks", ["I_Truck_02_ammo_F"]];
_vehiclesData set ["vehiclesRepairTrucks", ["I_Truck_02_box_F"]];
_vehiclesData set ["vehiclesFuelTrucks", ["I_Truck_02_fuel_F"]];
_vehiclesData set ["vehiclesMedical", ["I_Truck_02_medical_F"]];
_vehiclesData set ["vehiclesLightAPCs", []];
_vehiclesData set ["vehiclesAPCs", ["I_APC_tracked_03_cannon_F", "I_APC_Wheeled_03_cannon_F"]];
_vehiclesData set ["vehiclesIFVs", []];
_vehiclesData set ["vehiclesAirborne", ["I_APC_Wheeled_03_cannon_F","I_UGV_01_rcws_F"]];
_vehiclesData set ["vehiclesTanks", ["I_MBT_03_cannon_F"]];
_vehiclesData set ["vehiclesLightTanks", ["I_LT_01_cannon_F", "I_LT_01_AT_F","I_UGV_01_rcws_F"]];
private _aa = ["I_LT_01_AA_F"];

_vehiclesData set ["vehiclesTransportBoats", ["I_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["I_Boat_Armed_01_minigun_F"]];

_vehiclesData set ["vehiclesPlanesCAS", ["I_Plane_Fighter_03_dynamicLoadout_F","I_Plane_Fighter_04_F"]];
_vehiclesData set ["vehiclesPlanesAA", ["I_Plane_Fighter_04_F"]];
_vehiclesData set ["vehiclesPlanesTransport", ["I_Plane_Transport_01_infantry_F"]];

_vehiclesData set ["vehiclesHelisLight", ["I_Heli_light_03_unarmed_F"]];
_vehiclesData set ["vehiclesHelisTransport", ["I_Heli_Transport_02_F"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["I_Heli_Light_01_dynamicLoadout_F", "I_Heli_light_03_dynamicLoadout_F"]];
_vehiclesData set ["vehiclesHelisAttack", ["I_Heli_Attack_03_F"]];

_vehiclesData set ["vehiclesArtillery", ["I_Truck_02_MRL_F"]];
["magazines", createHashMapFromArray [
["I_Truck_02_MRL_F", ["12Rnd_230mm_rockets", "12Rnd_230mm_rockets_cluster"]]
]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["I_UAV_02_dynamicLoadout_F"]];
...
_vehiclesData set ["staticMGs", ["I_HMG_02_high_F"]];
...
_vehiclesData set ["vehicleRadar", "I_LT_01_scout_F"];
_vehiclesData set ["vehicleSam", "I_LT_01_AA_F"];
...
_vehiclesData set ["vehiclesCargoTrucks", _cargoTrucks];
_vehiclesData set ["vehiclesAA", _aa];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["I_C_Offroad_01_armed_F"]];
_militiaVehiclesData set ["vehiclesTrucks", ["I_Truck_02_transport_F", "I_Truck_02_covered_F"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["I_C_Offroad_01_F"]];
