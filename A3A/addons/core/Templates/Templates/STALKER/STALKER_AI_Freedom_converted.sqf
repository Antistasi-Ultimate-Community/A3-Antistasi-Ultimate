...
_vehiclesData set ["vehiclesBasic", ["CUP_O_TT650_TKA"]];
_vehiclesData set ["vehiclesLightUnarmed", ["CUP_O_Hilux_unarmed_TK_INS", "CUP_O_Volha_SLA"]];
_vehiclesData set ["vehiclesLightArmed", ["CUP_O_Hilux_M2_TK_INS", "CUP_O_Hilux_metis_TK_INS", "CUP_O_Hilux_armored_DSHKM_TK_INS"]];
_vehiclesData set ["vehiclesTrucks", ["CUP_O_Ural_SLA", "CUP_O_Ural_Open_SLA"]];
_vehiclesData set ["vehiclesCargoTrucks", ["CUP_O_Ural_SLA", "CUP_O_Ural_Open_SLA"]];
...
_vehiclesData set ["vehiclesLightAPCs", ["CUP_O_Hilux_armored_DSHKM_TK_INS", "CUP_O_GAZ_Vodnik_AGS_RU"]];
_vehiclesData set ["vehiclesAirborne", ["CUP_O_Hilux_armored_DSHKM_TK_INS", "CUP_O_GAZ_Vodnik_AGS_RU"]];
_vehiclesData set ["vehiclesAPCs", ["CUP_O_BTR60_SLA"]];
_vehiclesData set ["vehiclesIFVs", ["CUP_O_MTLB_pk_SLA"]];
_vehiclesData set ["vehiclesLightTanks",  ["CUP_O_BMP2_SLA"]];
_vehiclesData set ["vehiclesTanks", ["CUP_O_T72_RU", "CUP_O_T55_SLA"]];
_vehiclesData set ["vehiclesAA", ["CUP_O_Ural_ZU23_SLA"]];

_vehiclesData set ["vehiclesTransportBoats", ["CUP_O_PBX_RU"]];
_vehiclesData set ["vehiclesGunBoats", ["CUP_O_LCVP_SLA"]];
_vehiclesData set ["vehiclesAmphibious", []];

_vehiclesData set ["vehiclesPlanesCAS", []];
_vehiclesData set ["vehiclesPlanesAA", []];
_vehiclesData set ["vehiclesPlanesTransport", ["CUP_O_C47_SLA"]];

_vehiclesData set ["vehiclesHelisLight", ["CUP_O_Mi8_medevac_RU"]];
_vehiclesData set ["vehiclesHelisTransport", ["CUP_O_Mi24_P_Dynamic_RU"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["CUP_O_Ka50_DL_RU"]];
_vehiclesData set ["vehiclesHelisAttack", ["CUP_O_Ka52_RU"]];
...
_vehiclesData set ["vehiclesPolice", ["CUP_O_Hilux_unarmed_TK_INS"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["CUP_O_Hilux_armored_DSHKM_TK_INS"]];
_militiaVehiclesData set ["vehiclesTrucks", ["CUP_O_Ural_Open_SLA"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["CUP_O_Hilux_unarmed_TK_INS"]];
_militiaVehiclesData set ["vehiclesAPCs", ["CUP_O_BRDM2_SLA"]];
