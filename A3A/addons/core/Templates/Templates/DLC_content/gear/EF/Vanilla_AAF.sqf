...
(_sfLoadoutData get "vests") append ["EF_V_AAV_Olive","EF_V_AAV_Diver_NoReb_Olive"];
(_sfLoadoutData get "Hvests") append ["EF_V_AAV_Support_Olive"];
(_sfLoadoutData get "glVests") append ["EF_V_AAV_Support_Olive"];
...
(_eliteLoadoutData get "vests") append ["EF_V_AAV_Olive","EF_V_AAV_Diver_NoReb_Olive"];
