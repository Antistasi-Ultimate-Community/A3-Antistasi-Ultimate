...
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1","LIB_Kfz1_camo","LIB_Kfz1_Hood"]];
...
_vehiclesData set ["vehiclesTrucks", ["LIB_OpelBlitz_Open_Y_Camo","LIB_OpelBlitz_Tent_Y_Camo","LIB_SdKfz_7"]];
_vehiclesData set ["vehiclesCargoTrucks", ["LIB_OpelBlitz_Open_Y_Camo","LIB_SdKfz_7"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["LIB_OpelBlitz_Ammo", "LIB_SdKfz_7_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["LIB_OpelBlitz_Parm"]];
_vehiclesData set ["vehiclesFuelTrucks", ["LIB_OpelBlitz_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["LIB_OpelBlitz_Ambulance"]];
_vehiclesData set ["vehiclesLightAPCs", ["fow_v_sdkfz_250_camo_ger_heer","fow_v_sdkfz_250_camo_ger_heer"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_SdKfz_7_AA", "fow_v_sdkfz_251_camo_ger_heer","fow_v_sdkfz_251_camo_ger_heer"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_PzKpfwIV_H", "LIB_StuG_III_G"]];
_vehiclesData set ["vehiclesTanks", ["fow_v_panther_camo_ger_heer", "fow_v_panther_camo_ger_heer", "fow_v_panther_camo_ger_heer", "LIB_PzKpfwVI_E", "LIB_PzKpfwVI_B_tarn51c"]];
_vehiclesData set ["vehiclesAA", ["LIB_FlakPanzerIV_Wirbelwind"]];
_vehiclesData set ["vehiclesAirborne", ["fow_v_sdkfz_250_camo_ger_heer"]];
...
_vehiclesData set ["vehiclesLightArmed", _vehiclesLightArmed];
_vehiclesData set ["vehiclesLightTanks", _vehiclesLightTanks];

_vehiclesData set ["vehiclesTransportBoats", ["LIB_LCA"]];
_vehiclesData set ["vehiclesGunBoats", []];
...
_vehiclesData set ["vehiclesArtillery", ["LIB_SdKfz124"]];
...
_vehiclesData set ["vehiclesPolice", ["LIB_Kfz1_sernyt"]];

_vehiclesData set ["staticMGs", ["fow_w_mg42_deployed_high_ger_heer"]];
_vehiclesData set ["staticAT", ["fow_w_pak40_camo_ger_heer"]];
_vehiclesData set ["staticAA", ["LIB_FlaK_38"]];
_vehiclesData set ["staticMortars", ["LIB_GrWr34"]];
_vehiclesData set ["staticHowitzers", ["LIB_leFH18"]];

_vehiclesData set ["vehicleRadar", "fow_w_flak36_camo_ger_heer"];
_vehiclesData set ["vehicleSam", "fow_w_flak36_camo_ger_heer"];

_vehiclesData set ["howitzerMagazineHE", "LIB_20x_Shell_105L28_Gr38_HE"];

_vehiclesData set ["mortarMagazineHE", "LIB_8Rnd_81mmHE_GRWR34"];
_vehiclesData set ["mortarMagazineSmoke", "LIB_81mm_GRWR34_SmokeShell"];

//Minefield definition
_vehiclesData set ["minefieldAT", ["LIB_TMI_42_MINE"]];
_vehiclesData set ["minefieldAPERS", ["LIB_shumine_42_MINE"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_Kfz1_MG42","LIB_Kfz1_MG42_camo","fow_v_sdkfz_222_camo_ger_heer"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_OpelBlitz_Open_Y_Camo","LIB_OpelBlitz_Tent_Y_Camo"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1","LIB_Kfz1_camo","LIB_Kfz1_Hood"]];
_militiaVehiclesData set ["vehiclesAPCs", ["fow_v_sdkfz_251_camo_ger_heer","fow_v_sdkfz_250_9_camo_ger_heer"]];
