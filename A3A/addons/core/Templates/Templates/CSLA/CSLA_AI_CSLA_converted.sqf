...
_vehiclesData set ["vehiclesBasic", ["CSLA_JARA250","CSLA_AZU_R2"]];			 
_vehiclesData set ["vehiclesLightUnarmed", ["CSLA_AZU","CSLA_AZU_para","CSLA_AZU_R2"]];		 
_vehiclesData set ["vehiclesLightArmed", []];             
_vehiclesData set ["vehiclesTrucks", ["CSLA_V3SLizard","CSLA_F813o","CSLA_F813"]];		 
_vehiclesData set ["vehiclesCargoTrucks", ["CSLA_V3SLizard","CSLA_F813o","CSLA_F813"]];		 
_vehiclesData set ["vehiclesAmmoTrucks", ["CSLA_V3Sa"]];		 
_vehiclesData set ["vehiclesRepairTrucks", ["CSLA_V3Sr","CSLA_DTP90"]];		 
_vehiclesData set ["vehiclesFuelTrucks", ["CSLA_V3Sf"]];		 
_vehiclesData set ["vehiclesMedical", ["CSLA_OZV90"]];		 
_vehiclesData set ["vehiclesLightAPCs", ["CSLA_OT64C"]];             
_vehiclesData set ["vehiclesAPCs", ["CSLA_OT64C"]];                  
_vehiclesData set ["vehiclesAirborne", ["CSLA_BVP1","CSLA_BPzV"]];              
_vehiclesData set ["vehiclesIFVs", ["CSLA_OT62","CSLA_OT62D"]];                  
_vehiclesData set ["vehiclesTanks", ["CSLA_T72","CSLA_T72M","CSLA_T72M1"]];                 
_vehiclesData set ["vehiclesLightTanks", ["CSLA_BVP1","CSLA_BPzV"]];            
_vehiclesData set ["vehiclesAA", ["CSLA_PLdvK59V3S"]];                    
...
_vehiclesData set ["vehiclesHelisLight", ["CSLA_Mi17"]];            
_vehiclesData set ["vehiclesHelisTransport", ["CSLA_Mi17mg"]];        

_vehiclesData set ["vehiclesHelisLightAttack", ["CSLA_Mi17pylons"]];      
_vehiclesData set ["vehiclesHelisAttack", ["CSLA_Mi24V"]];           

_vehiclesData set ["vehiclesArtillery", ["CSLA_ShKH77","CSLA_RM70","CSLA_RM51"]];
...
_vehiclesData set ["staticMGs", ["CSLA_UK59L_Stat"]];
_vehiclesData set ["staticAT", ["CSLA_9K113_Stat"]];
...
_militiaVehiclesData set ["vehiclesTrucks", ["CSLA_V3So","CSLA_V3S"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["CSLA_AZU","CSLA_AZU_para","CSLA_AZU_R2"]];
_militiaVehiclesData set ["vehiclesAPCs", ["CSLA_OT64C"]];
