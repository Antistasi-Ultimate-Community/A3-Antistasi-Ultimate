...
["vehiclesCivPlanes", ["UK3CB_ADC_C_Antonov_AN2"]] call _fnc_saveToTemplate;

_vehiclesData set ["vehiclesCivHeli", ["UK3CB_CHC_C_Mi8AMT", "RHS_Mi8amt_civilian", "RHS_Mi8t_civilian"]];
