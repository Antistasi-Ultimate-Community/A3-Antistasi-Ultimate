...
_vehiclesData set ["vehiclesLightAPCs", ["LIB_SdKfz251_FFV","LIB_SdKfz251"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_SdKfz_7_AA", "LIB_SdKfz251_FFV","LIB_SdKfz251"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_PzKpfwIV_H", "LIB_StuG_III_G"]];
_vehiclesData set ["vehiclesTanks", ["LIB_PzKpfwV", "LIB_PzKpfwV", "LIB_PzKpfwV", "LIB_PzKpfwVI_E", "LIB_PzKpfwVI_B_tarn51c"]];
_vehiclesData set ["vehiclesAA", ["LIB_FlakPanzerIV_Wirbelwind"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_SdKfz251"]];
...
_vehiclesData set ["vehicleRadar", "LIB_FlaK_36_AA"];
_vehiclesData set ["vehicleSam", "LIB_FlaK_36_AA"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_Kfz1_MG42","LIB_Kfz1_MG42_camo"]];
...
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_SdKfz251"]];
