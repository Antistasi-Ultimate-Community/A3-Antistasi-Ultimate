...
_vehiclesData set ["vehiclesLightUnarmed", ["gm_ge_army_iltis_cargo"]];
_vehiclesData set ["vehiclesLightArmed", ["gm_gc_army_uaz469_dshkm"]];
_vehiclesData set ["vehiclesTruck", ["gm_ge_army_kat1_451_cargo"]];
_vehiclesData set ["vehiclesAT", ["gm_gc_army_uaz469_spg9"]];
_vehiclesData set ["vehiclesAA", ["CUP_I_Ural_ZU23_NAPA"]];

_vehiclesData set ["vehiclesBoat", ["I_C_Boat_Transport_02_F"]];

_vehiclesData set ["vehiclesPlane", ["gm_gc_civ_l410s_passenger"]];

_vehiclesData set ["vehiclesCivCar", ["gm_gc_civ_p601", "gm_ge_civ_w123"]];
_vehiclesData set ["vehiclesCivTruck", ["gm_gc_civ_ural375d_cargo"]];
_vehiclesData set ["vehiclesCivHeli", ["gm_gc_civ_mi2p"]];
_vehiclesData set ["vehiclesCivBoat", ["C_Rubberboat"]];

_vehiclesData set ["staticMGs", ["gm_gc_army_dshkm_aatripod"]];
_vehiclesData set ["staticAT", ["gm_gc_army_spg9_tripod"]];
...
_vehiclesData set ["minesAT", "gm_mine_at_dm21"];         // , "gm_mine_at_dm1233"]]
_vehiclesData set ["minesAPERS", "gm_mine_ap_dm31"];
