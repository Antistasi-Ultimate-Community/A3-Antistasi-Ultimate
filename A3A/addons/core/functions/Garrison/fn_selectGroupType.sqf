...
if(_vehicle in flatten OccAndInv("vehiclesTanks")) exitWith {FactionGetTiered(_faction, "groupTierAT")};

//If AA-tank, select AA team
if(_vehicle in flatten OccAndInv("vehiclesAA")) exitWith {FactionGetTiered(_faction, "groupTierAA")};
