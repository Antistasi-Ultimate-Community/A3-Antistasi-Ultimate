...
_vehiclesData set ["vehiclesTrucks", ["OPTRE_m1015_mule_ins"]];
_vehiclesData set ["vehiclesLightUnarmed", ["OPTRE_M12_FAV_ins"]];
_vehiclesData set ["vehiclesAPCs", ["OPTRE_M12_ins_APC"]];
_vehiclesData set ["vehiclesTanks", ["OPTRE_M808B_INS"]];
_vehiclesData set ["vehiclesHelis", ["OPTRE_UNSC_falcon_armed_S_ins"]];			
