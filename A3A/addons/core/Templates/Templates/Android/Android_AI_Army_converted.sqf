...
_vehiclesData set ["vehiclesLightUnarmed", ["SSV_Vehicle_Android_Ifrit", "OPTRE_M411_APC_UNSC"]];
...
_vehiclesData set ["vehiclesMedical", ["SSV_Vehicle_Android_Ifrit", "OPTRE_M12_FAV_APC_MED_CMA"]];
_vehiclesData set ["vehiclesLightAPCs", ["OPTRE_M12_TD_CMA", "OPTRE_M12_FAV_APC_CMA"]];
_vehiclesData set ["vehiclesAirborne", ["SSV_Vehicle_Android_APC", "SSV_Vehicle_Android_Tank"]];
_vehiclesData set ["vehiclesAPCs", ["SSV_Vehicle_Android_APC"]];
_vehiclesData set ["vehiclesIFVs", ["OPTRE_M413_MGS_UNSC", "OPTRE_M412_IFV_UNSC"]];
_vehiclesData set ["vehiclesLightTanks",  ["OPTRE_M808B_CMA"]];
_vehiclesData set ["vehiclesTanks", ["SSV_Vehicle_Android_Tank", "OPTRE_M808BM_CMA"]];
_vehiclesData set ["vehiclesAA", ["OPTRE_M12R_AA_CMA"]];
...
_vehiclesData set ["vehiclesAmphibious", ["SSV_Vehicle_Android_APC_Ruined"]];

_vehiclesData set ["vehiclesPlanesCAS", ["OPTRE_YSS_1000_A"]];
_vehiclesData set ["vehiclesPlanesAA", ["OPTRE_YSS_1000_A"]];
_vehiclesData set ["vehiclesPlanesTransport", ["SSV_Vehicle_Android_VTOL_Infantry"]];

_vehiclesData set ["vehiclesHelisLight", ["OPTRE_UNSC_falcon_PD"]];
_vehiclesData set ["vehiclesHelisTransport", ["OPTRE_Pelican_unarmed_PD"]];
...
_vehiclesData set ["uavsPortable", ["SSV_Drone_Cargo_Metro"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_LRV_PD"]];
_militiaVehiclesData set ["vehiclesTrucks", ["OPTRE_m1015_mule_cover_cma"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["SSV_Vehicle_Android_Ifrit"]];
_militiaVehiclesData set ["vehiclesAPCs", ["SSV_Vehicle_Android_APC", "OPTRE_M12_FAV_APC_PD"]];
