...
_vehiclesData set ["vehiclesBasic", ["UK3CB_TKM_I_YAVA"]];
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_TKM_I_LR_Closed"]];
_vehiclesData set ["vehiclesLightArmed", ["UK3CB_TKM_I_Hilux_Dshkm"]];
_vehiclesData set ["vehiclesTruck", ["UK3CB_TKM_I_V3S_Open"]];
_vehiclesData set ["vehiclesAT", ["UK3CB_TKM_I_Hilux_Spg9"]];
_vehiclesData set ["vehiclesAA", ["UK3CB_TKM_I_V3S_Zu23"]];

_vehiclesData set ["vehiclesBoat", ["UK3CB_CHD_I_Fishing_Boat"]];

_vehiclesData set ["vehiclesPlane", ["UK3CB_CHC_I_Antonov_AN2", "I_C_Plane_Civil_01_F"]];

_vehiclesData set ["vehiclesCivCar", ["UK3CB_TKC_C_Hilux_Civ_Open"]];
_vehiclesData set ["vehiclesCivTruck", ["UK3CB_TKC_C_Ural_Open"]];
_vehiclesData set ["vehiclesCivHeli", ["UK3CB_TKC_C_Mi8AMT"]];
_vehiclesData set ["vehiclesCivBoat", ["UK3CB_CHC_C_Fishing_Boat"]];
_vehiclesData set ["vehiclesCivSupply", ["UK3CB_ADC_C_S1203"]];

_vehiclesData set ["staticMGs", ["UK3CB_TKM_I_DSHKM"]];
_vehiclesData set ["staticAT", ["UK3CB_TKM_I_SPG9"]];
_vehiclesData set ["staticAA", ["UK3CB_TKM_I_ZU23"]];
_vehiclesData set ["staticMortars", ["UK3CB_TKM_I_2b14_82mm"]];
_vehiclesData set ["staticMortarMagHE", "rhs_mag_3vo18_10"];
_vehiclesData set ["staticMortarMagSmoke", "rhs_mag_d832du_10"];

_vehiclesData set ["minesAT", [
	"ATMine_Range_Mag",
	"rhs_mine_tm62m_mag",
	"rhs_mine_M19_mag",
	"rhs_mag_mine_ptm1",
