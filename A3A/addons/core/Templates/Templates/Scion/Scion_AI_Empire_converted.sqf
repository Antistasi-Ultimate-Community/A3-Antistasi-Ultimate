...
_vehiclesData set ["vehiclesLightAPCs", ["SC_SaurusAPC_Unarmed_SE"]];
_vehiclesData set ["vehiclesAirborne", ["SC_SE_IFV"]];
_vehiclesData set ["vehiclesAPCs", ["SC_SE_IFV", "SC_SaurusAPC_SE"]];
_vehiclesData set ["vehiclesIFVs", []];

_vehiclesData set ["vehiclesLightTanks",  ["SC_EXT_Ant_SE", "SC_EXT_Scorpion"]];
_vehiclesData set ["vehiclesTanks", ["SC_Mantis", "SC_EXT_Rhino_AR"]];
_vehiclesData set ["vehiclesAA", ["SC_SaurusAPC_AA_SE"]];
...
_vehiclesData set ["vehiclesPlanesCAS", ["SCR_TF3Fighter_SE"]];
_vehiclesData set ["vehiclesPlanesAA", ["SCR_TF3Fighter_SE"]];
_vehiclesData set ["vehiclesPlanesTransport", ["SC_VTOL_X42_SE"]];
...
_militiaVehiclesData set ["vehiclesLightUnarmed", ["SC_SaurusAPC_Unarmed_SE"]];
_militiaVehiclesData set ["vehiclesAPCs", ["SC_SaurusAPC_SE"]];
