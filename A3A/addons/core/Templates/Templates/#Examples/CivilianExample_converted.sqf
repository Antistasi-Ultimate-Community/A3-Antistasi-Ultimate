...
_vehiclesData set ["vehiclesCivCar", []];             //this line determines civilian cars -- Example: _vehiclesData set ["vehiclesCivCar", ["C_Offroad_01_F"]] -- Array, can contain multiple assets

["vehiclesCivIndustrial", []];             //this line determines civilian trucks -- Example: _vehiclesData set ["vehiclesCivIndustrial", ["C_Truck_02_transport_F"]] -- Array, can contain multiple assets

["vehiclesCivHeli", []];            //this line determines civilian helis -- Example: _vehiclesData set ["vehiclesCivHeli", ["C_Heli_Light_01_civil_F"]] -- Array, can contain multiple assets

["vehiclesCivPlanes", []];          // this line determines civilian planes -- Example: ["vehiclesCivPlanes", ["C_Plane_Civil_01_F"]] -- Array, can contain multiple assets

_vehiclesData set ["vehiclesCivBoat", []];             //this line determines civilian boats -- Example: _vehiclesData set ["vehiclesCivBoat", ["C_Boat_Civil_01_F"]] -- Array, can contain multiple assets

["vehiclesCivRepair", []];            //this line determines civilian repair vehicles

_vehiclesData set ["vehiclesCivMedical", []];        //this line determines civilian medic vehicles
...
["vehiclesData", [
    _vehiclesData
            ...
            //this line determines civilian fuel vehicles
