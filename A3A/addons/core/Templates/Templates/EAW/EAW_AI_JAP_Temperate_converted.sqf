...
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1_camo","LIB_Kfz1_Hood_camo"]];
["vehiclesLightArmed",["EAW_Type94_1937","EAW_Panzar1","EAW_Crossley"]] call _fnc_saveToTemplate;
_vehiclesData set ["vehiclesTrucks", ["EAW_Dodge1936_Pickup_Military_IJA","fow_v_type97_truck_open_ija","fow_v_type97_truck_ija"]];
_vehiclesData set ["vehiclesCargoTrucks", ["EAW_Dodge1936_Pickup_Military_IJA"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["EAW_Dodge1936_Pickup_Military_Ammo_IJA"]];
_vehiclesData set ["vehiclesRepairTrucks", ["EAW_Dodge1936_Pickup_Military_Fuel_IJA","fow_v_type97_truck_utility_ija"]];
_vehiclesData set ["vehiclesFuelTrucks", ["fow_v_type97_truck_fuel_ija"]];
_vehiclesData set ["vehiclesMedical", ["EAW_Dodge1936_Pickup_Military_Medical_IJA"]];
_vehiclesData set ["vehiclesLightAPCs", ["fow_v_sdkfz_250_camo_foliage_ger_heer"]];
_vehiclesData set ["vehiclesAPCs", ["fow_v_sdkfz_251_camo_foliage_ger_heer"]];
_vehiclesData set ["vehiclesIFVs", ["EAW_Vickers6Ton", "fow_ija_type95_HaGo_3_ija"]];
_vehiclesData set ["vehiclesTanks", ["EAW_Type89_1937", "EAW_ChiHa_1941J","EAW_ChiHa_Kai_1941J"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["fow_v_sdkfz_250_camo_foliage_ger_heer"]];
_vehiclesData set ["vehiclesLightTanks",  ["EAW_Vickers6Ton", "fow_ija_type95_HaGo_3_ija"]];

_vehiclesData set ["vehiclesTransportBoats", ["EAW_Daihatsu_LC"]];
_vehiclesData set ["vehiclesGunBoats", []];
_vehiclesData set ["vehiclesAmphibious", []];

private _vehiclesPlanesCAS = ["EAW_A4N", "EAW_Ki43_II"];
_vehiclesData set ["vehiclesPlanesLargeCAS", ["EAW_G3M"]];
...
_vehiclesData set ["vehiclesPolice", ["EAW_Crossley"]];

_vehiclesData set ["staticMGs", ["fow_w_type92_tripod_high_ija"]];
_vehiclesData set ["staticAT", ["EAW_Type1_47mm_J"]];
_vehiclesData set ["staticAA", ["EAW_T98_20mm_AA_1941J"]];
_vehiclesData set ["staticMortars", ["EAW_IJA_Type97_Mortar_1941J"]];
_vehiclesData set ["staticHowitzers", ["EAW_IJA_Type91_Gun_1941J_Arty"]];

_vehiclesData set ["vehicleRadar", "EAW_IJA_Type99_88_AA_1941J"];
_vehiclesData set ["vehicleSam", "EAW_IJA_Type99_88_AA_1941J"];

_vehiclesData set ["howitzerMagazineHE", "EAW_Type91_105mm_Arty_Magazine"];

_vehiclesData set ["mortarMagazineHE", "EAW_Type97_81mm_HE"];
_vehiclesData set ["mortarMagazineSmoke", "EAW_Type97_81mm_Flare"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["EAW_Crossley"]];
_militiaVehiclesData set ["vehiclesTrucks", ["EAW_Dodge1936_Pickup_Military_IJA"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_Kfz1_camo","LIB_Kfz1_Hood_camo"]];
_militiaVehiclesData set ["vehiclesAPCs", ["fow_v_sdkfz_250_camo_foliage_ger_heer","fow_v_sdkfz_251_camo_foliage_ger_heer"]];
