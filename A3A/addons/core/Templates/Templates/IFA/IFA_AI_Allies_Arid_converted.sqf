...
_vehiclesData set ["vehiclesBasic", ["LIB_US_NAC_Willys_MB"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_US_NAC_Willys_MB","LIB_US_NAC_Willys_MB_Hood"]];
...
_vehiclesData set ["vehiclesMedical", ["LIB_US_NAC_GMC_Ambulance", "LIB_US_NAC_Willys_MB_Ambulance"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_US_NAC_Scout_M3"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_US_NAC_M3_Halftrack","LIB_US_NAC_Scout_M3_FFV"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_M8_Greyhound", "LIB_M3A3_Stuart", "LIB_M5A1_Stuart"]];
_vehiclesData set ["vehiclesTanks", ["LIB_US_NAC_M4A3_75", "LIB_Churchill_Mk7_desert"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_US_NAC_Scout_M3"]];
