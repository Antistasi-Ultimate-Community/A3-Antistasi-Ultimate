...
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_ARD_I_Hilux_Open"]];
_vehiclesData set ["vehiclesLightArmed", ["UK3CB_ARD_I_Hilux_M2"]];
_vehiclesData set ["vehiclesTruck", ["UK3CB_I_G_Ural_Open"]];
_vehiclesData set ["vehiclesAT", ["UK3CB_ARD_I_Hilux_Spg9"]];
_vehiclesData set ["vehiclesAA", ["rhsgref_nat_ural_Zu23"]];

_vehiclesData set ["vehiclesBoat", ["UK3CB_CHD_I_Fishing_Boat"]];

_vehiclesData set ["vehiclesPlane", ["UK3CB_I_G_Antonov_An2", "UK3CB_NAP_I_C400"]];

_vehiclesData set ["vehiclesCivCar", ["UK3CB_CHC_C_LR_Closed"]];
_vehiclesData set ["vehiclesCivTruck", ["UK3CB_CHC_C_Ural_Open"]];
_vehiclesData set ["vehiclesCivHeli", ["UK3CB_C_Bell412_Civ"]];
