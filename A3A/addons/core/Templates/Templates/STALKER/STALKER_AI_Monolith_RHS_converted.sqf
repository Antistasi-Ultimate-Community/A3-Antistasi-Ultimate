...
_vehiclesData set ["vehiclesLightArmed", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsusf_m1151_m2_v1_usarmy_wd", "rhsgref_cdf_b_reg_uaz_ags"]];
_vehiclesData set ["vehiclesTrucks", ["RHS_Ural_MSV_01"]];
_vehiclesData set ["vehiclesCargoTrucks", ["RHS_Ural_MSV_01"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhs_gaz66_ammo_vdv"]];
...
_vehiclesData set ["vehiclesAirborne", ["rhsgref_cdf_b_reg_uaz_dshkm", "rhsusf_m1151_m2_v1_usarmy_wd", "rhsgref_BRDM2_msv"]];
_vehiclesData set ["vehiclesAPCs", ["rhs_btr70_msv"]];
_vehiclesData set ["vehiclesIFVs", ["rhs_bmp2e_msv"]];
_vehiclesData set ["vehiclesLightTanks",  ["rhs_bmp3mera_msv"]];
_vehiclesData set ["vehiclesTanks", ["rhs_t72ba_tv", "rhs_t80"]];
_vehiclesData set ["vehiclesAA", ["rhs_zsu234_aa", "RHS_Ural_Zu23_MSV_01"]];

_vehiclesData set ["vehiclesTransportBoats", ["O_T_Boat_Transport_01_F"]];
_vehiclesData set ["vehiclesGunBoats", ["rhsusf_mkvsoc"]];
_vehiclesData set ["vehiclesAmphibious", ["rhs_btr70_msv" ]];
...
_vehiclesData set ["vehiclesArtillery", ["RHS_BM21_VMF_01"]];
["magazines", createHashMapFromArray [["RHS_BM21_VMF_01", ["rhs_mag_m21of_1"]]]] call _fnc_saveToTemplate;

_vehiclesData set ["uavsAttack", ["rhs_pchela1t_vvs"]];
_vehiclesData set ["uavsPortable", []];



_vehiclesData set ["vehiclesPolice", ["rhsusf_m1025_w"]];

_vehiclesData set ["staticMGs", ["B_G_HMG_02_high_F"]];
_vehiclesData set ["staticAT", ["rhsgref_cdf_b_SPG9"]];
_vehiclesData set ["staticAA", ["RHS_Stinger_AA_pod_D"]];
_vehiclesData set ["staticMortars", ["rhsgref_cdf_b_reg_M252"]];
...
_militiaVehiclesData set ["vehiclesTrucks", ["RHS_Ural_MSV_01"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["rhsgref_cdf_b_reg_uaz"]];
_militiaVehiclesData set ["vehiclesAPCs", ["rhsgref_BRDM2_msv"]];
