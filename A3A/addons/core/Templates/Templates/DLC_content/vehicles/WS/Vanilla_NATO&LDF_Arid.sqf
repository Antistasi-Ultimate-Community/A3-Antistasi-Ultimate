...
_militiaAPCs append ["APC_Wheeled_01_command_base_lxWS","O_APC_Wheeled_02_unarmed_lxWS","O_APC_Wheeled_02_hmg_lxWS","B_T_APC_Wheeled_01_command_lxWS"];
...
_aa append ["a3a_ldf_Truck_02_aa", "a3a_ldf_Offroad_AA", "a3a_ldf_Offroad_armor_AA"];
