...
_vehiclesData set ["vehiclesSDV", ["EF_B_SDV_01_MJTF_Des"]];
...
_vehiclesData set ["vehiclesGunBoats", ["EF_B_CombatBoat_HMG_MJTF_Wdl", "EF_B_CombatBoat_AT_MJTF_Wdl"]];
//_vehiclesData set ["vehiclesAmphibious", []]; not now
...
_vehiclesData set ["vehiclesPlanesGunship", ["B_T_VTOL_01_armed_F"]];
...
_vehiclesData set ["staticAA", ["B_T_Static_AA_F"]];
...
clesData set ["vehiclesTransportBoats", _transportBoat];
