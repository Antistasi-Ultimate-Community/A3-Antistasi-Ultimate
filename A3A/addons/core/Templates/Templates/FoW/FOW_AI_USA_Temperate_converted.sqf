...
_vehiclesData set ["vehiclesLightAPCs", ["LIB_US_Scout_M3","fow_v_lvta2_usa"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_US_M3_Halftrack","LIB_US_Scout_M3_FFV","fow_v_lvta2_usa"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_M8_Greyhound", "LIB_M3A3_Stuart", "fow_v_m5a1_usa"]];
...
_vehiclesData set ["vehiclesLightTanks",  ["LIB_M3A3_Stuart", "fow_v_m5a1_usa"]];
...
_vehiclesData set ["vehiclesGunBoats", ["fow_usa_lcvp", "LIB_LCI"]];
_vehiclesData set ["vehiclesAmphibious", ["fow_v_lvta2_usa"]];
...
_vehiclesData set ["staticMGs", ["fow_w_m1919a6_deployed_high_usa_p"]];
_vehiclesData set ["staticAT", ["fow_w_6Pounder_usa"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_US_Willys_MB_M1919"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_US_GMC_Open"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_US_Willys_MB"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_US_Scout_M3"]];
