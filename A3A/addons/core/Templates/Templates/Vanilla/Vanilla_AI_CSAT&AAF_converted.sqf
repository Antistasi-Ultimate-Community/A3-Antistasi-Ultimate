...
_vehiclesData set ["vehiclesSDV", ["O_SDV_01_F","I_SDV_01_F"]];
...
_vehiclesData set ["uavsAttack", ["O_UAV_02_dynamicLoadout_F", "O_T_UAV_04_CAS_F"]];
...
_vehiclesData set ["staticMortars", ["O_Mortar_01_F"]];
private _howitzers = [];
...
_vehiclesData set ["howitzerMagazineHE", "6Rnd_120mm_HE_shells_RF","2Rnd_120mm_Mo_Cluster_RF"];
