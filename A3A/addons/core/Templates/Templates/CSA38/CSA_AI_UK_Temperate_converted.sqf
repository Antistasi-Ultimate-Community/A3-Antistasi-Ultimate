...
_vehiclesData set ["vehiclesBasic", ["LIB_UK_Willys_MB"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_UK_Willys_MB","LIB_UK_Willys_MB_Hood"]];
private _vehiclesLightArmed = ["LIB_UK_Willys_MB_M1919","LIB_UniversalCarrier"]; 
_vehiclesData set ["vehiclesTrucks", ["LIB_US_GMC_Tent","LIB_US_GMC_Open"]];
_vehiclesData set ["vehiclesCargoTrucks", ["LIB_US_GMC_Tent","LIB_US_GMC_Open"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["LIB_US_GMC_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["LIB_US_GMC_Parm"]];
_vehiclesData set ["vehiclesFuelTrucks", ["LIB_US_GMC_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["LIB_US_GMC_Ambulance", "LIB_UK_Willys_MB_Ambulance"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_UniversalCarrier"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_UK_M3_Halftrack","LIB_UniversalCarrier"]];
_vehiclesData set ["vehiclesIFVs", ["csa38_valentineMkIIgreen", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Crocodile", "LIB_Cromwell_Mk4", "LIB_Churchill_Mk7_Howitzer", "LIB_Churchill_Mk7_AVRE"]];
_vehiclesData set ["vehiclesTanks", ["LIB_M4A4_FIREFLY", "csa38_matildaii_1", "csa38_matildaiiCS_1"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_UniversalCarrier"]];
_vehiclesData set ["vehiclesLightTanks",  ["csa38_valentineMkIIgreen"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_UK_Willys_MB_M1919"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_US_GMC_Open"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_UK_Willys_MB"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_UniversalCarrier"]];
