...
_vehiclesData set ["vehiclesCivCar", _civCarsWithWeights];
_vehiclesData set ["vehiclesCivHeli", _civHelicopter];
_vehiclesData set ["vehiclesCivIndustrial", _civIndustrial];
_vehiclesData set ["vehiclesCivBoat", _civBoat];
_vehiclesData set ["vehiclesCivRepair", _civRepair];
_vehiclesData set ["vehiclesCivMedical", _civMedical];
_vehiclesData set ["vehiclesCivFuel", _civFuel];
