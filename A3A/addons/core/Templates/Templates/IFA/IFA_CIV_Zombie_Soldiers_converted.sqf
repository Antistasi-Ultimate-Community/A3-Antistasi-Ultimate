...
private _unitTypes = [
    ...
    ["Man", _manTemplate],
    ["Special", _manTemplate, [["baseClass", ["Zombie_O_Walker_LIB_GER", "Zombie_O_Walker_LIB_SOV", "Zombie_O_Shambler_LIB_GER", "Zombie_O_Shambler_LIB_SOV", "Zombie_O_RC_LIB_SOV", "Zombie_O_Crawler_LIB_US", "Zombie_O_RA_LIB_US"], true]]]
];
