...
private _vehicleClass = selectRandomWeighted ((FactionGoDTieredFT(A3A_faction_riv, "vehiclesCars", 0)) + (FactionGoDTieredFT(A3A_faction_riv, "vehiclesLightArmed", 0)));
...
private _rivalVehData = [_roadPosition, 0, selectRandomWeighted (FactionGetTieredFT(A3A_faction_riv, "vehiclesLightArmed", 0)), Rivals] call A3A_fnc_RivalsSpawnVehicle;
