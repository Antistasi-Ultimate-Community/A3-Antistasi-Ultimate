...
_vehiclesData set ["vehiclesBasic", ["UK3CB_CSAT_B_O_Quadbike", "UK3CB_CSAT_B_O_M1030"]];
_vehiclesData set ["vehiclesLightUnarmed", ["UK3CB_CSAT_B_O_GAZ_Vodnik", "UK3CB_CSAT_B_O_BRDM2_UM"]];
_vehiclesData set ["vehiclesLightArmed", ["UK3CB_CSAT_B_O_BTR40_MG", "UK3CB_CSAT_B_O_GAZ_Vodnik_PKT"]];
_vehiclesData set ["vehiclesTrucks", ["UK3CB_CSAT_B_O_Ural"]];
_vehiclesData set ["vehiclesCargoTrucks", ["UK3CB_CSAT_B_O_Ural_Open", "UK3CB_CSAT_B_O_Ural_Recovery"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["UK3CB_CSAT_B_O_MAZ_543_Reammo", "UK3CB_CSAT_B_O_Ural_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["UK3CB_CSAT_B_O_MAZ_543_Repair", "UK3CB_CSAT_B_O_Ural_Repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["UK3CB_CSAT_B_O_MAZ_543_Refuel", "UK3CB_CSAT_B_O_Ural_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["UK3CB_CSAT_B_O_GAZ_Vodnik_MedEvac"]];
_vehiclesData set ["vehiclesLightAPCs", ["UK3CB_CSAT_B_O_GAZ_Vodnik_PKT", "UK3CB_CSAT_B_O_BRDM2_HQ", "UK3CB_CSAT_B_O_GAZ_Vodnik_Cannon", "UK3CB_CSAT_B_O_GAZ_Vodnik_HMG", "UK3CB_CSAT_B_O_GAZ_Vodnik_KVPT", "UK3CB_CSAT_B_O_BTR40_MG"]];
_vehiclesData set ["vehiclesAirborne", ["UK3CB_CSAT_B_O_BRDM2_ATGM", "UK3CB_CSAT_B_O_BRDM2", "UK3CB_CSAT_B_O_BMP3", "UK3CB_CSAT_B_O_BMP3MERA", "UK3CB_CSAT_B_O_BRM1K", "UK3CB_CSAT_B_O_BMD2", "UK3CB_CSAT_B_O_BMD1K"]];
_vehiclesData set ["vehiclesAPCs", ["UK3CB_CSAT_B_O_BTR80a", "UK3CB_CSAT_B_O_BTR80"]];
_vehiclesData set ["vehiclesIFVs", ["UK3CB_CSAT_B_O_BTR60", "UK3CB_CSAT_B_O_MTLB_PKT"]];

_vehiclesData set ["vehiclesLightTanks",  ["UK3CB_CSAT_B_O_T55", "UK3CB_CSAT_B_O_T72A", "UK3CB_CSAT_B_O_T72B", "UK3CB_CSAT_B_O_T72BC"]];
_vehiclesData set ["vehiclesTanks", ["UK3CB_CSAT_B_O_T80UK", "UK3CB_CSAT_B_O_T80U", "UK3CB_CSAT_B_O_T80BVK", "UK3CB_CSAT_B_O_T80BV"]];
_vehiclesData set ["vehiclesAA", ["UK3CB_CSAT_B_O_2S6M_Tunguska", "UK3CB_CSAT_B_O_ZsuTank"]];

_vehiclesData set ["vehiclesTransportBoats", ["UK3CB_CSAT_B_O_Skiff"]];
_vehiclesData set ["vehiclesGunBoats", ["UK3CB_CSAT_B_O_Armed_Boat_HMG_Minigun"]];

_vehiclesData set ["vehiclesPlanesCAS", ["UK3CB_CSAT_B_O_MIG21", "UK3CB_CSAT_B_O_MIG21_CAS", "UK3CB_CSAT_B_O_Su25SM_CAS"]];
_vehiclesData set ["vehiclesPlanesAA", ["UK3CB_CSAT_B_O_MIG21_AA", "UK3CB_CSAT_B_O_MIG29S", "UK3CB_CSAT_B_O_MIG29SM"]];
_vehiclesData set ["vehiclesPlanesTransport", ["RHS_TU95MS_vvs_old"]];

_vehiclesData set ["vehiclesHelisTransport", ["UK3CB_CSAT_B_O_Mi_24V", "UK3CB_CSAT_B_O_Mi8"]];
_vehiclesData set ["vehiclesHelisLight", ["UK3CB_CSAT_B_O_Bell412_Utility", "UK3CB_CSAT_B_O_Orca"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["UK3CB_CSAT_B_O_Bell412_Armed", "UK3CB_CSAT_B_O_Bell412_Armed_AT", "UK3CB_CSAT_B_O_Orca_Armed_MULTI", "UK3CB_CSAT_B_O_Orca_Armed_AT"]];
_vehiclesData set ["vehiclesHelisAttack", ["UK3CB_CSAT_B_O_Mi_24G", "UK3CB_CSAT_B_O_Mi8AMTSh", "UK3CB_CSAT_B_O_Orca_Armed_CAS"]];
...
_vehiclesData set ["uavsAttack", ["UK3CB_CSAT_B_O_Ababil_CAS", "UK3CB_CSAT_B_O_Ababil_AT", "UK3CB_CSAT_B_O_Fenghuang"]];
_vehiclesData set ["uavsPortable", ["UK3CB_CSAT_B_O_Darter"]];

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:


_vehiclesData set ["vehiclesPolice", ["UK3CB_CSAT_B_O_Offroad_Unarmed", "UK3CB_CSAT_B_O_M1030"]];

_vehiclesData set ["staticMGs", ["UK3CB_CSAT_B_O_DSHKM", "UK3CB_CSAT_B_O_PKM_High", "UK3CB_CSAT_B_O_Searchlight"]];
_vehiclesData set ["staticAT", ["UK3CB_CSAT_B_O_SPG9", "UK3CB_CSAT_B_O_Kornet"]];
_vehiclesData set ["staticAA", ["UK3CB_CSAT_B_O_ZU23", "UK3CB_CSAT_B_O_Igla_AA_pod"]];
_vehiclesData set ["staticMortars", ["rhs_2b14_82mm_msv"]];
_vehiclesData set ["staticHowitzers", ["rhs_D30_msv"]];

_vehiclesData set ["vehicleRadar", "UK3CB_CSAT_B_O_Radar_System"];
_vehiclesData set ["vehicleSam", "UK3CB_CSAT_B_O_SAMS_System"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["UK3CB_CSAT_B_O_UAZ_MG", "UK3CB_CSAT_B_O_UAZ_SPG9"]];
_militiaVehiclesData set ["vehiclesTrucks", ["UK3CB_CSAT_B_O_Ural_Open", "UK3CB_CSAT_B_O_Ural"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["UK3CB_CSAT_B_O_UAZ_Open", "UK3CB_CSAT_B_O_UAZ_Closed"]];
_militiaVehiclesData set ["vehiclesAPCs", ["UK3CB_CSAT_B_O_MTLB_PKT", "UK3CB_CSAT_B_O_BTR60", "UK3CB_CSAT_B_O_BTR40_MG"]];
