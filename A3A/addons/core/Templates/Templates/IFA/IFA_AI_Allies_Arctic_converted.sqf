...
_vehiclesData set ["vehiclesBasic", ["LIB_US_Willys_MB_w"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_US_Willys_MB_w","LIB_US_Willys_MB_Hood_w"]];
...
_vehiclesData set ["vehiclesMedical", ["LIB_US_GMC_Ambulance_w", "LIB_US_Willys_MB_Ambulance_w"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_US_Scout_m3_w"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_US_M3_Halftrack_w","LIB_US_Scout_M3_FFV_w"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_M8_Greyhound", "LIB_M3A3_Stuart", "LIB_M5A1_Stuart","LIB_Cromwell_Mk4_w", "LIB_Churchill_Mk7_Howitzer_w", "LIB_Churchill_Mk7_AVRE_w"]];
...
_vehiclesData set ["vehiclesAirborne", ["LIB_US_Scout_m3_w"]];
_vehiclesData set ["vehiclesLightTanks",  ["LIB_M3A3_Stuart", "LIB_M5A1_Stuart"]];
...
_vehiclesData set ["vehiclesPlanesTransport", ["LIB_C47_Skytrain","LIB_C47_RAF"]];
