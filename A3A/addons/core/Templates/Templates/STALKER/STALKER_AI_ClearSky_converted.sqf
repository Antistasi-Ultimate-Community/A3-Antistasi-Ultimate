...
_vehiclesData set ["vehiclesLightUnarmed", ["CUP_O_UAZ_Unarmed_SLA", "CUP_O_GAZ_Vodnik_Unarmed_RU"]];
_vehiclesData set ["vehiclesLightArmed", ["CUP_O_UAZ_MG_SLA", "CUP_O_UAZ_METIS_SLA", "CUP_O_GAZ_Vodnik_PK_RU"]];
...
_vehiclesData set ["vehiclesLightAPCs", ["CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU"]];
_vehiclesData set ["vehiclesAirborne", ["CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU"]];
_vehiclesData set ["vehiclesAPCs", ["CUP_O_BTR60_SLA"]];
_vehiclesData set ["vehiclesIFVs", ["CUP_O_BMP3_RU"]];
_vehiclesData set ["vehiclesLightTanks",  ["CUP_O_BMP2_SLA"]];
_vehiclesData set ["vehiclesTanks", ["CUP_O_T72_SLA", "CUP_O_T55_SLA"]];
...
_vehiclesData set ["vehiclesHelisLight", ["CUP_O_Mi24_P_Dynamic_RU"]];
_vehiclesData set ["vehiclesHelisTransport", ["CUP_O_Mi8_medevac_RU"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["CUP_O_Mi24_V_Dynamic_RU"]];
_vehiclesData set ["vehiclesHelisAttack", ["CUP_O_Mi8_RU"]];
...
_vehiclesData set ["vehiclesPolice", ["CUP_O_UAZ_Unarmed_RU"]];
...
_militiaVehiclesData set ["vehiclesLightUnarmed", ["CUP_O_UAZ_Open_SLA"]];
