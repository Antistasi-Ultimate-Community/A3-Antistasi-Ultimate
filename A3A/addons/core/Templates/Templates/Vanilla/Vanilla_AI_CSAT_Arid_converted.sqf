...
_vehiclesData set ["vehiclesAPCs", [ "O_APC_Wheeled_02_rcws_v2_F"]];
private _IFVs = ["O_APC_Tracked_02_cannon_F"];
private _airborneVehicles = ["O_APC_Wheeled_02_rcws_v2_F","O_UGV_01_rcws_F"];
_vehiclesData set ["vehiclesLightTanks", ["O_UGV_01_rcws_F"]];
...
_vehiclesData set ["vehiclesArtillery", ["O_MBT_02_arty_F", "I_Truck_02_MRL_F"]];
...
_vehiclesData set ["vehiclesHelisLightAttack", _helisLightAttack];
