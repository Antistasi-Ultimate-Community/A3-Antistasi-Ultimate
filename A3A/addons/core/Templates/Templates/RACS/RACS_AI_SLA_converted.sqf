...
_vehiclesData set ["vehiclesLightUnarmed", ["PRACS_SLA_BTR40", "PRACS_SLA_UAZ_open", "PRACS_SLA_UAZ"]];
_vehiclesData set ["vehiclesLightArmed", ["PRACS_SLA_BTR40_NSV", "PRACS_SLA_UAZ_DSHKM"]];
_vehiclesData set ["vehiclesTrucks", ["PRACS_SLA_URAL"]];
_vehiclesData set ["vehiclesCargoTrucks", ["PRACS_SLA_URAL"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["PRACS_SLA_Ural_Ammo", "PRACS_SLA_MAZ_ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["PRACS_SLA_URAL_Repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["PRACS_SLA_URAL_Fuel"]];
_vehiclesData set ["vehiclesMedical", ["PRACS_SLA_Ural_AMB"]];
_vehiclesData set ["vehiclesLightAPCs", ["PRACS_SLA_BTR40_AT", "PRACS_SLA_Type63_AT", "PRACS_SLA_MTLB", "PRACS_SLA_BRDM_HQ_PKT", "PRACS_SLA_BMD2", "PRACS_SLA_BTR80"]];
_vehiclesData set ["vehiclesAirborne", ["PRACS_SLA_BMD1", "PRACS_SLA_BRDM", "PRACS_SLA_BTR60"]];
_vehiclesData set ["vehiclesAPCs", ["PRACS_SLA_MTLB", "PRACS_SLA_BRDM", "PRACS_SLA_BTR80A"]];
_vehiclesData set ["vehiclesIFVs", ["PRACS_SLA_BTR60", "PRACS_SLA_Type63", "PRACS_SLA_BMP2"]];
_vehiclesData set ["vehiclesLightTanks",  ["PRACS_SLA_BMP2", "PRACS_SLA_BMP1"]];
_vehiclesData set ["vehiclesTanks", ["PRACS_SLA_T72B", "PRACS_SLA_T72BV", "PRACS_SLA_T80U"]];
_vehiclesData set ["vehiclesAA", ["PRACS_SLA_BTR40_AAM", "PRACS_SLA_URAL_Zu23", "PRACS_SLA_2S6M_Tunguska", "PRACS_SLA_SA13", "PRACS_SLA_SA8", "PRACS_SLA_SA9", "PRACS_SLA_ZSU23"]];

_vehiclesData set ["vehiclesTransportBoats", ["PRACS_SLA_GoFast"]];
_vehiclesData set ["vehiclesGunBoats", ["PRACS_SLA_GoFast_gun"]];
_vehiclesData set ["vehiclesAmphibious", ["PRACS_SLA_BTR60"]];

_vehiclesData set ["vehiclesPlanesCAS", ["PRACS_SLA_MiG27", "PRACS_SLA_Su25"]];
_vehiclesData set ["vehiclesPlanesAA", ["PRACS_SLA_MiG21", "PRACS_SLA_MiG23"]];
_vehiclesData set ["vehiclesPlanesTransport", ["PRACS_AN12B"]];

_vehiclesData set ["vehiclesHelisLight", ["PRACS_SLA_Mi8amt"]];
_vehiclesData set ["vehiclesHelisTransport", ["PRACS_SLA_Mi24D", "PRACS_SLA_Mi24V_UPK"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["PRACS_SLA_Mi17Sh"]];
_vehiclesData set ["vehiclesHelisAttack", ["PRACS_SLA_Mi17Sh_UPK", "PRACS_SLA_Mi24D"]];

_vehiclesData set ["vehiclesArtillery", ["PRACS_SLA_2s1"]];
...
_vehiclesData set ["vehiclesPolice", ["PRACS_SLA_UAZ_open_recon"]];

_vehiclesData set ["staticMGs", ["PRACS_SLA_DShK"]];
_vehiclesData set ["staticAT", ["PRACS_SLA_SPG9M_tripod"]];
_vehiclesData set ["staticAA", ["rhs_Igla_AA_pod_msv"]];
_vehiclesData set ["staticMortars", ["B_Mortar_01_F"]];
_vehiclesData set ["staticHowitzers", ["PRACS_SLA_M46"]];

_vehiclesData set ["vehicleRadar", "PRACS_P37_Radar"];
_vehiclesData set ["vehicleSam", "PRACS_SLA_S60"];

_vehiclesData set ["howitzerMagazineHE", "PRACS_130mm_X32"];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["PRACS_SLA_UAZ_DSHKM"]];
_militiaVehiclesData set ["vehiclesTrucks", ["PRACS_SLA_URAL"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["PRACS_SLA_UAZ_open_guards"]];
_militiaVehiclesData set ["vehiclesAPCs", ["PRACS_SLA_BRDM_HQ_PKT"]];
