...
_vehiclesData set ["vehiclesBasic", ["NORTH_SOV_R75"]];
_vehiclesData set ["vehiclesLightUnarmed", ["LIB_Willys_MB_w","LIB_Willys_MB_Hood_w"]];
...
_vehiclesData set ["vehiclesTrucks", ["LIB_US6_Tent","LIB_US6_Open"]];
_vehiclesData set ["vehiclesCargoTrucks", ["LIB_US6_Open_Cargo","LIB_US6_Tent_Cargo"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["LIB_US6_Ammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["LIB_Zis6_Parm_w"]];
_vehiclesData set ["vehiclesFuelTrucks", ["LIB_Zis5v_Fuel_w"]];
_vehiclesData set ["vehiclesMedical", ["LIB_Zis5v_med_w"]];
_vehiclesData set ["vehiclesLightAPCs", ["LIB_Scout_M3_FFV_w","LIB_Scout_m3_w"]];
_vehiclesData set ["vehiclesAPCs", ["LIB_Scout_M3_FFV_w","LIB_SOV_M3_Halftrack_w","NORTH_SOV_W_T34_76_1941"]];
_vehiclesData set ["vehiclesIFVs", ["LIB_SU85_w","NORTH_SOV_W_T34_76_1943","NORTH_SOV_W_T28","NORTH_SOV_W_T28e","NORTH_SOV_W_T28_com"]];
_vehiclesData set ["vehiclesTanks", ["NORTH_SOV_W_KV1_1940","NORTH_SOV_W_KV1_1941","NORTH_SOV_W_KV1_1942","NORTH_SOV_W_KV1E_1940","NORTH_SOV_W_T34_85","NORTH_SOV_W_T34_85_45","NORTH_SOV_W_T34_85","NORTH_SOV_W_T34_85_45","LIB_JS2_43_w","LIB_JS2_43_w","LIB_JS2_43_w"]];
_vehiclesData set ["vehiclesAA", ["LIB_Zis5v_61K"]];
_vehiclesData set ["vehiclesAirborne", ["LIB_Scout_M3_FFV_w","NORTH_SOV_T60","NORTH_SOV_T70"]];
_vehiclesData set ["vehiclesLightTanks",  ["NORTH_SOV_T26_M33","NORTH_SOV_T26_M38","NORTH_SOV_T26_M39","NORTH_SOV_T26_M33com","NORTH_SOV_T70","NORTH_SOV_41_BT5","NORTH_SOV_41_BT5Com","NORTH_SOV_41_BT7","NORTH_SOV_41_BT7A","NORTH_SOV_41_BT7Com_M35","NORTH_SOV_41_T26_M33_OT","NORTH_SOV_41_T26_M39_OT"]];
...
_vehiclesData set ["vehiclesPlanesTransport", ["LIB_Li2"]];
...
_vehiclesData set ["vehiclesArtillery", ["LIB_US6_BM13"]];
...
_vehiclesData set ["vehiclesPolice", ["LIB_GazM1_SOV"]];

_vehiclesData set ["staticMGs", ["NORTH_FIN_Maxim_High"]];
_vehiclesData set ["staticAT", ["NORTH_SOV_W_76mm1936"]];
_vehiclesData set ["staticAA", ["NORTH_SOV_Maxim_Quad"]];
_vehiclesData set ["staticMortars", ["LIB_BM37"]];
_vehiclesData set ["staticHowitzers", ["NORTH_SOV_W_152mm1938"]];

_vehiclesData set ["vehicleRadar", "LIB_61k"];
_vehiclesData set ["vehicleSam", "LIB_61k"];

_vehiclesData set ["howitzerMagazineHE", "NORTH_10Shell_152mmHE_152h38"];

_vehiclesData set ["mortarMagazineHE", "LIB_8Rnd_82mmHE_BM37"];
_vehiclesData set ["mortarMagazineSmoke", "LIB_82mm_BM37_SmokeShell"];

//Minefield definition
_vehiclesData set ["minefieldAT", ["LIB_TM44_MINE"]];
_vehiclesData set ["minefieldAPERS", ["LIB_PMD6_MINE"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["LIB_Kfz1_MG42_sernyt"]];
_militiaVehiclesData set ["vehiclesTrucks", ["LIB_Zis5v_w"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["LIB_Willys_MB_w"]];
_militiaVehiclesData set ["vehiclesAPCs", ["LIB_Scout_m3_w"]];
