...
_vehiclesData set ["vehiclesLightUnarmed", ["OPTRE_M12_FAV"]];
_vehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_LRV"]];
_vehiclesData set ["vehiclesTruck", ["OPTRE_m1087_stallion_unsc"]];
_vehiclesData set ["vehiclesAT", ["OPTRE_M12A1_LRV"]];
private _vehicleAA = [];

_vehiclesData set ["vehiclesBoat", ["optre_catfish_unarmed_f"]];
