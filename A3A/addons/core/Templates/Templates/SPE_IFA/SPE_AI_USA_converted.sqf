...
_vehiclesData set ["vehiclesIFVs", ["SPE_M18_Hellcat", "SPE_M10", "SPE_M8_LAC_ringMount", "SPE_M8_LAC"]];
...
_vehiclesData set ["vehiclesTransportBoats", _vehiclesTransportBoats];
_vehiclesData set ["vehiclesGunBoats", _vehiclesGunBoats];

_vehiclesData set ["vehiclesPlanesCAS", ["SPE_P47"]];
_vehiclesData set ["vehiclesPlanesAA", ["SPE_P47"]];
...
_vehiclesData set ["vehiclesPlanesTransport", _vehiclesPlanesTransport];
