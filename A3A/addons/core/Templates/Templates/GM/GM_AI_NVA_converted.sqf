...
_vehiclesData set ["vehiclesLightUnarmed", ["gm_gc_army_uaz469_cargo", "gm_gc_army_uaz469_cargo", "gm_gc_army_btr60pu12", "gm_gc_army_brdm2um"]];
...
_vehiclesData set ["vehiclesTrucks", ["gm_gc_army_ural4320_cargo", "gm_gc_army_ural375d_cargo", "gm_gc_army_btr60pa"]];
_vehiclesData set ["vehiclesCargoTrucks", ["gm_gc_army_ural4320_cargo", "gm_gc_army_ural44202", "gm_gc_army_ural375d_cargo"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["gm_gc_army_ural4320_reammo"]];
_vehiclesData set ["vehiclesRepairTrucks", ["gm_gc_army_ural4320_repair"]];
_vehiclesData set ["vehiclesFuelTrucks", ["gm_gc_army_ural375d_refuel"]];
_vehiclesData set ["vehiclesMedical", ["gm_gc_army_ural375d_medic"]];
_vehiclesData set ["vehiclesLightAPCs", ["gm_gc_army_btr60pb", "gm_gc_army_btr60pb", "CUP_O_GAZ_Vodnik_Unarmed_RU", "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU",
    "gm_gc_army_btr60pa_dshkm"]];
_vehiclesData set ["vehiclesAPCs", ["gm_pl_army_ot64a", "CUP_O_BTR80_CAMO_RU", "CUP_O_BTR80A_CAMO_RU", "gm_gc_army_bmp1sp2"]];
_vehiclesData set ["vehiclesIFVs", ["gm_gc_army_bmp1sp2", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU"]];
_vehiclesData set ["vehiclesTanks", ["gm_gc_army_pt76b", "gm_gc_army_t55", "gm_gc_army_t55a", "gm_gc_army_t55ak", "gm_gc_army_t55am2", "gm_gc_army_t55am2b"]];
_vehiclesData set ["vehiclesAA", ["gm_gc_army_zsu234v1", "CUP_O_Ural_ZU23_RU"]];

_vehiclesData set ["vehiclesAirborne", ["gm_gc_army_btr60pb", "gm_gc_army_btr60pb", "CUP_O_GAZ_Vodnik_Unarmed_RU", "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU",
    "gm_gc_army_btr60pa_dshkm"]];
_vehiclesData set ["vehiclesLightTanks",  ["gm_gc_army_bmp1sp2", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU"]];

_vehiclesData set ["vehiclesTransportBoats", ["CUP_O_PBX_RU"]];
_vehiclesData set ["vehiclesGunBoats", ["CUP_B_RHIB2Turret_USMC"]];
_vehiclesData set ["vehiclesAmphibious", ["gm_gc_army_bmp1sp2", "CUP_O_BMP2_RU", "CUP_O_BMP3_RU", "CUP_O_BTR80A_CAMO_RU","gm_gc_army_brdm2um", "gm_gc_army_btr60pa", 
...
_vehiclesData set ["vehiclesHelisLight", ["gm_gc_airforce_mi2p", "gm_pl_airforce_mi2ch"]];
_vehiclesData set ["vehiclesHelisTransport", ["gm_gc_airforce_mi2t", "gm_pl_airforce_mi2t", "CUP_O_Mi8AMT_RU"]];
_vehiclesData set ["vehiclesHelisAttack", ["CUP_O_Mi24_P_Dynamic_RU"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["gm_gc_airforce_mi2urn", "gm_gc_airforce_mi2us", "gm_pl_airforce_mi2urp", "gm_pl_airforce_mi2urpg", "CUP_O_Mi8_RU"]];

_vehiclesData set ["vehiclesArtillery", ["gm_gc_army_ural375d_mlrs", "gm_gc_army_2s1"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["gm_pl_army_uaz469_dshkm"]];
_militiaVehiclesData set ["vehiclesTrucks", ["gm_pl_army_ural4320_cargo"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["gm_pl_army_uaz469_cargo"]];
_militiaVehiclesData set ["vehiclesAPCs", ["gm_gc_army_btr60pb", "gm_gc_army_btr60pb", "CUP_O_GAZ_Vodnik_Unarmed_RU", "CUP_O_GAZ_Vodnik_PK_RU", "CUP_O_GAZ_Vodnik_AGS_RU",
    "gm_gc_army_btr60pa_dshkm"]];
