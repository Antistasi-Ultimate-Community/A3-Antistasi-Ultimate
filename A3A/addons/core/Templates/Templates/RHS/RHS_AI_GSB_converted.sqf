...
_vehiclesData set ["vehiclesBasic", ["B_Quadbike_01_F"]]; 			//this line determines basic vehicles, the lightest kind available. -- Example: _vehiclesData set ["vehiclesBasic", ["B_Quadbike_01_F"]] -- Array, can contain multiple assets
["vehiclesLightUnarmed", ["gsb_rhs_22_m1151_olive", "gsb_rhs_22_m1152_olive", "gsb_rhs_22_m1152_TCV_olive"]]; 		//this line determines light and unarmed vehicles. -- Example: _vehiclesData set ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
["vehiclesLightArmed",["gsb_rhs_22_m1151_m2_v1_olive", "gsb_rhs_22_m1151_olive_pkm", "gsb_rhs_22_m1151_mk19_v1_olive"]]; 		//this line determines light and armed vehicles -- Example: ["vehiclesLightArmed",["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"]] -- Array, can contain multiple assets
_vehiclesData set ["vehiclesTrucks", ["gsb_rhs_22_ural_open", "gsb_rhs_22_ural", "rhsgref_cdf_b_gaz66", "rhsgref_cdf_b_gaz66o", "rhsgref_cdf_b_zil131", "rhsgref_cdf_b_zil131_open"]]; 			//this line determines the trucks -- Example: _vehiclesData set ["vehiclesTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
["vehiclesCargoTrucks", ["gsb_rhs_22_ural_open", "gsb_rhs_22_ural", "rhsgref_cdf_b_gaz66", "rhsgref_cdf_b_gaz66o", "rhsgref_cdf_b_zil131", "rhsgref_cdf_b_zil131_open"]]; 		//this line determines cargo trucks -- Example: _vehiclesData set ["vehiclesCargoTrucks", ["B_Truck_01_transport_F", "B_Truck_01_covered_F"]] -- Array, can contain multiple assets
["vehiclesRepairTrucks", ["gsb_rhs_22_ural_repair", "rhsgref_cdf_b_gaz66_repair"]]; 		//this line determines repair trucks -- Example: _vehiclesData set ["vehiclesRepairTrucks", ["B_Truck_01_Repair_F"]] -- Array, can contain multiple assets
["vehiclesFuelTrucks", ["gsb_rhs_22_ural_fuel"]];		//this line determines fuel trucks -- Array, can contain multiple assets
_vehiclesData set ["vehiclesIFVs", ["gsb_rhs_22_bmp2", "gsb_rhs_22_bmp2d", "KAP_gsb_22_M2A3", "KAP_gsb_22_M2A3_BUSKI", "KAP_gsb_22_M2A3_BUSKIII", "KAP_gsb_22_APC_Wheeled_01", "rhsgref_cdf_b_bmd1", "rhsgref_cdf_b_bmd1k", "rhsgref_cdf_b_bmd1p", "rhsgref_cdf_b_bmd1pk", "rhsgref_cdf_b_bmd2", "rhsgref_cdf_b_bmd2k", "rhsgref_cdf_b_bmp1", "rhsgref_cdf_b_bmp1d", "rhsgref_cdf_b_bmp1k", "rhsgref_cdf_b_bmp1p"]];				//this line determines IFVs
_vehiclesData set ["vehiclesAirborne", ["gsb_rhs_22_m1151_m2_v1_olive", "gsb_rhs_22_m1151_olive_pkm", "gsb_rhs_22_BRDM2UM"]];
...
_vehiclesData set ["vehiclesAA", _vehiclesAA];
_vehiclesData set ["vehiclesLightAPCs", _vehiclesLightAPCs];
_vehiclesData set ["vehiclesAmmoTrucks", _vehiclesAmmoTrucks];
_vehiclesData set ["vehiclesMedical", _vehiclesMedical];
_vehiclesData set ["vehiclesAPCs", _vehiclesAPCs];
_vehiclesData set ["uavsAttack", _uavsAttack];
_vehiclesData set ["vehiclesTanks", _vehiclesTanks];


_vehiclesData set ["vehiclesTransportBoats", ["B_Boat_Transport_01_F"]]; 	//this line determines transport boats -- Example: _vehiclesData set ["vehiclesTransportBoats", ["B_Boat_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesGunBoats", ["I_Boat_Armed_01_minigun_F"]]; 			//this line determines gun boats -- Example: _vehiclesData set ["vehiclesGunBoats", ["B_Boat_Armed_01_minigun_F"]] -- Array, can contain multiple assets
["vehiclesAmphibious", ["KAP_gsb_22_APC_Wheeled_01"]]; 		//this line determines amphibious vehicles  -- Example: _vehiclesData set ["vehiclesAmphibious", ["B_APC_Wheeled_01_cannon_F"]] -- Array, can contain multiple assets

["vehiclesPlanesCAS", ["KAP_GSB_22_Plane_Fighter_04", "rhsgref_cdf_b_su25", "rhs_l159_cdf_b_CDF"]];
_vehiclesData set ["vehiclesPlanesAA", ["KAP_GSB_22_Plane_Fighter_04", "rhsgref_cdf_b_mig29s", "rhs_l159_cdf_b_CDF"]];
_vehiclesData set ["vehiclesPlanesTransport", ["RHS_C130J"]]; 	//this line determines transport planes -- Example: _vehiclesData set ["vehiclesPlanesTransport", ["B_T_VTOL_01_infantry_F"]] -- Array, can contain multiple assets

["vehiclesHelisLight", ["KAP_GSB_22_UH1Y_UNARMED", "KAP_GSB_22_UH60M2_d"]]; 		//this line determines light helis -- Example: _vehiclesData set ["vehiclesHelisLight", ["B_Heli_Light_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisTransport", ["KAP_GSB_22_UH60M2_d", "KAP_GSB_22_UH60M", "rhsgref_cdf_b_reg_Mi8amt"]]; 	//this line determines transport helis -- Example: _vehiclesData set ["vehiclesHelisTransport", ["B_Heli_Transport_01_F"]] -- Array, can contain multiple assets
["vehiclesHelisLightAttack", ["KAP_GSB_22_UH1Y_FFAR", "KAP_GSB_22_UH1Y", "KAP_GSB_22_UH60M", "rhsgref_cdf_b_reg_Mi17Sh"]];		// this line determines light attack helicopters
_vehiclesData set ["vehiclesHelisAttack", ["gsb_rhs_22_mi24g_CAS", "rhsgref_cdf_b_Mi24D", "rhsgref_cdf_b_Mi35"]]; 		//this line determines attack helis -- Example: _vehiclesData set ["vehiclesHelisAttack", ["B_Heli_Attack_01_F"]] -- Array, can contain multiple assets

if (isClass (configFile >> "cfgPatches" >> "ACM_CDF_GSFL")) then {
    ["vehiclesArtillery", ["gsb_rhs_22_BM21", "rhsgref_cdf_b_2s1", "ACM_B_CDF_Vehicle_M109", "ACM_B_CDF_Vehicle_9K79", "ACM_B_CDF_Vehicle_9K79_K", "ACM_B_CDF_Vehicle_2S3"]];
...
{
	_vehiclesData set ["vehiclesArtillery", ["gsb_rhs_22_BM21", "rhsgref_cdf_b_2s1"]];
    ["magazines", createHashMapFromArray [
    ["gsb_rhs_22_BM21", ["rhs_mag_m21of_1"]],
    ["rhsgref_cdf_b_2s1", ["rhs_mag_3of56_35"]]
    ]] call _fnc_saveToTemplate;
...
_vehiclesData set ["uavsPortable", ["B_UAV_01_F"]]; 				//this line determines portable UAVs -- Example: _vehiclesData set ["uavsPortable", ["B_UAV_01_F"]] -- Array, can contain multiple assets

//Config special vehicles - militia vehicles are mostly used in the early game, police cars are being used by troops around cities -- Example:
						//this line determines militia APCs

_vehiclesData set ["vehiclesPolice", ["gsb_rhs_22_m1151_olive", "gsb_rhs_22_m1152_olive", "gsb_rhs_22_m1152_TCV_olive"]]; 			//this line determines police cars -- Example: _vehiclesData set ["vehiclesPolice", ["B_GEN_Offroad_01_gen_F"]] -- Array, can contain multiple assets

["staticMGs", ["rhsgref_cdf_b_DSHKM"]]; 					//this line determines static MGs -- Example: ["staticMG", ["B_HMG_01_high_F"]] -- Array, can contain multiple assets
_vehiclesData set ["staticAT", ["rhsgref_cdf_b_SPG9M"]]; 					//this line determinesstatic ATs -- Example: _vehiclesData set ["staticAT", ["B_static_AT_F"]] -- Array, can contain multiple assets
["staticAA", ["rhsgref_cdf_b_Igla_AA_pod", "rhsgref_cdf_b_ZU23"]]; 					//this line determines static AAs -- Example: _vehiclesData set ["staticAA", ["B_static_AA_F"]] -- Array, can contain multiple assets
["staticMortars", ["rhsgref_cdf_b_reg_M252"]]; 				//this line determines static mortars -- Example: _vehiclesData set ["staticMortars", ["B_Mortar_01_F"]] -- Array, can contain multiple assets
["staticHowitzers", ["rhsgref_cdf_b_reg_d30"]];							//this line determines static howitzers. Basically it's just a stronger mortar, use same syntax as above.

_vehiclesData set ["mortarMagazineHE", "rhs_12Rnd_m821_HE"]; 			//this line determines available HE-shells for the static mortars - !needs to be compatible with the mortar! -- Example: _vehiclesData set ["mortarMagazineHE", "8Rnd_82mm_Mo_shells"] - ENTER ONLY ONE OPTION
...
["howitzerMagazineHE", "rhs_mag_3of56_10"];			//this line determines available HE-shells for the static howitzers - !needs to be compatible with the howitzer! -- same syntax as above - ENTER ONLY ONE OPTION

//Minefield definition
_vehiclesData set ["minefieldAT", ["rhs_mine_tm62m"]];
_vehiclesData set ["minefieldAPERS", ["rhs_mine_m3_pressure"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["gsb_rhs_22_m1151_m2_v1_olive", "gsb_rhs_22_m1151_olive_pkm", "rhsgref_cdf_b_reg_uaz_dshkm", "rhsgref_cdf_b_reg_uaz_ags", "rhsgref_cdf_b_reg_uaz_spg9"]];
_militiaVehiclesData set ["vehiclesTrucks", ["B_G_Van_01_transport_F"]] -- Array, can contain multiple assets
["vehiclesMilitiaCars", ["gsb_rhs_22_m1151_olive", "gsb_rhs_22_m1152_olive", "gsb_rhs_22_m1152_TCV_olive"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["B_G_Offroad_01_F"]] -- Array, can contain multiple assets

["vehiclesMilitiaAPCs", ["gsb_rhs_22_m1151_m2_v1_olive", "gsb_rhs_22_m1151_olive_pkm", "rhsgref_cdf_b_reg_uaz_open", "rhsgref_cdf_b_reg_uaz"]];
