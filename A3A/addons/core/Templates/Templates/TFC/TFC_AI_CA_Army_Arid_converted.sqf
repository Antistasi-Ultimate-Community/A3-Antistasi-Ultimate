...
_vehiclesData set ["vehiclesLightUnarmed", ["tfc_vs_luvw_arid_f", "rhsusf_m998_d_4dr_fulltop", "rhsusf_m1043_d"]];
_vehiclesData set ["vehiclesLightArmed", ["tfc_vs_luvw_arid_armed_f", "rhsusf_m1043_d_m2", "rhsusf_m1151_m240_v2_usarmy_d"]];
_vehiclesData set ["vehiclesTrucks", ["rhsusf_M1078A1P2_D_fmtv_usarmy", "rhsusf_M1078A1P2_D_flatbed_fmtv_usarmy"]];
_vehiclesData set ["vehiclesCargoTrucks", ["rhsusf_M1078A1P2_D_flatbed_fmtv_usarmy", "rhsusf_M1084A1P2_B_D_fmtv_usarmy"]];
_vehiclesData set ["vehiclesAmmoTrucks", ["rhsusf_M977A4_AMMO_BKIT_usarmy_d", "rhsusf_M977A4_AMMO_BKIT_M2_usarmy_d"]];
_vehiclesData set ["vehiclesRepairTrucks", ["rhsusf_M977A4_REPAIR_BKIT_usarmy_d"]];
_vehiclesData set ["vehiclesFuelTrucks", ["rhsusf_M978A4_BKIT_usarmy_d"]];
_vehiclesData set ["vehiclesMedical", ["rhsusf_M1085A1P2_B_D_Medical_fmtv_usarmy"]];
_vehiclesData set ["vehiclesLightAPCs", ["tfc_wheeled_lav6_isc_ar", "rhsusf_M1117_D", "rhsusf_stryker_m1126_m2_d", "rhsusf_stryker_m1132_m2_np_d"]];
_vehiclesData set ["vehiclesAirborne", ["tfc_wheeled_lav6_isc_ar", "rhsusf_stryker_m1126_m2_d", "RHS_M2A3_BUSKI_d", "RHS_M2A3_d"]];
_vehiclesData set ["vehiclesAPCs", ["tfc_wheeled_lav6_isc_ar", "rhsusf_M1220_M2_usarmy_d", "rhsusf_M1232_M2_usarmy_d"]];
_vehiclesData set ["vehiclesIFVs", ["RHS_M2A2_BUSKI", "RHS_M6"]];

_vehiclesData set ["vehiclesLightTanks",  ["RHS_M2A3_BUSKIII", "RHS_M2A2"]];
_vehiclesData set ["vehiclesTanks", ["TFC_MBT_Leopard2A4M_F"]];
...
_vehiclesData set ["vehiclesHelisTransport", ["RHS_UH60M", "RHS_CH_47F_light"]];
_vehiclesData set ["vehiclesHelisLight", ["RHS_UH60M2"]];
_vehiclesData set ["vehiclesHelisLightAttack", ["RHS_MELB_AH6M_M", "RHS_MELB_AH6M_H"]];
_vehiclesData set ["vehiclesHelisAttack", ["RHS_AH64D"]];
...
_vehiclesData set ["vehiclesPolice", ["tfc_vs_luvw_armed_f", "rhsusf_m998_d_4dr_halftop"]];
...
_militiaVehiclesData set ["vehiclesLightArmed", ["tfc_vs_luvw_arid_armed_f", "rhsusf_m1025_d_m2"]];
_militiaVehiclesData set ["vehiclesTrucks", ["rhsusf_M1078A1P2_D_fmtv_usarmy"]];
_militiaVehiclesData set ["vehiclesLightUnarmed", ["tfc_vs_luvw_arid_f", "rhsusf_m998_d_2dr_halftop"]];
_militiaVehiclesData set ["vehiclesAPCs", ["tfc_wheeled_lav6_isc_ar"]];
