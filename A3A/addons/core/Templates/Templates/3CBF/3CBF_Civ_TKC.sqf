...
["vehiclesCivPlanes", ["UK3CB_TKC_C_Antonov_AN2", "UK3CB_TKC_C_DC3"]] call _fnc_saveToTemplate;
...
["uniforms", _civUniforms + _pressUniforms + _workerUniforms + _vipUniforms] call _fnc_saveToTemplate;
