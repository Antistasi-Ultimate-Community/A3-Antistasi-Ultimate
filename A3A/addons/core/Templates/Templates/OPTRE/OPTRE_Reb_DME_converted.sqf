...
_vehiclesData set ["vehiclesLightUnarmed", ["OPTRE_DME_M12_FAV"]];
_vehiclesData set ["vehiclesLightArmed", ["OPTRE_M12_LRV_DME"]];
_vehiclesData set ["vehiclesTruck", ["OPTRE_m1015_mule_cma"]];
_vehiclesData set ["vehiclesAT", ["OPTRE_M12_TD_CMA", "OPTRE_M12A1_LRV_CMA"]];
private _vehicleAA = [];

_vehiclesData set ["vehiclesBoat", ["optre_catfish_cma_unarmed_f"]];

_vehiclesData set ["vehiclesPlane", ["OPTRE_YSS_1000_A"]];
...
_vehiclesData set ["vehiclesCivHeli", ["OPTRE_UNSC_falcon_PD"]];
_vehiclesData set ["vehiclesCivBoat", ["optre_catfish_cma_unarmed_f"]];
...
_vehiclesData set ["staticMortars", ["OPTRE_AU_44_DME_Mortar"]];
_vehiclesData set ["staticMortarMagHE", "OPTRE_10Rnd_122mm_SABOT_81mm_Mo_shells"];
_vehiclesData set ["staticMortarMagSmoke", "OPTRE_10Rnd_122mm_Mo_Smoke_white"];
_vehiclesData set ["staticMortarMagFlare", "OPTRE_10Rnd_122mm_Mo_Flare_white"];
